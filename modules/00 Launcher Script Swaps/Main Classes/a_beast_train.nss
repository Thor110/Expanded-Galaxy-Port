...
// Prototypes
void sub101(string stringParam1, int intParam2, int intParam3, float floatParam4);
void sub100();
int sub99(int intParam1, int intParam2);
int sub98(object objectParam1, int intParam2);
void sub97();
void sub96();
int sub95();
int sub94();
int sub93(object objectParam1);
int sub92(object objectParam1);
int sub91(float floatParam1);
int sub90(object objectParam1);
int sub89();
int sub88(object objectParam1);
int sub87(object objectParam1);
object sub86(object objectParam1);
int sub85();
int sub84();
int sub83(object objectParam1);
int sub82(float floatParam1);
int sub81(object objectParam1);
int sub80(object objectParam1);
void sub79(object objectParam1);
int sub78(object objectParam1);
talent sub77(object objectParam1, talent talentParam2);
int sub76(int intParam1);
int sub75(int intParam1);
int sub74(int intParam1);
string sub73(int intParam1);
int sub72();
int sub71();
int sub70();
int sub69();
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub9(intGLOB_52, 1));
					}
					else {
...
void sub97() {
	if ((!sub6(intGLOB_61))) {
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub6(intGLOB_58)) {
					...
					if (sub6(intGLOB_54)) {
						int int11 = sub98(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub6(intGLOB_59), fPersonalSpace, float4);
			if (sub6(intGLOB_52)) {
				ActionDoCommand(sub100());
			}
...
int sub95() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		DelayCommand(0.2, ActionDoCommand(sub96()));
		return 1;
	}
	else {
...
int sub94() {
	...
	if ((sub6(intGLOB_112) && (!sub6(intGLOB_113)))) {
		if (sub95()) {
			return 1;
		}
	}
	...
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub6(intGLOB_61) == 1))) {
		sub2("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
		DelayCommand(1.0, sub97());
		return 1;
	}
	else {
			...
			if ((!GetSoloMode())) {
				if ((((GetObjectType(oTarget) == 8) && (!GetIsOpen(oTarget))) && (!GetSoloMode()))) {
					...
					if ((((GetObjectType(oTarget) == 64) && (GetCurrentHitPoints(oTarget) > 0)) && (!GetSoloMode()))) {
						...
						sub101("NO TARGET: FOLLOW LEADER", 10, 10, 4.0);
	...
	if ((d100(1) < 20)) {
		if ((GetIsTalentValid(talRandom) && GetCreatureHasTalent(talRandom, OBJECT_SELF))) {
			if ((GetIsObjectValid(objectParam1) && GetIsEnemy(objectParam1, OBJECT_SELF))) {
				sub2("GENERIC DEBUG *************** Using Talent on Intruder Target");
				...
				object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
				if (GetIsObjectValid(oNearest)) {
					sub2("GENERIC DEBUG *************** Using Talent on Determined Target");
...
int sub90(object objectParam1) {
	if ((GetLevelByClass(2, OBJECT_SELF) > 0)) {
		return 1;
	}
	if ((GetLevelByClass(0, OBJECT_SELF) > 0)) {
		return 1;
	}
	if ((GetLevelByClass(1, OBJECT_SELF) > 0)) {
		return 1;
	}
...
int sub89() {
	...
	if ((nLocal > 0)) {
		...
		if (GetIsObjectValid(object5)) {
			int11 = sub76(GetBaseItemType(object5));
		}
		if ((int11 != 2)) {
			object object7 = GetItemInSlot(18, OBJECT_SELF);
			int int15 = 0;
			if (GetIsObjectValid(object7)) {
				int15 = sub76(GetBaseItemType(object7));
			}
			if ((int15 == 2)) {
				ClearAllActions();
				ActionSwitchWeapons();
...
int sub83(object objectParam1) {
	...
	if ((sub84() != (-1))) {
		...
		if (int8) {
			...
			if (sub14(intGLOB_128, GetFirstPC())) {
				return 1;
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if (sub14(intGLOB_125, object1)) {
			return 1;
		}
	}
	object object9 = sub13();
	if (GetIsObjectValid(object9)) {
		if (sub14(intGLOB_126, object9)) {
			return 1;
		}
	}
	if (sub14(intGLOB_127, OBJECT_SELF)) {
		return 1;
	}
	object3 = sub28();
	...
	if ((GetIsObjectValid(oTarget) && (!GetIsDead(oTarget)))) {
		...
		if ((fDistance < 3.5)) {
			...
			if (GetIsInCombat(OBJECT_SELF, 0)) {
				DelayCommand(3.0, sub1(objectParam1));
			}
		}
		else {
			int nAction = GetCurrentAction(OBJECT_SELF);
				...
				if ((intParam1 == intGLOB_23)) {
					...
					if ((intParam1 == intGLOB_24)) {
						...
						if ((intParam1 == intGLOB_25)) {
							...
							if ((intParam1 == intGLOB_26)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub56())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_27)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub56())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_28)) {
										...
										if ((intParam1 == intGLOB_29)) {
											...
											if ((intParam1 == intGLOB_30)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub60() && sub61()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_31)) {
													talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
													if ((sub62() && GetIsTalentValid(talRandom))) {
														return 1;
													}
												}
												else {
													if ((intParam1 == intGLOB_32)) {
														...
														if ((intParam1 == intGLOB_33)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub58() && sub64()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_34)) {
																if (((sub64() && sub57()) && sub65())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_35)) {
																	if (((sub62() && sub57()) && sub59())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_36)) {
																		if (((sub63() && sub57()) && sub59())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_36)) {
																			if (((sub58() && sub66()) && sub57())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_38)) {
																				talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																				if ((sub66() && GetIsTalentValid(talRandom))) {
																					return 1;
																				}
																			}
																			else {
																				if ((intParam1 == intGLOB_39)) {
																					if (((sub66() && sub57()) && sub65())) {
																						return 1;
																					}
																				}
																				else {
																					if ((intParam1 == intGLOB_40)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if (((sub57() && GetIsTalentValid(talRandom)) && GetHasSpell(177, OBJECT_SELF))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_41)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub57() && sub64()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_42)) {
																								talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																								if (((sub67() && sub68()) && GetIsTalentValid(talRandom))) {
																									return 1;
																								}
																							}
																							else {
																								if ((intParam1 == intGLOB_43)) {
																									talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																									if (((sub69() && sub70()) && GetIsTalentValid(talRandom))) {
																										return 1;
																									}
																								}
																								else {
																									if ((intParam1 == intGLOB_44)) {
																										talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																										if ((sub71() && GetIsTalentValid(talRandom))) {
																											return 1;
																										}
																									}
																									else {
...
talent sub34(int intParam1) {
	...
	object oRWeapItem = GetItemInSlot(4, OBJECT_SELF);
	if (((((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0)) && (!sub35(OBJECT_SELF))) && (!GetIsObjectValid(oRWeapItem)))) {
		object oLArmItem = GetItemInSlot(7, OBJECT_SELF);
		object oRArmItem = GetItemInSlot(8, OBJECT_SELF);
		int int9 = 1;
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((((((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0)) || (GetLevelByClass(11, OBJECT_SELF) > 0)) || (GetLevelByClass(12, OBJECT_SELF) > 0)) || (GetLevelByClass(13, OBJECT_SELF) > 0)) || (GetLevelByClass(14, OBJECT_SELF) > 0)) || (GetLevelByClass(15, OBJECT_SELF) > 0)) || (GetLevelByClass(16, OBJECT_SELF) > 0))) {
				int2 = sub54(intParam1);
				sub2(("GENERIC DEBUG *************** Starting Jedi Combo " + sub73(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub2(("GENERIC DEBUG *************** Starting Droid Combo " + sub73(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub36(int2);
				}
					...
					sub2(("GENERIC DEBUG *************** Starting NPC Combo " + sub73(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub36(int2);
				}
		...
		sub2(("GENERIC DEBUG *************** Continuing Combo " + sub73(structGLOB_1.int15)));
		return sub36(structGLOB_1.int15);
	}
	return talent1;
}
...
int sub32(object objectParam1) {
	...
	oNPC = sub33();
	if (GetIsObjectValid(oNPC)) {
		if (sub14(intGLOB_125, oNPC)) {
			return 1;
		}
	}
	oNPC = sub13();
	if (GetIsObjectValid(oNPC)) {
		if (sub14(intGLOB_126, oNPC)) {
			return 1;
		}
	}
	talent1 = sub34(0);
	...
	if ((nLocalBool == 1)) {
		...
		if ((GetNPCAIStyle(OBJECT_SELF) == 10)) {
			...
			object oRWeapItem = GetItemInSlot(4, OBJECT_SELF);
			if (GetIsObjectValid(oRWeapItem)) {
				int11 = sub76(GetBaseItemType(oRWeapItem));
			}
			if ((int11 == 2)) {
...
int sub14(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
			...
			if ((intParam1 == intGLOB_125)) {
				...
				if ((intParam1 == intGLOB_126)) {
					...
					if (((GetCreatureHasTalent(talSpell, OBJECT_SELF) || GetCreatureHasTalent(talent2, OBJECT_SELF)) || GetCreatureHasTalent(talent3, OBJECT_SELF))) {
						sub2("GENERIC DEBUG *************** I have Heal, Improved Heal, or Master Heal");
						int3 = 1;
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub2(("GENERIC DEBUG *************** Spells.2DA ID = " + sub8(int56)));
			ClearAllActions();
...
int sub10() {
	int int1 = 0;
	if (((sub6(intGLOB_119) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub6(intGLOB_116))) {
...
int sub7() {
	...
	sub2(((("GENERIC DEBUG *************** Shield Boolean (" + sub8(intGLOB_117)) + ") = ") + sub8(sub6(intGLOB_117))));
	if (((sub6(intGLOB_117) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub1(object objectParam1) {
	...
	sub4();
	{
		...
		if (((((!sub6(intGLOB_112)) && (!sub6(intGLOB_113))) && (!sub6(intGLOB_114))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub6(intGLOB_121) == 1)) {
					if ((sub11() == 1)) {
						return;
					}
				}
				if ((sub6(intGLOB_116) == 1)) {
				...
				if (((nNPCStyle == 0) || (nNPCStyle == 7))) {
					...
					if ((nNPCStyle == 4)) {
						...
						if ((nNPCStyle == 5)) {
							...
							if ((sub83(objectParam1) == 1)) {
								return;
							}
						}
						else {
							if ((nNPCStyle == 8)) {
								if ((sub87(objectParam1) == 1)) {
									return;
								}
							}
							else {
...
void main() {
	...
	switch (nParam1) {
		case 0:
			location1 = GetLocation(GetObjectByTag("wp_train_move", 0));
			oShapeObject = GetFirstObjectInShape(4, 15.0, location1, 0, 1, [0.0,0.0,0.0]);
			while (GetIsObjectValid(oShapeObject)) {
				if ((!GetIsPC(oShapeObject))) {
					SetLocalBoolean(oShapeObject, 45, 1);
					ChangeToStandardFaction(oShapeObject, 5);
				}
		...
		case 1:
			...
			while (GetIsObjectValid(oShapeObject)) {
				if ((!GetIsPC(oShapeObject))) {
					if (((GetTag(oShapeObject) != "troop_beast_1") && (GetTag(oShapeObject) != "troop_beast_2"))) {
						AssignCommand(oShapeObject, ClearAllActions());
						DelayCommand(0.1, AssignCommand(oShapeObject, ActionMoveToObject(GetObjectByTag("wp_train_move2", 0), 1, 1.0)));
					}
				}
				oShapeObject = GetNextObjectInShape(4, 15.0, location1, 0, 1, [0.0,0.0,0.0]);
			}
		...
		case 2:
			location1 = GetLocation(GetObjectByTag("wp_train_move", 0));
			oSp_c_boma22 = GetObjectByTag("sp_c_boma22", 0);
			oShapeObject = GetFirstObjectInShape(4, 15.0, location1, 0, 1, [0.0,0.0,0.0]);
			while (GetIsObjectValid(oShapeObject)) {
				if ((!GetIsPC(oShapeObject))) {
					if (GetLocalBoolean(oShapeObject, 45)) {
						AssignCommand(oShapeObject, ClearAllActions());
						ChangeToStandardFaction(oShapeObject, 1);
						AssignCommand(oShapeObject, sub1(OBJECT_INVALID));
						DelayCommand(0.1, AssignCommand(oShapeObject, ActionForceMoveToObject(oSp_c_boma22, 1, 1.0, 30.0)));
					}
				}
				oShapeObject = GetNextObjectInShape(4, 15.0, location1, 0, 1, [0.0,0.0,0.0]);
			}
		...
		case 5:
			{
				...
				while ((int11 < 3)) {
				{
					object oBoma_train = GetObjectByTag("boma_train", int11);
					AssignCommand(oBoma_train, ActionPlayAnimation(107, 1.0, 1.0));
					DelayCommand(3.0, AssignCommand(oBoma_train, ActionPlayAnimation(107, 1.0, 1.0)));
				}
					(int11++);
				}
			}
