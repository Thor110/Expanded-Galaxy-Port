...
void main() {
	...
	ChangeToStandardFaction(oKas22_czguard_01, 18);
	ChangeToStandardFaction(oKas22_czguard_02, 18);
	ChangeToStandardFaction(OBJECT_SELF, 18);
	AssignCommand(oKas22_czguard_01, sub1(OBJECT_INVALID));
	AssignCommand(oKas22_czguard_02, sub1(OBJECT_INVALID));
	sub1(OBJECT_INVALID);
}
