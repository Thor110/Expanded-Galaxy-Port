...
void main() {
	object oTat17_darkjedi02 = GetObjectByTag("tat17_darkjedi02", 0);
	object oTat17_darkjedi03 = GetObjectByTag("tat17_darkjedi03", 0);
	ChangeToStandardFaction(oTat17_darkjedi02, 1);
	ChangeToStandardFaction(oTat17_darkjedi03, 1);
	ChangeToStandardFaction(OBJECT_SELF, 1);
	AssignCommand(oTat17_darkjedi02, DelayCommand(1.0, sub1(OBJECT_INVALID)));
	AssignCommand(oTat17_darkjedi03, DelayCommand(1.0, sub1(OBJECT_INVALID)));
