...
void main() {
	int int1 = 0;
	object oKas_calo_thug1 = GetObjectByTag("kas_calo_thug1", 0);
	object oKas_calo_thug2 = GetObjectByTag("kas_calo_thug2", 0);
	if (GetIsObjectValid(oKas_calo_thug1)) {
		ChangeToStandardFaction(oKas_calo_thug1, 1);
		DelayCommand(0.5, AssignCommand(oKas_calo_thug1, ClearAllActions()));
		DelayCommand(0.5, AssignCommand(oKas_calo_thug1, sub1(OBJECT_INVALID)));
	}
	if (GetIsObjectValid(oKas_calo_thug2)) {
		ChangeToStandardFaction(oKas_calo_thug2, 1);
		DelayCommand(0.5, AssignCommand(oKas_calo_thug2, ClearAllActions()));
		DelayCommand(0.5, AssignCommand(oKas_calo_thug2, ActionMoveToObject(GetFirstPC(), 1, 1.0)));
		DelayCommand(1.0, AssignCommand(oKas_calo_thug2, sub1(OBJECT_INVALID)));
	}
	ChangeToStandardFaction(GetObjectByTag("kas_calo", 0), 1);
	DelayCommand(0.5, AssignCommand(GetObjectByTag("kas_calo", 0), ClearAllActions()));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("kas_calo", 0), sub1(OBJECT_INVALID)));
}
