...
void sub82(object objectParam1, int intParam2);
...
void sub81(object objectParam1) {
	sub82(objectParam1, intGLOB_141);
}
	...
	if ((!sub8(intGLOB_55))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub8(intGLOB_52)) {
				...
				if (((nLocal < int4) && (!sub8(intGLOB_52)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub8(intGLOB_53), 2.5, float3);
			if (sub8(intGLOB_46)) {
...
int sub72() {
	...
	if ((sub8(intGLOB_101) && (!sub8(intGLOB_102)))) {
		if (sub73()) {
			return 1;
		}
	}
...
int sub12() {
	int int1 = 0;
	if (((sub8(intGLOB_108) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub8(intGLOB_105))) {
...
int sub9() {
	...
	sub4(((("GENERIC DEBUG *************** Shield Boolean (" + sub10(intGLOB_106)) + ") = ") + sub10(sub8(intGLOB_106))));
	if (((sub8(intGLOB_106) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub3(object objectParam1) {
	...
	sub6();
	{
		...
		if (((((!sub8(intGLOB_101)) && (!sub8(intGLOB_102))) && (!sub8(intGLOB_103))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub8(intGLOB_111) == 1)) {
					if ((sub13() == 1)) {
						return;
					}
				}
				if ((sub8(intGLOB_105) == 1)) {
...
void sub1(object objectParam1) {
	...
	object object5 = GetPartyMemberByIndex(2);
	CancelCombat(oNPC);
	ApplyEffectToObject(0, EffectForcePushTargeted(GetLocation(objectParam1), 0), oNPC, 0.0);
	if (GetIsObjectValid(object3)) {
		CancelCombat(object3);
		ApplyEffectToObject(0, EffectForcePushTargeted(GetLocation(objectParam1), 0), object3, 0.0);
	}
	if (GetIsObjectValid(object5)) {
		CancelCombat(object5);
		ApplyEffectToObject(0, EffectForcePushTargeted(GetLocation(objectParam1), 0), object5, 0.0);
	}
	CancelCombat(objectParam1);
}
	...
	if ((int1 == 1001)) {
		...
		if ((int1 == 1002)) {
			...
			if ((int1 == 1003)) {
				...
				if ((int1 == 1004)) {
					object oInvis_rulan_conv = GetObjectByTag("invis_rulan_conv", 0);
					AssignCommand(oInvis_rulan_conv, ActionStartConversation(oInvis_rulan_conv, "", 0, 0, 0, "", "", "", "", "", ""));
				}
				else {
					if ((int1 == 1005)) {
					}
						...
						if ((int1 == 1006)) {
							int int3 = (GetMaxHitPoints(OBJECT_SELF) / 2);
							object oInvis_ter_conv = GetObjectByTag("invis_ter_conv", 0);
							if (((GetCurrentHitPoints(OBJECT_SELF) <= int3) && (GetGlobalNumber("k_Rulan_morph") == 2))) {
								...
								ApplyEffectAtLocation(0, EffectVisualEffect(1046, 0), GetLocation(OBJECT_SELF), 0.0);
								...
								AssignCommand(GetModule(), DelayCommand(0.4, ApplyEffectToObject(0, EffectVisualEffect(6002, 0), GetFirstPC(), 0.0)));
								DelayCommand(0.1, PlaySound("v_pro_afflict"));
								AssignCommand(GetModule(), DelayCommand(0.4, ApplyEffectAtLocation(0, EffectVisualEffect(1046, 0), GetLocation(OBJECT_SELF), 0.0)));
								AssignCommand(GetModule(), DelayCommand(0.4, sub2(1, "rulan_ter", location1)));
								AssignCommand(GetModule(), DelayCommand(0.90000004, ChangeToStandardFaction(GetObjectByTag("rulan_ter", 0), 1)));
								AssignCommand(GetModule(), DelayCommand(1.0, AssignCommand(GetObjectByTag("rulan_ter", 0), sub3(OBJECT_INVALID))));
							}
							else {
								if (((GetCurrentHitPoints(OBJECT_SELF) <= 10) && (GetGlobalNumber("k_Rulan_morph") == 3))) {
									SetGlobalNumber("k_Rulan_morph", 4);
									ChangeToStandardFaction(OBJECT_SELF, 4);
									sub1(OBJECT_SELF);
									ApplyEffectAtLocation(0, EffectVisualEffect(1047, 0), GetLocation(OBJECT_SELF), 0.0);
									DelayCommand(0.1, ActionSurrenderToEnemies());
									DelayCommand(0.2, ClearAllEffects());
									DelayCommand(0.2, DestroyObject(OBJECT_SELF, 0.0, 0, 0.0));
									AssignCommand(GetModule(), DelayCommand(0.4, ApplyEffectToObject(0, EffectVisualEffect(6002, 0), GetFirstPC(), 0.0)));
									DelayCommand(0.1, PlaySound("v_pro_afflict"));
									AssignCommand(GetModule(), DelayCommand(0.4, ApplyEffectAtLocation(0, EffectVisualEffect(1047, 0), GetLocation(OBJECT_SELF), 0.0)));
									AssignCommand(GetModule(), DelayCommand(1.4, sub2(1, "rulan004", location1)));
								}
							}
						}
						else {
							if ((int1 == 1007)) {
								PlaySound("c_veerkal_bat1");
								SetGlobalNumber("k_Rulan_morph", 5);
								SetGlobalNumber("K_Geno_Rulan", 50);
								AddJournalQuestEntry("Geno_Rulan", 50, 0);
								sub81(GetFirstPC());
								ApplyEffectAtLocation(0, EffectVisualEffect(1047, 0), location1, 0.0);
								ApplyEffectToObject(0, EffectVisualEffect(6002, 0), GetFirstPC(), 0.0);
								DelayCommand(0.6, sub2(64, "rulan_corpse", location1));
								DelayCommand(0.7, DestroyObject(OBJECT_SELF, 0.0, 0, 0.0));
							}
							else {
								if ((int1 == 1008)) {
								}
