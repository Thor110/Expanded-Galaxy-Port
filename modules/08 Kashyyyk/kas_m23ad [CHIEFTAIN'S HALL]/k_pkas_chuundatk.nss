...
void main() {
	object oKas23_freyyr_01 = GetObjectByTag("kas23_freyyr_01", 0);
	object oKas23_czerkaloy = GetObjectByTag("kas23_czerkaloy", 0);
	object object5 = GetObjectByTag("kas23_czerkaloy", 1);
	object object7 = GetObjectByTag("kas23_czerkaloy", 2);
	object object9 = GetObjectByTag("kas23_czerkaloy", 3);
	object oKas23_wookguard = GetObjectByTag("kas23_wookguard", 0);
	object object13 = GetObjectByTag("kas23_wookguard", 1);
	object oKas23_wookguard2 = GetObjectByTag("kas23_wookguard2", 0);
	object object17 = GetObjectByTag("kas23_wookguard2", 1);
	object oNPC = GetPartyMemberByIndex(0);
	object object21 = GetPartyMemberByIndex(1);
	object object23 = GetPartyMemberByIndex(2);
	if ((!GetIsObjectValid(object23))) {
		object23 = oNPC;
	}
	sub1(1);
	SetPlotFlag(oKas23_freyyr_01, 1);
	ChangeToStandardFaction(OBJECT_SELF, 1);
	ChangeToStandardFaction(oKas23_czerkaloy, 1);
	ChangeToStandardFaction(object5, 1);
	ChangeToStandardFaction(object7, 1);
	ChangeToStandardFaction(object9, 1);
	ChangeToStandardFaction(oKas23_wookguard, 1);
	ChangeToStandardFaction(object13, 1);
	ChangeToStandardFaction(oKas23_wookguard2, 1);
	ChangeToStandardFaction(object17, 1);
	ChangeToStandardFaction(oKas23_freyyr_01, 2);
	AssignCommand(oKas23_czerkaloy, DelayCommand(1.0, sub3(oNPC)));
	AssignCommand(object5, DelayCommand(1.0, sub3(object21)));
	AssignCommand(object7, DelayCommand(1.0, sub3(object23)));
	AssignCommand(object9, DelayCommand(1.0, sub3(oNPC)));
	AssignCommand(oKas23_wookguard, DelayCommand(1.0, sub3(oNPC)));
	AssignCommand(object13, DelayCommand(1.0, sub3(object21)));
	AssignCommand(oKas23_wookguard, DelayCommand(1.0, sub3(object23)));
