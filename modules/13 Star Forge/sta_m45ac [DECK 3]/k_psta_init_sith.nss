...
void main() {
	...
	if ((((GetEnteringObject() == oNPC) && (!sub1(OBJECT_SELF, intGLOB_1))) && GetIsObjectValid(oSta_sith1))) {
		sub2(OBJECT_SELF, intGLOB_1, 1);
		AssignCommand(oSta_sith1, ActionStartConversation(oNPC, "", 0, 0, 1, "", "", "", "", "", ""));
		object oK45_door_bast1 = GetObjectByTag("k45_door_bast1", 0);
		object oK45_door_bast2 = GetObjectByTag("k45_door_bast2", 0);
		AssignCommand(oK45_door_bast1, ActionCloseDoor(oK45_door_bast1));
		SetLocked(oK45_door_bast1, 1);
