			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub11(intGLOB_75, 1));
					}
					else {
...
void sub77() {
	if ((!sub8(intGLOB_84))) {
		...
		string string2 = "WP_";
		string string3;
		int nLocal = GetLocalNumber(OBJECT_SELF, intGLOB_72);
		int int4 = GetLocalNumber(OBJECT_SELF, intGLOB_73);
		int int6 = GetLocalNumber(OBJECT_SELF, intGLOB_74);
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub8(intGLOB_81)) {
				...
				if (((nLocal < int4) && (!sub8(intGLOB_81)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub8(intGLOB_82), 2.5, float3);
			if (sub8(intGLOB_75)) {
				ActionDoCommand(sub79());
			}
			SetLocalNumber(OBJECT_SELF, intGLOB_72, nLocal);
			if ((string2 != "UNKNOWN")) {
...
int sub75(object objectParam1) {
	...
	int nLocal = GetLocalNumber(objectParam1, intGLOB_74);
	string string5;
	if ((nLocal < 10)) {
...
int sub72() {
	...
	if ((sub8(intGLOB_130) && (!sub8(intGLOB_131)))) {
		if (sub73()) {
			return 1;
		}
	}
...
int sub70(object objectParam1) {
	...
	if (sub16(intGLOB_146, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub16(intGLOB_144, object1)) {
			return 1;
		}
	}
	object object4 = sub15();
	if (GetIsObjectValid(object4)) {
		if (sub16(intGLOB_145, object4)) {
			return 1;
		}
	}
	object3 = sub29();
	...
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub24(intGLOB_31, 1);
		}
		else {
			talent1 = sub24(intGLOB_31, 0);
		}
	}
	else {
		...
		if (GetIsObjectValid(object3)) {
			...
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub24(intGLOB_32, 1);
			}
			else {
				talent1 = sub24(intGLOB_32, 0);
			}
		}
	}
...
int sub69(object objectParam1) {
	...
	sub4("GENERIC DEBUG *************** Grenade AI Fall Through");
	return sub33(objectParam1);
}
...
talent sub52(int intParam1) {
	SetLocalBoolean(OBJECT_SELF, intGLOB_71, 0);
															...
															if ((intParam1 == intGLOB_45)) {
																...
																if ((intParam1 == intGLOB_46)) {
																	...
																	if ((intParam1 == intGLOB_47)) {
																		...
																		if (((intParam1 == intGLOB_48) || (intParam1 == intGLOB_44))) {
	...
	(nLocal++);
	SetLocalNumber(OBJECT_SELF, intGLOB_37, nLocal);
...
int sub37(int intParam1) {
	if ((intParam1 == intGLOB_70)) {
		return 0;
	}
	talent talRandom;
	talent talent2;
	if ((((intParam1 == intGLOB_45) || (intParam1 == intGLOB_46)) || (intParam1 == intGLOB_47))) {
		...
		if ((intParam1 == intGLOB_44)) {
			...
			if ((((intParam1 == intGLOB_41) || (intParam1 == intGLOB_42)) || (intParam1 == intGLOB_43))) {
																					...
																					if ((intParam1 == intGLOB_65)) {
																						...
																						if ((intParam1 == intGLOB_66)) {
																							...
																							if ((intParam1 == intGLOB_67)) {
																								...
																								if (((intParam1 == intGLOB_68) || (intParam1 == intGLOB_69))) {
...
talent sub35(int intParam1) {
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		SetLocalNumber(OBJECT_SELF, intGLOB_37, 0);
		SetLocalNumber(OBJECT_SELF, intGLOB_36, 0);
		nRandom = d6(1);
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				...
				SetLocalNumber(OBJECT_SELF, intGLOB_37, 1);
				SetLocalNumber(OBJECT_SELF, intGLOB_36, int2);
				return sub52(int2);
			}
			else {
...
int sub33(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub16(intGLOB_144, oNPC)) {
			return 1;
		}
	}
	oNPC = sub15();
	if (GetIsObjectValid(oNPC)) {
		if (sub16(intGLOB_145, oNPC)) {
			return 1;
		}
	}
	talent1 = sub35(0);
	int nLocalBool = GetLocalBoolean(OBJECT_SELF, intGLOB_71);
	if ((nLocalBool == 1)) {
...
talent sub24(int intParam1, int intParam2) {
	...
	talent talRandom;
	int int1 = 0;
	if (((intParam1 == intGLOB_30) || (intParam1 == intGLOB_34))) {
	...
	if (((intParam1 == intGLOB_31) || (intParam1 == intGLOB_34))) {
	...
	if (((intParam1 == intGLOB_32) || (intParam1 == intGLOB_34))) {
		if ((d100(1) > 50)) {
		...
		if (((intParam1 == intGLOB_33) || (intParam1 == intGLOB_34))) {
			if ((d100(1) > 70)) {
				talRandom = sub27(intParam2);
				if (GetIsTalentValid(talRandom)) {
					return talRandom;
			...
			if ((intParam1 == intGLOB_144)) {
				...
				if ((intParam1 == intGLOB_145)) {
					...
					if ((intParam1 == intGLOB_146)) {
						...
						sub4(("GENERIC DEBUG *************** Spell Effect 22" + sub10(GetHasSpellEffect(22, OBJECT_SELF))));
						sub4(("GENERIC DEBUG *************** Spell Effect 33" + sub10(GetHasSpellEffect(33, OBJECT_SELF))));
						sub4(("GENERIC DEBUG *************** Spell Effect 36" + sub10(GetHasSpellEffect(36, OBJECT_SELF))));
...
int sub12() {
	int int1 = 0;
	if (((sub8(intGLOB_137) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub8(intGLOB_134))) {
...
int sub9() {
	...
	sub4(((("GENERIC DEBUG *************** Shield Boolean (" + sub10(intGLOB_135)) + ") = ") + sub10(sub8(intGLOB_135))));
	if (((sub8(intGLOB_135) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		...
		if (GetCreatureHasTalent(talSpell, OBJECT_SELF)) {
			...
			sub4("GENERIC DEBUG *************** Forcefield Search Fallthrough");
			sub11(intGLOB_135, 1);
			return 0;
		}
	}
...
void sub6() {
	...
	structGLOB_1.int13 = GetLocalNumber(OBJECT_SELF, intGLOB_37);
	structGLOB_1.int15 = GetLocalNumber(OBJECT_SELF, intGLOB_36);
}
...
void sub3(object objectParam1) {
	...
	sub6();
	{
		...
		if (((((!sub8(intGLOB_130)) && (!sub8(intGLOB_131))) && (!sub8(intGLOB_132))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub9() == 1)) {
					sub4("GENERIC DEBUG *************** Terminating AI from Shields");
					return;
				}
				if ((sub12() == 1)) {
					return;
				}
				if ((sub8(intGLOB_140) == 1)) {
					if ((sub13() == 1)) {
						return;
					}
				}
				if ((sub8(intGLOB_134) == 1)) {
...
void sub1(int intParam1) {
	SetGlobalNumber("KOR39_SITH_HOSTILE", intParam1);
}

void main() {
	object oKor39_yuthura = GetObjectByTag("kor39_yuthura", 0);
	object oKor39_uthar = GetObjectByTag("kor39_uthar", 0);
	object oPC = GetFirstPC();
	ChangeToStandardFaction(oKor39_yuthura, 2);
	ChangeToStandardFaction(OBJECT_SELF, 1);
	sub1(2);
	object object7 = GetItemPossessedBy(OBJECT_SELF, "G_W_DBLSBR002");
	if (GetIsObjectValid(object7)) {
		object oRWeapItem = GetItemInSlot(4, OBJECT_SELF);
		if ((!GetIsObjectValid(oRWeapItem))) {
			ClearAllActions();
			ActionEquipItem(object7, 4, 0);
			sub2("Sword valid", 10, 10, 4.0);
		}
		else {
			sub2("Sword already in slot", 10, 10, 5.0);
		}
	}
	else {
		sub2("Sword not valid", 10, 10, 4.0);
	}
	object object11 = GetItemPossessedBy(oKor39_yuthura, "g_w_lghtsbr02");
	if (GetIsObjectValid(object11)) {
		object object13 = GetItemInSlot(4, oKor39_yuthura);
		if ((!GetIsObjectValid(object13))) {
			AssignCommand(oKor39_yuthura, ClearAllActions());
			AssignCommand(oKor39_yuthura, ActionEquipItem(object11, 4, 0));
			sub2("Yuthura Sword valid", 12, 12, 4.0);
		}
		else {
			sub2("Sword already in slot", 10, 10, 5.0);
		}
		...
		sub2("Yuthura Sword not valid", 12, 12, 4.0);
	}
	object object15 = GetItemPossessedBy(oKor39_yuthura, "g_w_shortsbr02");
	if (GetIsObjectValid(object15)) {
		object oLWeapItem = GetItemInSlot(5, oKor39_yuthura);
		if ((!GetIsObjectValid(oLWeapItem))) {
			AssignCommand(oKor39_yuthura, ClearAllActions());
			AssignCommand(oKor39_yuthura, ActionEquipItem(object15, 5, 0));
			sub2("Yuthura Sword 2 valid", 12, 12, 4.0);
		}
		else {
			sub2("Sword already in slot", 10, 10, 5.0);
		}
		...
		sub2("Yuthura Sword 2 not valid", 12, 12, 4.0);
	}
	SetMinOneHP(OBJECT_SELF, 0);
	DelayCommand(1.0, sub3(oPC));
	DelayCommand(1.0, AssignCommand(oKor39_yuthura, sub3(oKor39_uthar)));
}
