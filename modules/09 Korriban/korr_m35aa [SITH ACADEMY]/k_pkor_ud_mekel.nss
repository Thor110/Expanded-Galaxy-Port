...
void main() {
	...
	if ((int1 == 1001)) {
		if ((((!GetIsInConversation(OBJECT_SELF)) && (!GetIsInCombat(OBJECT_SELF))) && sub1(OBJECT_SELF, intGLOB_2))) {
			ClearAllActions();
			object oKor35_mekcomp = GetObjectByTag("kor35_mekcomp", 0);
			vector vPosition = GetPosition(oKor35_mekcomp);
