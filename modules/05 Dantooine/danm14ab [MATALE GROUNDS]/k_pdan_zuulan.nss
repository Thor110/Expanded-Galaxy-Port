...
void main() {
	object oDan_party_move00 = GetObjectByTag("dan_party_move00", 0);
	object oDan_party_move11 = GetObjectByTag("dan_party_move11", 0);
	object oDan_party_move22 = GetObjectByTag("dan_party_move22", 0);
	...
	location location1 = GetLocation(GetObjectByTag("dan_zuulan_move", 0));
	location location3 = GetLocation(GetObjectByTag("dan_droid1_move", 0));
	location location5 = GetLocation(GetObjectByTag("dan_droid2_move", 0));
	sub1(3.2);
	sub2(oDan_party_move00, oDan_party_move11, oDan_party_move22);
	AssignCommand(oDan_cut_zuulan, ActionMoveToLocation(location1, 0));
	DelayCommand(0.2, AssignCommand(oDan_cut_droid1, ActionMoveToLocation(location3, 0)));
	DelayCommand(0.3, AssignCommand(oDan_cut_droid2, ActionMoveToLocation(location5, 0)));
}
