...
int StartingConditional() {
	int int1 = ((((sub1(OBJECT_SELF) == 0) && GetGlobalBoolean("DAN_BOLOOK_WEST")) && (GetGlobalNumber("DAN_JEDI_PLOT") == 7)) && (GetGlobalBoolean("DAN_BOLOOKF_DONE") == 0));
	if (int1) {
		SetGlobalBoolean("DAN_BOLOOKF_DONE", 1);
	}
	return int1;
}
