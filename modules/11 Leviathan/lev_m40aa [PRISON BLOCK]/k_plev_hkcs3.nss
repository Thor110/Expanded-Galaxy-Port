...
void main() {
	...
	ChangeToStandardFaction(oLev40_hktech0, 1);
	ChangeToStandardFaction(oLev40_hktech1, 1);
	DelayCommand(0.5, AssignCommand(oLev40_hktech0, sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oLev40_hktech1, sub1(OBJECT_INVALID)));
}
