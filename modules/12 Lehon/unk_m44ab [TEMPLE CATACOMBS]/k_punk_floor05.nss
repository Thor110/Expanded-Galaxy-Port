...
void main() {
	if ((GetGlobalBoolean("UNK_TILES") == 0)) {
		...
		if ((sub1(GetObjectByTag("FloorPanel04", 0)) == 1)) {
			AssignCommand(GetObjectByTag("FloorPanel04", 0), ActionPlayAnimation(200, 1.0, 0.0));
			sub2(GetObjectByTag("FloorPanel04", 0), 0);
		}
		else {
			AssignCommand(GetObjectByTag("FloorPanel04", 0), ActionPlayAnimation(201, 1.0, 0.0));
			sub2(GetObjectByTag("FloorPanel04", 0), 1);
		}
		...
		if ((sub1(GetObjectByTag("FloorPanel06", 0)) == 1)) {
			AssignCommand(GetObjectByTag("FloorPanel06", 0), ActionPlayAnimation(200, 1.0, 0.0));
			sub2(GetObjectByTag("FloorPanel06", 0), 0);
		}
		else {
			AssignCommand(GetObjectByTag("FloorPanel06", 0), ActionPlayAnimation(201, 1.0, 0.0));
			sub2(GetObjectByTag("FloorPanel06", 0), 1);
		}
		if ((sub1(GetObjectByTag("FloorPanel08", 0)) == 1)) {
			AssignCommand(GetObjectByTag("FloorPanel08", 0), ActionPlayAnimation(200, 1.0, 0.0));
			sub2(GetObjectByTag("FloorPanel08", 0), 0);
		}
		else {
			AssignCommand(GetObjectByTag("FloorPanel08", 0), ActionPlayAnimation(201, 1.0, 0.0));
			sub2(GetObjectByTag("FloorPanel08", 0), 1);
		}
	}
