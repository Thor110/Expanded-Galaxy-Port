...
void main() {
	ChangeToStandardFaction(GetObjectByTag("darkjedi441", 0), 1);
	AssignCommand(GetObjectByTag("darkjedi441", 0), sub1(OBJECT_INVALID));
	ChangeToStandardFaction(GetObjectByTag("darkjedi442", 0), 1);
	AssignCommand(GetObjectByTag("darkjedi442", 0), sub1(OBJECT_INVALID));
}
