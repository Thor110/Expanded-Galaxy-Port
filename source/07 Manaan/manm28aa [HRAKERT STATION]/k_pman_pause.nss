...
void main() {
	object oMan_pc_jump0 = GetObjectByTag("man_pc_jump0", 0);
	object oMan_pc_jump1 = GetObjectByTag("man_pc_jump1", 0);
	object oMan_pc_jump2 = GetObjectByTag("man_pc_jump2", 0);
	sub1(2.1);
	sub2(oMan_pc_jump0, oMan_pc_jump1, oMan_pc_jump2);
}
