...
void main() {
	object oMan28_shield = GetObjectByTag("man28_shield", 0);
	if ((GetExitingObject() == oMan28_shield)) {
		AssignCommand(oMan28_shield, ClearAllActions());
		AssignCommand(oMan28_shield, sub1());
	}
}
