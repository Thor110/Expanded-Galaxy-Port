...
void main() {
	object oMan28_sur4 = GetObjectByTag("man28_sur4", 0);
	ChangeToStandardFaction(OBJECT_SELF, 3);
	ChangeToStandardFaction(oMan28_sur4, 3);
	sub1(OBJECT_INVALID);
	AssignCommand(oMan28_sur4, sub1(OBJECT_INVALID));
}
