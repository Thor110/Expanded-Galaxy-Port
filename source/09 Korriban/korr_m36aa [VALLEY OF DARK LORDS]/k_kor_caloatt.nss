...
void main() {
	int int1 = 0;
	object oKor_calo_thug1 = GetObjectByTag("kor_calo_thug1", 0);
	object oKor_calo_thug2 = GetObjectByTag("kor_calo_thug2", 0);
	object oKor36_kor35 = GetObjectByTag("kor36_kor35", 0);
	SetLocked(oKor36_kor35, 0);
	if (GetIsObjectValid(oKor_calo_thug1)) {
		ChangeToStandardFaction(oKor_calo_thug1, 1);
		DelayCommand(0.5, AssignCommand(oKor_calo_thug1, ClearAllActions()));
		DelayCommand(0.5, AssignCommand(oKor_calo_thug1, sub1(OBJECT_INVALID)));
	}
	if (GetIsObjectValid(oKor_calo_thug2)) {
		ChangeToStandardFaction(oKor_calo_thug2, 1);
		DelayCommand(0.5, AssignCommand(oKor_calo_thug2, ClearAllActions()));
		DelayCommand(0.5, AssignCommand(oKor_calo_thug2, sub1(OBJECT_INVALID)));
	}
	ChangeToStandardFaction(GetObjectByTag("kor_calo", 0), 1);
