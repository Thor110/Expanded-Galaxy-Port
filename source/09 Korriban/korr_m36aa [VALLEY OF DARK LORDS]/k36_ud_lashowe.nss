...
void main() {
	...
	if ((int1 == 1001)) {
		if (((((!GetIsInConversation(OBJECT_SELF)) && (!GetIsInCombat(OBJECT_SELF))) && (!sub1(OBJECT_SELF))) && (!sub2(OBJECT_SELF, intGLOB_118)))) {
			ClearAllActions();
			sub3(OBJECT_SELF, intGLOB_118, 1);
			ActionPlayAnimation(3, 1.0, 1000.0);
			ActionDoCommand(sub3(OBJECT_SELF, intGLOB_118, 0));
		}
	}
	else {
		if ((int1 == 1002)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								SetGlobalBoolean("KOR_LASHOWE_VALLEY", 1);
								AddJournalQuestEntry("kor35_aidlashowe", 40, 0);
