...
void main() {
	int int1 = 0;
	object oKor_bandon_thug1 = GetObjectByTag("kor_bandon_thug1", 0);
	object oKor_bandon_thug2 = GetObjectByTag("kor_bandon_thug2", 0);
	if (GetIsObjectValid(oKor_bandon_thug1)) {
		ChangeToStandardFaction(oKor_bandon_thug1, 1);
		DelayCommand(0.5, AssignCommand(oKor_bandon_thug1, ClearAllActions()));
		DelayCommand(0.5, AssignCommand(oKor_bandon_thug1, sub1(OBJECT_INVALID)));
	}
	if (GetIsObjectValid(oKor_bandon_thug2)) {
		ChangeToStandardFaction(oKor_bandon_thug2, 1);
		DelayCommand(0.5, AssignCommand(oKor_bandon_thug2, ClearAllActions()));
		DelayCommand(0.5, AssignCommand(oKor_bandon_thug2, sub1(OBJECT_INVALID)));
	}
	ChangeToStandardFaction(GetObjectByTag("kor_bandon", 0), 1);
	DelayCommand(0.5, ClearAllActions());
	DelayCommand(0.5, AssignCommand(GetObjectByTag("kor_bandon", 0), sub1(OBJECT_INVALID)));
}
