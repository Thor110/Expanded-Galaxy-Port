...
void main() {
	...
	if (((GetIsObjectValid(oKor36_lashowe) && (GetEnteringObject() == oNPC)) && (!sub1(OBJECT_SELF, intGLOB_1)))) {
		AssignCommand(oKor36_lashowe, ClearAllActions());
		sub2(OBJECT_SELF, intGLOB_1, 1);
		sub3("kor36_lashowe", "", OBJECT_INVALID);
	}
}
