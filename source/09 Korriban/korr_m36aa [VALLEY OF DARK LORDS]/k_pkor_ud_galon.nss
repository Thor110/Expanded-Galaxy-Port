...
void main() {
	...
	if ((int1 == 1001)) {
		if (((((!GetIsInConversation(OBJECT_SELF)) && (!sub1(OBJECT_SELF, intGLOB_120))) && (!GetGlobalBoolean("KOR_END_HOSTILE"))) && (!sub1(OBJECT_SELF, intGLOB_118)))) {
			int nRandom = d3(1);
			if ((nRandom == 1)) {
				ClearAllActions();
				SetFacing(90.0);
				sub2(OBJECT_SELF, intGLOB_120, 1);
				ActionPlayAnimation(20, 1.0, 15.0);
				ActionDoCommand(sub2(OBJECT_SELF, intGLOB_120, 0));
			}
			else {
				if ((nRandom == 2)) {
					ClearAllActions();
					...
					if ((nRandom == 3)) {
						...
						SetFacing(90.0);
						sub2(OBJECT_SELF, intGLOB_120, 1);
						ActionPlayAnimation(11, 1.0, 0.0);
						ActionDoCommand(sub2(OBJECT_SELF, intGLOB_120, 0));
					}
				}
			}
