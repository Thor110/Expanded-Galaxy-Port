...
void sub1(object objectParam1) {
	sub2(objectParam1, intGLOB_141);
}

void main() {
	object oK38a_door_locked = GetObjectByTag("k38a_door_locked", 0);
	SetLocked(oK38a_door_locked, 0);
	SetGlobalNumber("KOR_ROGUE_DROID", 2);
	object oPC = GetFirstPC();
	...
	DelayCommand(0.5, AssignCommand(oKor38a_wardroid2, sub3(oPC)));
	DelayCommand(0.5, AssignCommand(oKor38a_wardroid3, sub3(oPC)));
	...
	while ((int1 < 3)) {
		...
		AssignCommand(oKor38_door7stat, ActionOpenDoor(oK38a_door_locked));
