			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub10(intGLOB_75, 1));
					}
					else {
	...
	if ((!sub7(intGLOB_84))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub7(intGLOB_81)) {
				...
				if (((nLocal < int4) && (!sub7(intGLOB_81)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub7(intGLOB_82), 2.5, float3);
			if (sub7(intGLOB_75)) {
...
int sub71() {
	...
	if ((sub7(intGLOB_130) && (!sub7(intGLOB_131)))) {
		if (sub72()) {
			return 1;
		}
	}
...
int sub69(object objectParam1) {
	...
	if (sub15(intGLOB_146, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub15(intGLOB_144, object1)) {
			return 1;
		}
	}
	object object4 = sub14();
	if (GetIsObjectValid(object4)) {
		if (sub15(intGLOB_145, object4)) {
			return 1;
		}
	}
	object3 = sub28();
	...
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub23(intGLOB_31, 1);
		}
		else {
			talent1 = sub23(intGLOB_31, 0);
		}
	}
	else {
		...
		if (GetIsObjectValid(object3)) {
			...
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub23(intGLOB_32, 1);
			}
			else {
				talent1 = sub23(intGLOB_32, 0);
			}
		}
	}
...
int sub32(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub15(intGLOB_144, oNPC)) {
			return 1;
		}
	}
	oNPC = sub14();
	if (GetIsObjectValid(oNPC)) {
		if (sub15(intGLOB_145, oNPC)) {
			return 1;
		}
	}
	talent1 = sub34(0);
			...
			if ((intParam1 == intGLOB_144)) {
				...
				if ((intParam1 == intGLOB_145)) {
					...
					if ((intParam1 == intGLOB_146)) {
						...
						sub3(("GENERIC DEBUG *************** Spell Effect 22" + sub9(GetHasSpellEffect(22, OBJECT_SELF))));
						sub3(("GENERIC DEBUG *************** Spell Effect 33" + sub9(GetHasSpellEffect(33, OBJECT_SELF))));
						sub3(("GENERIC DEBUG *************** Spell Effect 36" + sub9(GetHasSpellEffect(36, OBJECT_SELF))));
...
int sub11() {
	int int1 = 0;
	if (((sub7(intGLOB_137) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub7(intGLOB_134))) {
...
int sub8() {
	...
	sub3(((("GENERIC DEBUG *************** Shield Boolean (" + sub9(intGLOB_135)) + ") = ") + sub9(sub7(intGLOB_135))));
	if (((sub7(intGLOB_135) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub2(object objectParam1) {
	...
	sub5();
	{
		...
		if (((((!sub7(intGLOB_130)) && (!sub7(intGLOB_131))) && (!sub7(intGLOB_132))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub7(intGLOB_140) == 1)) {
					if ((sub12() == 1)) {
						return;
					}
				}
				if ((sub7(intGLOB_134) == 1)) {
...
void main() {
	...
	object object1 = GetItemPossessedBy(OBJECT_SELF, "g_w_lghtsbr02");
	if (GetIsObjectValid(object1)) {
		...
		if ((!GetIsObjectValid(oRWeapItem))) {
			...
			sub1("Sword already in slot", 10, 10, 5.0);
		}
	}
	else {
		sub1("Sword not valid", 10, 10, 4.0);
	}
	object object5 = GetItemPossessedBy(OBJECT_SELF, "g_w_shortsbr02");
	if (GetIsObjectValid(object5)) {
		object oLWeapItem = GetItemInSlot(5, OBJECT_SELF);
		if ((!GetIsObjectValid(oLWeapItem))) {
			ClearAllActions();
			ActionEquipItem(object5, 5, 0);
			sub1("Yuthura Sword 2 valid", 12, 12, 4.0);
		}
		else {
			sub1("Sword already in slot", 10, 10, 5.0);
		}
		...
		sub1("Yuthura Sword 2 not valid", 12, 12, 4.0);
	}
	object oPC = GetFirstPC();
	DelayCommand(0.5, sub2(oPC));
}
