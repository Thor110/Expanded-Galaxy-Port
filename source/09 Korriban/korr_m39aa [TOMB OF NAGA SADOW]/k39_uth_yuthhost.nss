...
void main() {
	...
	sub1(1);
	object object5 = GetItemPossessedBy(oKor39_yuthura, "g_w_lghtsbr02");
	if (GetIsObjectValid(object5)) {
		object oRWeapItem = GetItemInSlot(4, oKor39_yuthura);
		if ((!GetIsObjectValid(oRWeapItem))) {
			AssignCommand(oKor39_yuthura, ClearAllActions());
			AssignCommand(oKor39_yuthura, ActionEquipItem(object5, 4, 0));
	...
	object object9 = GetItemPossessedBy(oKor39_yuthura, "g_w_shortsbr02");
	if (GetIsObjectValid(object9)) {
		object oLWeapItem = GetItemInSlot(5, oKor39_yuthura);
		if ((!GetIsObjectValid(oLWeapItem))) {
			AssignCommand(oKor39_yuthura, ClearAllActions());
			AssignCommand(oKor39_yuthura, ActionEquipItem(object9, 5, 0));
