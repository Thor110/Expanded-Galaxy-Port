					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								if ((sub1() == 2)) {
									CancelCombat(oKor39_yuthura);
									sub2("kor39_yuthura", "", OBJECT_INVALID);
								}
								else {
									if (((sub1() == 3) && GetIsDead(oKor39_yuthura))) {
										...
										sub4(6);
										if ((!GetGlobalBoolean("KOR_PC_SITH"))) {
										}
									}
									else {
										if ((sub1() == 4)) {
											object object11 = GetObjectByTag("kor39_kor36", 0);
											SetLocked(object11, 0);
											object object13 = GetObjectByTag("kor39_dooracid", 0);
											SetLocked(object13, 0);
											object object15 = GetObjectByTag("k39_door_starmap", 0);
											SetLocked(object15, 0);
											sub4(6);
										}
									}
								}
								if (((GetGlobalNumber("KOR_FINAL_TEST") == 4) && GetIsDead(oKor39_yuthura))) {
									object object17 = GetObjectByTag("kor39_kor36", 0);
									SetLocked(object17, 0);
									object object19 = GetObjectByTag("kor39_dooracid", 0);
									SetLocked(object19, 0);
									object object21 = GetObjectByTag("k39_door_starmap", 0);
									SetLocked(object21, 0);
								}
							}
							else {
								if ((int1 == 1008)) {
