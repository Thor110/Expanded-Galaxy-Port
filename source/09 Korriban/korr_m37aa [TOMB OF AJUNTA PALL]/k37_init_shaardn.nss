...
void main() {
	...
	object oKor37_shaardan = GetObjectByTag("kor37_shaardan", 0);
	if ((((sub1() == 0) && (GetEnteringObject() == oNPC)) && GetIsObjectValid(oKor37_shaardan))) {
		sub3(1);
		sub5("kor37_shaardan", "", OBJECT_INVALID);
	}
}
