...
void main() {
	if ((sub1() == 0)) {
		...
		object object9 = GetItemPossessedBy(oPC, "k37_itm_freednf1");
		object object11 = GetItemPossessedBy(oNPC, "k37_itm_freednf1");
		object object13 = GetItemPossessedBy(object7, "k37_itm_freednf1");
