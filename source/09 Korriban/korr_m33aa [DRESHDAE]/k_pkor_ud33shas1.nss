...
void main() {
	...
	if ((int1 == 1001)) {
		...
		if (((!sub1(OBJECT_SELF)) && (!GetIsInConversation(oKor33_shaardan)))) {
			ClearAllActions();
			sub2("Heartbeat", 10, 10, 5.0);
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 101)) {
												...
												if (GetIsObjectValid(oK33a_way_shavic)) {
													ClearAllActions();
													ActionMoveToObject(oK33a_way_shavic, 1, 1.0);
													ActionDoCommand(sub2("Way exists", 10, 10, 5.0));
													ActionDoCommand(DestroyObject(OBJECT_SELF, 0.0, 0, 0.0));
												}
												else {
													sub2("Way doesn't exist", 10, 10, 5.0);
												}
											}
											else {
												if ((int1 == 102)) {
													object object5 = GetObjectByTag("kor33_shaardan", 0);
