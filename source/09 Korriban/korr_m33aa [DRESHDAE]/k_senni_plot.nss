...
void main() {
	object oNearestK_senni_pc0_jump = GetNearestObjectByTag("k_senni_pc0_jump", OBJECT_SELF, 1);
	object oNearestK_senni_pc1_jump = GetNearestObjectByTag("k_senni_pc1_jump", OBJECT_SELF, 1);
	object oNearestK_senni_pc2_jump = GetNearestObjectByTag("k_senni_pc2_jump", OBJECT_SELF, 1);
	ActionPauseConversation();
	ActionJumpToLocation(GetLocation(GetObjectByTag("wp_sennispawn2", 0)));
	sub1(oNearestK_senni_pc0_jump, oNearestK_senni_pc1_jump, oNearestK_senni_pc2_jump);
	ActionMoveToObject(GetObjectByTag("k_senni_pc0_jump", 0), 0, 2.0);
