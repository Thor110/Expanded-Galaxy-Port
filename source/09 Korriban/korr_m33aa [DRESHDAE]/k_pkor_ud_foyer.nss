	...
	if ((int1 == 1001)) {
		if (((!sub1(OBJECT_SELF, intGLOB_118)) && (!GetIsInConversation(OBJECT_SELF)))) {
			...
			if ((int5 == 1)) {
				...
				object oNearestKor33a_computer1 = GetNearestObjectByTag("kor33a_computer1", OBJECT_SELF, 1);
				vector vPosition = GetPosition(oNearestKor33a_computer1);
				...
				if ((int5 == 2)) {
					ClearAllActions();
					ActionDoCommand(sub2(OBJECT_SELF, intGLOB_118, 1));
					object oNearestKor33a_computer2 = GetNearestObjectByTag("kor33a_computer2", OBJECT_SELF, 1);
					vector struct4 = GetPosition(oNearestKor33a_computer2);
