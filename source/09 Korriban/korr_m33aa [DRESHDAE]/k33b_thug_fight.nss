...
void main() {
	...
	object oK33b_siththug1 = GetObjectByTag("k33b_siththug1", 0);
	object oK33b_siththug2 = GetObjectByTag("k33b_siththug2", 0);
	object oK33b_siththug3 = GetObjectByTag("k33b_siththug3", 0);
	object oNPC = GetPartyMemberByIndex(0);
	object object9 = GetPartyMemberByIndex(1);
	object object11 = GetPartyMemberByIndex(2);
	ChangeToStandardFaction(oK33b_siththug1, 1);
	ChangeToStandardFaction(oK33b_siththug2, 1);
	ChangeToStandardFaction(oK33b_siththug3, 1);
	DelayCommand(0.5, AssignCommand(oK33b_siththug1, sub1(oNPC)));
	if (GetIsObjectValid(object9)) {
		DelayCommand(0.5, AssignCommand(oK33b_siththug2, sub1(object9)));
	}
	else {
		DelayCommand(0.5, AssignCommand(oK33b_siththug2, sub1(oNPC)));
	}
	if (GetIsObjectValid(object11)) {
		DelayCommand(0.5, AssignCommand(oK33b_siththug3, sub1(object11)));
	}
	else {
		DelayCommand(0.5, AssignCommand(oK33b_siththug3, sub1(oNPC)));
	}
	DelayCommand(0.5, ActionAttack(oNPC, 0));
}
