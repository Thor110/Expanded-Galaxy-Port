...
void main() {
	...
	SetGlobalBoolean("KOR_PRESTIGE_END", 1);
	...
	if ((GetIsObjectValid(object3) && GetIsObjectValid(oK35_way_pcroom1))) {
		location location1 = GetLocation(oK35_way_pcroom1);
		AssignCommand(object3, ClearAllActions());
		DelayCommand(0.5, sub7(object3, location1));
		sub8("PC1 Valid", 10, 10, 5.0);
	}
	else {
		sub8("PC1 Not Valid", 10, 10, 5.0);
	}
	if ((GetIsObjectValid(object5) && GetIsObjectValid(oK35_way_pcroom2))) {
		location location3 = GetLocation(oK35_way_pcroom2);
		AssignCommand(object5, ClearAllActions());
		DelayCommand(0.5, sub7(object5, location3));
		sub8("PC2 Valid", 5, 5, 5.0);
	}
	else {
		sub8("PC2 Not Valid", 5, 5, 5.0);
	}
	AssignCommand(oNPC, ClearAllActions());
	AssignCommand(oNPC, JumpToObject(oK35_way_pcroom, 1));
	SetGlobalFadeIn(2.0, 2.0, 0.0, 0.0, 0.0);
	ActionDoCommand(sub9(OBJECT_SELF, intGLOB_1, 0));
	AssignCommand(object3, sub5(intGLOB_130, 0));
	AssignCommand(object5, sub5(intGLOB_130, 0));
}
