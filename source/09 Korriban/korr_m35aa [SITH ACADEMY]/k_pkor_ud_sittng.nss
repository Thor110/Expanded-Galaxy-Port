...
void main() {
	...
	if ((int1 == 1001)) {
		...
		if (((!GetIsInConversation(OBJECT_SELF)) && (!sub1(OBJECT_SELF, intGLOB_118)))) {
			ClearAllActions();
			sub2(OBJECT_SELF, intGLOB_118, 1);
			object oNearestKor35_sithteach3 = GetNearestObjectByTag("kor35_sithteach3", OBJECT_SELF, 1);
			vector vPosition = GetPosition(oNearestKor35_sithteach3);
			ActionDoCommand(SetFacingPoint(vPosition));
			ActionPlayAnimation(3, 1.0, 1000.0);
