...
void main() {
	...
	if ((int1 == 1001)) {
		if (((!GetIsInConversation(OBJECT_SELF)) && (!GetIsInCombat(OBJECT_SELF)))) {
			if ((((GetGlobalNumber("KOR_START_FINAL") < 1) && (GetGlobalNumber("KOR_SITHJOIN") > 0)) && (!sub1(OBJECT_SELF, intGLOB_118)))) {
				ClearAllActions();
