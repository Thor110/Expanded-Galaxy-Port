...
void main() {
	...
	if ((int1 == 1001)) {
		if ((((((!GetIsInConversation(OBJECT_SELF)) && (!GetIsInCombat(OBJECT_SELF))) && (!sub1(OBJECT_SELF, intGLOB_118))) && sub1(OBJECT_SELF, intGLOB_119)) && (GetGlobalNumber("KOR_SHAARDAN_SWORD") != 2))) {
			ClearAllActions();
