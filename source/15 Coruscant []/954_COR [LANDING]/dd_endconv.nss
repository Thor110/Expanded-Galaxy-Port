			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub5(intGLOB_52, 1));
					}
					else {
...
void sub1() {
	if ((!sub2(intGLOB_61))) {
		...
		if (((nLocal < 10) && (nLocal > 0))) {
			...
			if ((nLocal == 0)) {
				if (sub2(intGLOB_58)) {
					...
					if (sub2(intGLOB_54)) {
						int int11 = sub3(OBJECT_SELF, int6);
						if (((int11 > 0) && (int11 < 10))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string11))) {
			...
			ActionForceMoveToObject(object3, sub2(intGLOB_59), fPersonalSpace, float4);
			if (sub2(intGLOB_52)) {
