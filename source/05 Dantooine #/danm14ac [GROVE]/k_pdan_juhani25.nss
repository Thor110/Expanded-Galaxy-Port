...
void main() {
	object oWp_cut02 = GetObjectByTag("wp_cut02", 0);
	object oWp_cut03 = GetObjectByTag("wp_cut03", 0);
	object oWp_cut04 = GetObjectByTag("wp_cut04", 0);
	object oDan14_juhani = GetObjectByTag("dan14_juhani", 0);
	SetPartyLeader(0xFFFFFFFF);
	sub1(oWp_cut02, oWp_cut03, oWp_cut04);
	ActionPauseConversation();
	ActionDoCommand(SignalEvent(oDan14_juhani, EventUserDefined(10)));
}
