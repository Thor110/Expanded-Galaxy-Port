							...
							if ((nCurHP <= 200)) {
								if (GetIsObjectValid(oNearestSta_malak_drain)) {
									...
									if ((GetDistanceToObject(oNearestSta_malak_drain) <= 5.0)) {
										DelayCommand(0.5, AssignCommand(object9, ClearAllActions()));
										if ((int15 == 0)) {
											DelayCommand(0.5, AssignCommand(oSta_invis_conv_2, ActionStartConversation(oSta_invis_conv_2, "", 0, 0, 0, "", "", "", "", "", "")));
										}
										else {
											DelayCommand(0.5, AssignCommand(object7, ActionStartConversation(object7, "", 0, 0, 0, "", "", "", "", "", "")));
										}
									}
									else {
										DelayCommand(0.5, ActionMoveToObject(oNearestSta_malak_drain, 1, 1.0));
									}
								}
								else {
