...
void main() {
	if (sub1()) {
		sub4(1);
		AssignCommand(sub5(), ActionWait(1.0));
		AssignCommand(sub5(), ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", ""));
	//}
	sub3(OBJECT_SELF, intGLOB_10, 1);
  //AssignCommand(GetObjectByTag("Carth"), ActionStartConversation(GetFirstPC(), "end_carth001", 0, 0, 1, "", "", "", "", "", ""));
