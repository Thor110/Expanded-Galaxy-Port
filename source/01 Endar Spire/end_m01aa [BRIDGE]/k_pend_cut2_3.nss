			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub3(intGLOB_73, 1));
					}
					else {
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				...
				sub5(("GENERIC DEBUG *************** Starting Jedi Combo " + sub51(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub5(("GENERIC DEBUG *************** Starting Droid Combo " + sub51(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub52(int2);
				}
					...
					sub5(("GENERIC DEBUG *************** Starting NPC Combo " + sub51(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub52(int2);
				}
		...
		sub5(("GENERIC DEBUG *************** Continuing Combo " + sub51(structGLOB_1.int15)));
...
object sub1() {
	return GetObjectByTag("end_trask", 0);
}
...
void main() {
	...
	object object20 = sub1();//GetObjectByTag("end_trask", 0);
	object oPC = GetFirstPC();
	sub2(6.0);
	DelayCommand(2.0, AssignCommand(oEnd_cut2_sith3, ClearAllActions()));
	DelayCommand(2.1, AssignCommand(oEnd_cut2_sith3, CutsceneAttack(oEnd_cut2_soldier2, 163, 4, 0)));
	DelayCommand(0.5, AssignCommand(oEnd_cut2_sith2, CutsceneAttack(oEnd_cut2_soldier1, 239, 4, 0)));
	CancelCombat(oEnd_cut2_sith4);
	ChangeToStandardFaction(oEnd_cut2_sith4, 5);
	AssignCommand(oEnd_cut2_sith4, ActionUnequipItem(oRWeapItem, 1));
	DelayCommand(4.8, AssignCommand(oEnd_cut2_sith4, ActionEquipMostDamagingRanged(OBJECT_INVALID)));
	CancelCombat(oEnd_cut2_sith4);
	DelayCommand(0.1, AssignCommand(oEnd_cut2_sith4, ActionUseTalentOnObject(talSpell, oEnd_cut2_soldier2)));
	DelayCommand(2.5, SetDialogPlaceableCamera(37));
	DelayCommand(2.75, SetMinOneHP(oEnd_cut2_soldier2, 0));
	DelayCommand(2.75, SetMinOneHP(oEnd_cut2_soldier1, 0));
	DelayCommand(2.75, SetMinOneHP(oEnd_cut2_sith3, 0));
	DelayCommand(2.8, ApplyEffectToObject(0, EffectDeath(0, 1), oEnd_cut2_soldier2, 0.0));
	DelayCommand(2.9, ApplyEffectToObject(0, EffectDeath(0, 1), oEnd_cut2_soldier1, 0.0));
	DelayCommand(2.95, ApplyEffectToObject(0, EffectDeath(0, 1), oEnd_cut2_sith3, 0.0));
	DelayCommand(6.0, ChangeToStandardFaction(oEnd_cut2_sith4, 1));
	DelayCommand(6.0, ChangeToStandardFaction(oEnd_cut2_sith1, 1));
	DelayCommand(6.0, ChangeToStandardFaction(object9, 1));
