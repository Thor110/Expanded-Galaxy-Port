			...
			if ((int1 == 1003)) {
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							if (((GetCurrentHitPoints(OBJECT_SELF) < (GetMaxHitPoints(OBJECT_SELF) / 2)) && (!sub1(OBJECT_SELF, intGLOB_118)))) {
								int int6;
								object object1;
								sub2(OBJECT_SELF, intGLOB_118, 1);
								sub2(GetObjectByTag("lev40_forcepush2", 0), intGLOB_118, 0);
								...
								NoClicksFor(1.2);
								DelayCommand(1.0, AssignCommand(GetObjectByTag("lev40_talker", 0), ActionStartConversation(OBJECT_SELF, "", 0, 0, 0, "", "", "", "", "", "")));
							}
							else {
								if ((((GetCurrentHitPoints(OBJECT_SELF) < (GetMaxHitPoints(OBJECT_SELF) / 3)) && (!sub1(OBJECT_SELF, intGLOB_119))) && sub1(OBJECT_SELF, intGLOB_120))) {
									...
									SetCommandable(1, oBastila);
									SetCommandable(1, oCarth);
									AssignCommand(oBastila, ClearAllEffects());
									AssignCommand(oCarth, ClearAllEffects());
									sub3(oBastila, GetLocation(GetObjectByTag("lev40_wpbastila", 0)));
									sub3(oCarth, GetLocation(GetObjectByTag("lev40_wpcarth", 0)));
									NoClicksFor(1.2);
									DelayCommand(1.0, AssignCommand(oLev40_talker, ActionStartConversation(oLev40_talker, "lev40_carth", 0, 1, 0, "", "", "", "", "", "")));
								}
							}
						}
						else {
