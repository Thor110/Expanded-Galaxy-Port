...
void main() {
	...
	string string1;
	if (((GetIsPC(oEntering) && (!sub1(OBJECT_SELF))) && (GetGlobalNumber("Lev_MalakVision") > 0))) {
		string1 = "lev40_darthmalak";
		CreateObject(1, string1, location1, 0);
		sub2(OBJECT_SELF, 1);
		sub3("DARTH TALKING", 5, 5, 5.0);
		DelayCommand(0.3, AssignCommand(GetObjectByTag("darthmalak400", 0), ActionStartConversation(GetFirstPC(), "lev40_darthmala2", 0, 0, 1, "", "", "", "", "", "")));
	}
}
