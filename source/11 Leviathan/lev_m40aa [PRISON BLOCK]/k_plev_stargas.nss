...
void main() {
	SetGlobalNumber("LEV_RIOTS", (GetGlobalNumber("LEV_RIOTS") | 8));
	DelayCommand(1.0, sub1("stargas1", 10.0, 1));
	DelayCommand(1.0, sub1("stargas2", 10.0, 1));
	DelayCommand(1.0, sub1("stargas3", 10.0, 1));
	DelayCommand(1.0, sub1("stargas4", 10.0, 1));
	DelayCommand(1.0, sub1("stargas5", 10.0, 1));
	DelayCommand(1.0, sub1("stargas6", 10.0, 1));
