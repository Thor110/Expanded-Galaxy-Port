...
void main() {
	...
	if (((GetIsPC(oEntering) && (!sub1(OBJECT_SELF))) && (GetGlobalNumber("Lev_Escape") == 1))) {
		sub2(OBJECT_SELF, 1);
		SetLocked(oNearestLev40_cell08, 0);
		AssignCommand(oNearestLev40_cell08, ActionOpenDoor(oNearestLev40_cell08));
		AssignCommand(oLevguard401, ActionStartConversation(GetFirstPC(), "lev40_mission", 0, 0, 0, "", "", "", "", "", ""));
	}
}
