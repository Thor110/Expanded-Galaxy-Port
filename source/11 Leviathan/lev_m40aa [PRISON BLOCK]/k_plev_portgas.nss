...
void main() {
	SetGlobalNumber("LEV_RIOTS", (GetGlobalNumber("LEV_RIOTS") | 4));
	DelayCommand(1.0, sub1("portgas1", 10.0, 1));
	DelayCommand(1.0, sub1("portgas2", 10.0, 1));
	DelayCommand(1.0, sub1("portgas3", 10.0, 1));
	DelayCommand(1.0, sub1("portgas4", 10.0, 1));
	DelayCommand(1.0, sub1("portgas5", 10.0, 1));
	DelayCommand(1.0, sub1("portgas6", 10.0, 1));
