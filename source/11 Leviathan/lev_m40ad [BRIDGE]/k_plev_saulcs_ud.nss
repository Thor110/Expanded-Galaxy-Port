			...
			if ((int1 == 1003)) {
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							if (((GetCurrentHitPoints(OBJECT_SELF) == 1) && (!sub1(OBJECT_SELF, intGLOB_125)))) {
								sub2(OBJECT_SELF, intGLOB_125, 1);
								...
								sub3(OBJECT_SELF, 1);
								sub3(GetObjectByTag("carth", 0), 1);
								DelayCommand(0.6, ActionPlayAnimation(23, 0.7, (-1.0)));
											...
											if ((int1 == 2000)) {
												if ((!sub1(OBJECT_SELF, intGLOB_118))) {
													...
													if ((!sub1(OBJECT_SELF, intGLOB_119))) {
														...
														if ((!sub1(OBJECT_SELF, intGLOB_120))) {
															sub2(OBJECT_SELF, intGLOB_120, 1);
														}
														else {
															if ((!sub1(OBJECT_SELF, intGLOB_121))) {
																sub2(OBJECT_SELF, intGLOB_121, 1);
															}
															else {
																if ((!sub1(OBJECT_SELF, intGLOB_122))) {
																	sub2(OBJECT_SELF, intGLOB_122, 1);
																}
																else {
																	if ((!sub1(OBJECT_SELF, intGLOB_123))) {
																		sub2(OBJECT_SELF, intGLOB_123, 1);
																	}
																	else {
																		object oNPC;
																		object oLev40_talker = GetObjectByTag("lev40_talker", 0);
																		int int11;
																		sub4("SURRENDERING...", 5, 5, 5.0);
																		ActionUnequipItem(GetItemInSlot(4, OBJECT_SELF), 1);
																		SetLocked(GetObjectByTag("lev40_bdgdoor", 0), 0);
																		int11 = 0;
																		while ((int11 < GetPartyMemberCount())) {
																			oNPC = GetPartyMemberByIndex(int11);
																			CancelCombat(oNPC);
																			if ((int11 > 0)) {
																				sub5(oNPC);
																			}
																		...
																		NoClicksFor(0.3);
																		DelayCommand(0.1, AssignCommand(oLev40_talker, ActionStartConversation(oLev40_talker, "", 0, 0, 0, "", "", "", "", "", "", 0)));
																	}
																}
															}
														}
