...
string sub10(object objectParam1);
void sub9();
	...
	if ((!sub11(intGLOB_82))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub11(intGLOB_79)) {
				...
				if (((nLocal < int4) && (!sub11(intGLOB_79)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub11(intGLOB_80), 2.5, float3);
			if (sub11(intGLOB_73)) {
...
int sub76() {
	sub7("GENERIC DEBUG *************** Start Commoner AI");
	...
	if (GetIsObjectValid(oNearest)) {
		...
		if (GetIsObjectValid(object3)) {
			sub7(("GENERIC DEBUG *************** Object Flee = " + sub8(object3)));
			sub7("GENERIC DEBUG *************** Clear 2720");
			ClearAllActions();
...
int sub75() {
	sub7(("GENERIC DEBUG *************** Post DCR Checks for " + sub8(OBJECT_SELF)));
	if ((sub11(intGLOB_128) && (!sub11(intGLOB_129)))) {
		if (sub76()) {
			return 1;
		}
	}
	else {
		if (sub11(intGLOB_129)) {
			sub7("GENERIC DEBUG *************** Clear 1000");
			ClearAllActions();
			return 1;
		}
	}
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub78(OBJECT_SELF) == 1))) {
		sub7("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
...
object sub74(object objectParam1) {
	sub7("GENERIC DEBUG *************** Starting: Determine Attack Target");
	int nStyle = GetPartyAIStyle();
	int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
	object object1;
	object oLastTarget = GetLastHostileTarget(OBJECT_SELF);
	sub7(((("GENERIC DEBUG *************** Intruder = " + IntToString(GetIsObjectValid(objectParam1))) + " Last Target = ") + IntToString(GetIsObjectValid(oLastTarget))));
	if (((GetIsObjectValid(objectParam1) && (!GetIsDead(objectParam1))) && (!GetIsDebilitated(objectParam1)))) {
		sub7(("GENERIC DEBUG *************** Intruder Target Returned = " + ObjectToString(objectParam1)));
		return objectParam1;
	}
	else {
		if (((GetIsObjectValid(oLastTarget) && (!GetIsDead(oLastTarget))) && (!GetIsDebilitated(oLastTarget)))) {
			sub7(("GENERIC DEBUG *************** Last Target Returned = " + ObjectToString(objectParam1)));
			return oLastTarget;
		}
		else {
			if ((nStyle == 0)) {
				int int13 = 1;
				sub7("GENERIC DEBUG *************** Getting nearest target - 249");
				...
				if ((nStyle == 1)) {
					...
					if (GetIsObjectValid(oLastActor)) {
						sub7("GENERIC DEBUG *************** Getting nearest target - 262");
						...
						if (GetIsObjectValid(oLastActor)) {
							sub7("GENERIC DEBUG *************** Getting nearest target - 269");
							object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
						}
					}
				}
					...
					if ((nStyle != 2)) {
						sub7("GENERIC DEBUG *************** Getting nearest target - 275");
						object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
					}
					else {
						sub7("GENERIC DEBUG *************** Getting nearest target - 279");
						object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
					}
				}
			}
	...
	if (GetIsObjectValid(object1)) {
		sub7(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub8(object1)));
		return object1;
	}
	sub7("GENERIC DEBUG *************** No Attack Targets Found");
...
int sub73(object objectParam1) {
	...
	object3 = sub32();
	sub7(("GENERIC DEBUG *************** Jedi Support AI: AOE Target = " + sub13(GetIsObjectValid(object3))));
	if (GetIsObjectValid(object3)) {
		...
		sub7("GENERIC DEBUG *************** Jedi Support AI: Inside the Party AI Section");
		object3 = sub74(OBJECT_INVALID);
		sub7(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub8(object3)));
		if (GetIsObjectValid(object3)) {
			sub7(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub8(object3)));
			if ((GetRacialType(object3) == 5)) {
	...
	if ((GetIsObjectValid(object3) && GetIsTalentValid(talent1))) {
		sub7("GENERIC DEBUG *************** Clear 1450");
		ClearAllActions();
		ActionUseTalentOnObject(talent1, object3);
		return 1;
	}
	sub7("GENERIC DEBUG *************** Jedi Support AI: Fall Through");
	return sub36(OBJECT_INVALID);
}
...
int sub72(object objectParam1) {
	if ((IsObjectPartyMember(OBJECT_SELF) || (d100(1) > 50))) {
		...
		if (((GetIsObjectValid(object1) && GetIsTalentValid(talent1)) && GetCreatureHasTalent(talent1, OBJECT_SELF))) {
			sub7("GENERIC DEBUG *************** Clear 1400");
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			return 1;
		}
		sub7("GENERIC DEBUG *************** Grenade AI Failure");
...
talent sub71(object objectParam1, talent talentParam2) {
	int int1;
	sub7("GENERIC DEBUG *************** Starting Droid Talent Double Check");
	if ((GetTypeFromTalent(talentParam2) == 0)) {
		sub7("GENERIC DEBUG *************** Droid Talent is a Spell");
																...
																if ((intParam1 == intGLOB_44)) {
																	...
																	if ((intParam1 == intGLOB_45)) {
																		...
																		if (((intParam1 == intGLOB_46) || (intParam1 == intGLOB_42))) {
																			sub7("GENERIC DEBUG *************** Melee/Ranged Breather");
																		}
																		else {
																						...
																						if ((intParam1 == intGLOB_64)) {
																							...
																							if ((intParam1 == intGLOB_65)) {
																								...
																								if (((intParam1 == intGLOB_66) || (intParam1 == intGLOB_67))) {
																									...
																									sub7(((("GENERIC DEBUG *************** Droid Items = " + sub8(oLArmItem)) + " / ") + sub8(oRArmItem)));
																									if (sub53()) {
																										sub7("GENERIC DEBUG *************** Droid Utility Check is TRUE");
																										return 1;
																									}
																									sub7("GENERIC DEBUG *************** Droid Utility Check is FALSE");
																								}
																							}
																						}
																					}
...
talent sub38(int intParam1) {
	...
	talent talent1;
	int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
	sub7("GENERIC DEBUG *************** Starting GetComboMove");
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				...
				sub7(("GENERIC DEBUG *************** Starting Jedi Combo " + sub54(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub7(("GENERIC DEBUG *************** Starting Droid Combo " + sub54(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub55(int2);
				}
					...
					sub7(("GENERIC DEBUG *************** Starting NPC Combo " + sub54(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub55(int2);
				}
		...
		sub7(("GENERIC DEBUG *************** Continuing Combo " + sub54(structGLOB_1.int15)));
...
object sub37() {
	sub7("GENERIC DEBUG *************** Starting Poison Check");
	effect efNext;
	...
	sub7("GENERIC DEBUG ***************  Returning Invalid Poison Object");
	return OBJECT_INVALID;
}
...
int sub36(object objectParam1) {
	...
	if ((nLocalBool == 1)) {
		...
		sub7("GENERIC DEBUG *************** Default AI Debug Start *************************");
		sub7(("GENERIC DEBUG *************** Intruder    = " + sub8(objectParam1)));
		sub7(("GENERIC DEBUG *************** Last Target = " + sub8(oNPC)));
		sub7(("GENERIC DEBUG *************** Closest     = " + sub8(oNearest)));
		if ((((IsObjectPartyMember(OBJECT_SELF) && GetIsObjectValid(oNPC)) && (!GetIsDead(oNPC))) && GetObjectSeen(oNPC, OBJECT_SELF))) {
			...
			if ((GetIsObjectValid(objectParam1) && GetObjectSeen(objectParam1, OBJECT_SELF))) {
				sub7("GENERIC DEBUG *************** Intruder becomes Target");
				oNPC = objectParam1;
			}
			else {
				if ((GetIsObjectValid(oNearest) && GetObjectSeen(oNearest, OBJECT_SELF))) {
					if (((((!GetIsObjectValid(oNPC)) || (!GetIsEnemy(oNPC, OBJECT_SELF))) || GetIsDead(oNPC)) || (GetCurrentHitPoints(oNPC) < GetCurrentHitPoints(oNearest)))) {
						sub7("GENERIC DEBUG *************** Closest becomes Target");
						oNPC = oNearest;
					}
				}
			}
	...
	sub7("GENERIC DEBUG *************** Default AI Debug End ***************************");
	sub7(((("GENERIC DEBUG *************** Target = " + sub8(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	if (GetIsObjectValid(oNPC)) {
		sub7("GENERIC DEBUG *************** Clear 1300");
		ClearAllActions();
		if (sub21()) {
			sub7("GENERIC DEBUG *************** Switching Weapons");
		}
		if ((GetIsTalentValid(talent1) && GetIsEnemy(oNPC, OBJECT_SELF))) {
			sub7("GENERIC DEBUG *************** Using Talent on Target");
			ActionUseTalentOnObject(talent1, oNPC);
			return 1;
		}
		else {
			if (GetIsEnemy(oNPC, OBJECT_SELF)) {
				sub7("GENERIC DEBUG *************** Action Attack by Default");
				ActionAttack(oNPC, 0);
				return 1;
			}
		}
	}
	sub7("GENERIC DEBUG *************** Default AI has failed to do an action");
	return 0;
}
...
talent sub34(object objectParam1, talent talentParam2) {
	...
	if ((GetTypeFromTalent(talentParam2) == 0)) {
		if (((GetIdFromTalent(talentParam2) == 49) || (GetIdFromTalent(talentParam2) == 4))) {
			sub7(("GENERIC DEBUG *************** Lightsaber Throw Check = " + FloatToString(GetDistanceBetween(OBJECT_SELF, objectParam1), 4, 2)));
...
int sub33() {
	sub7("GENERIC DEBUG *************** Boss AI: Start Targeted Action Routine");
	talent talent1;
	object object1;
	int int1;
	int nRandom = d6(1);
	...
	sub7((("GENERIC DEBUG *************** Boss AI: Get the #" + sub13(nRandom)) + " target"));
	object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, int4, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
	sub7(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub8(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub7(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub8(oNearest)) + " nCnt = ") + sub13(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub7(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub8(oNearest)));
			object1 = oNearest;
		}
		(int4++);
	...
	if ((int7 == 1)) {
		if (GetIsTalentValid(talent1)) {
			if ((GetTypeFromTalent(talent1) == 1)) {
				sub7(("GENERIC DEBUG *************** Boss AI: Talent Feat = " + sub13(GetIdFromTalent(talent1))));
			}
			else {
				if ((GetTypeFromTalent(talent1) == 0)) {
					sub7(("GENERIC DEBUG *************** Boss AI: Talent Power = " + sub13(GetIdFromTalent(talent1))));
				}
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			sub7("GENERIC DEBUG *************** Boss AI: Get Boss Combat Move AI Droid");
			int1 = 1;
		}
		talent1 = sub27(intGLOB_30, int1);
		talent1 = sub34(object1, talent1);
		talent1 = sub35(object1, talent1);
		sub7(("GENERIC DEBUG *************** Boss AI: Target = " + sub13(GetIsObjectValid(object1))));
		sub7(("GENERIC DEBUG *************** Boss AI: Talent = " + sub13(GetIsTalentValid(talent1))));
		if ((GetIsTalentValid(talent1) && GetIsObjectValid(object1))) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub7("GENERIC DEBUG *************** Boss AI: Targeted Power Success");
			return 1;
		}
	}
	sub7("GENERIC DEBUG *************** Boss AI: Targeted Failure");
	return 0;
}
...
int sub31() {
	sub7("GENERIC DEBUG *************** Boss AI: AOE Function Starting");
	talent talent1;
	object object1 = sub32();
	sub7(("GENERIC DEBUG *************** Boss AI: AOE Target = " + sub13(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		...
		if (GetIsTalentValid(talent1)) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub7("GENERIC DEBUG *************** Boss AI: AOE Success");
			return 1;
		}
	}
	sub7("GENERIC DEBUG *************** Boss AI: AOE Failure");
	return 0;
}
...
talent sub29(int intParam1) {
	...
	sub7(("GENERIC DEBUG *************** Last Force Power Used = " + sub13(nLastForce)));
	...
	sub7(("GENERIC DEBUG *************** Force Power Returned = " + sub13(GetIdFromTalent(talent1))));
	return talent1;
}
...
talent sub28(int intParam1) {
	...
	sub7("GENERIC DEBUG *************** Grenade Selection Failure");
	talent talent11;
	return talent11;
	return talent11;
}
...
talent sub27(int intParam1, int intParam2) {
	...
	if (((intParam1 == intGLOB_28) || (intParam1 == intGLOB_32))) {
		...
		if (GetIsTalentValid(talRandom)) {
			sub7("GENERIC DEBUG *************** Boss AI: Grenade Talent Chosen");
			return talRandom;
		}
	}
	if (((intParam1 == intGLOB_29) || (intParam1 == intGLOB_32))) {
		...
		if (GetIsTalentValid(talRandom)) {
			sub7("GENERIC DEBUG *************** Boss AI: AOE Force Power Talent Chosen");
			return talRandom;
		}
	}
	if (((intParam1 == intGLOB_30) || (intParam1 == intGLOB_32))) {
		if ((d100(1) > 50)) {
			...
			if (GetIsTalentValid(talRandom)) {
				sub7("GENERIC DEBUG *************** Boss AI: Targeted Force Power Talent Chosen");
				return talRandom;
			}
			talRandom = sub29(intParam2);
			if (GetIsTalentValid(talRandom)) {
		...
		if ((sub22(OBJECT_SELF) == 1)) {
			sub7("GENERIC DEBUG *************** Boss AI: Melee Feat Talent Chosen");
			talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
		}
		else {
			sub7("GENERIC DEBUG *************** Boss AI: Range Feat Talent Chosen");
		...
		if (((intParam1 == intGLOB_31) || (intParam1 == intGLOB_32))) {
			...
			sub7("GENERIC DEBUG *************** Boss AI: No Feats Available");
		}
	}
	return talRandom;
}
...
int sub23() {
	sub7("GENERIC DEBUG *************** Boss AI: Grenade Function Starting");
	talent talent1;
	object object1 = sub24();
	sub7(("GENERIC DEBUG *************** Boss AI: Grenade Target = " + sub13(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
...
int sub22(object objectParam1) {
	...
	sub7("GENERIC DEBUG *************** Return No Weapon Type");
	return 0;
}
...
int sub21() {
	...
	if (((((GetIsObjectValid(GetAttackTarget(OBJECT_SELF)) && (GetDistanceBetween(GetAttackTarget(OBJECT_SELF), OBJECT_SELF) <= 3.0)) && (sub22(OBJECT_SELF) != 1)) && (GetRacialType(OBJECT_SELF) == 6)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		...
		while (GetIsObjectValid(oInvItem)) {
			sub7("GENERIC DEBUG *************** Checking Melee Weapon");
			if (((((((((((((((GetBaseItemType(oInvItem) == 9) || (GetBaseItemType(oInvItem) == 6)) || (GetBaseItemType(oInvItem) == 80)) || (GetBaseItemType(oInvItem) == 78)) || (GetBaseItemType(oInvItem) == 8)) || (GetBaseItemType(oInvItem) == 2)) || (GetBaseItemType(oInvItem) == 0)) || (GetBaseItemType(oInvItem) == 10)) || (GetBaseItemType(oInvItem) == 4)) || (GetBaseItemType(oInvItem) == 1)) || (GetBaseItemType(oInvItem) == 5)) || (GetBaseItemType(oInvItem) == 7)) || (GetBaseItemType(oInvItem) == 3)) || (GetBaseItemType(oInvItem) == 79))) {
				sub7("GENERIC DEBUG *************** Equipping Melee Weapon");
		...
		if (((((((sub22(OBJECT_SELF) != 2) && (GetLevelByClass(4, OBJECT_SELF) == 0)) && (GetLevelByClass(3, OBJECT_SELF) == 0)) && (GetLevelByClass(5, OBJECT_SELF) == 0)) && (GetDistanceBetween(GetAttemptedAttackTarget(), OBJECT_SELF) > 3.0)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
			oInvItem = GetFirstItemInInventory(OBJECT_SELF);
			while (GetIsObjectValid(oInvItem)) {
				sub7("GENERIC DEBUG *************** Checking Ranged Weapon");
				if ((((((((((((((((GetBaseItemType(oInvItem) == 20) || (GetBaseItemType(oInvItem) == 12)) || (GetBaseItemType(oInvItem) == 77)) || (GetBaseItemType(oInvItem) == 19)) || (GetBaseItemType(oInvItem) == 16)) || (GetBaseItemType(oInvItem) == 21)) || (GetBaseItemType(oInvItem) == 13)) || (GetBaseItemType(oInvItem) == 24)) || (GetBaseItemType(oInvItem) == 14)) || (GetBaseItemType(oInvItem) == 15)) || (GetBaseItemType(oInvItem) == 18)) || (GetBaseItemType(oInvItem) == 23)) || (GetBaseItemType(oInvItem) == 17)) || (GetBaseItemType(oInvItem) == 22)) || (GetBaseItemType(oInvItem) == 17))) {
					sub7("GENERIC DEBUG *************** Equipping Ranged Weapon");
	...
	sub7("GENERIC DEBUG *************** Should not currently change weapons");
	return 0;
}
...
object sub20(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		sub7("GENERIC DEBUG *************** Searching for Alternate Target");
		oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0, 6, 0xFFFFFFFF, 0xFFFFFFFF);
		sub7(("GENERIC DEBUG *************** Alternate Target = " + sub8(oNearest)));
	}
	sub7(("GENERIC DEBUG *************** Heal Drain Target = " + sub13(intParam1)));
	sub7(("GENERIC DEBUG *************** Get Active Party Member: " + sub8(oNearest)));
	return oNearest;
}
...
int sub19(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_141)) {
			...
			if ((intParam1 == intGLOB_142)) {
				...
				if ((intParam1 == intGLOB_143)) {
					sub7(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub8(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
					if ((GetRacialType(OBJECT_SELF) != 5)) {
					...
					int3 = 0;
					if ((GetCreatureHasTalent(talSpell, OBJECT_SELF) || GetCreatureHasTalent(talent2, OBJECT_SELF))) {
						sub7("GENERIC DEBUG *************** I have Heal or Cure");
						int3 = 1;
						if (GetCreatureHasTalent(talSpell, OBJECT_SELF)) {
							talent8 = talSpell;
						}
						...
						if (((GetIsTalentValid(talBest) || GetCreatureHasTalent(talent6, OBJECT_SELF)) || GetCreatureHasTalent(talent7, OBJECT_SELF))) {
							if ((objectParam2 == OBJECT_SELF)) {
								if ((GetCreatureHasTalent(talent7, OBJECT_SELF) && (!IsObjectPartyMember(OBJECT_SELF)))) {
									sub7("GENERIC DEBUG *************** I have Death Field");
									int3 = 1;
									int4 = 1;
									talent8 = talent7;
								}
									...
									if ((GetCreatureHasTalent(talent6, OBJECT_SELF) && (!IsObjectPartyMember(OBJECT_SELF)))) {
										sub7("GENERIC DEBUG *************** I have Drain Life");
										int3 = 1;
										int4 = 1;
										talent8 = talent6;
									}
									else {
										sub7("GENERIC DEBUG *************** I have a Med Pack");
										int3 = 1;
										talent8 = talBest;
									}
								}
					...
					if ((intParam1 == intGLOB_144)) {
						...
						if (((((!GetHasSpellEffect(36, OBJECT_SELF)) && (!GetHasSpellEffect(33, OBJECT_SELF))) && (!GetHasSpellEffect(22, OBJECT_SELF))) && (int3 == 1))) {
							sub7("GENERIC DEBUG *************** I do have VALOR");
							int3 = 1;
						}
						else {
							sub7("GENERIC DEBUG *************** I do not have VALOR");
							int3 = 0;
						}
					}
				}
		...
		if (((int3 == 1) && (int4 == 0))) {
			sub7("GENERIC DEBUG *************** Clear 2300");
			int nTalent = GetIdFromTalent(talent8);
			sub7(("GENERIC DEBUG *************** Spells.2DA ID = " + sub13(nTalent)));
			ClearAllActions();
			...
			if (((int3 == 1) && (int4 == 1))) {
				...
				if (GetIsObjectValid(objectParam2)) {
					sub7(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub8(objectParam2)));
					sub7("GENERIC DEBUG *************** Clear 2400");
					ClearAllActions();
		...
		if ((GetIsTalentValid(talent8) && (!GetHasSpellEffect(GetIdFromTalent(talent8), OBJECT_SELF)))) {
			if (GetIsObjectValid(objectParam2)) {
				sub7("GENERIC DEBUG *************** Clear 2500");
				ClearAllActions();
				sub7(((("GENERIC DEBUG *************** Target = " + GetName(objectParam2)) + " Talent Code = ") + IntToString(int2)));
				ActionUseTalentOnObject(talent8, OBJECT_SELF);
				return 1;
			}
		}
	}
	sub7(((((("GENERIC DEBUG *************** " + sub8(OBJECT_SELF)) + " VP = ") + sub13(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub13(GetMaxHitPoints(OBJECT_SELF))));
	sub7("GENERIC DEBUG *************** Healing Not Used");
	return 0;
}

object sub18() {
	sub7("GENERIC DEBUG ***************  Starting Injury Check Function");
...
int sub17(object objectParam1) {
	sub7("GENERIC DEBUG *************** Boss AI Start");
	...
	sub7("GENERIC DEBUG *************** Boss AI: Fall Through");
	return sub36(OBJECT_INVALID);
}

int sub16() {
	sub7("GENERIC DEBUG *************** Malak AI Start");
	...
	sub7(("GENERIC DEBUG *************** Malak Distance to PC = " + FloatToString(GetDistanceBetween(OBJECT_SELF, oPC), 4, 4)));
	if ((fDistance > 10.0)) {
		int6 = 1;
	}
	if ((int6 == 1)) {
		sub7("GENERIC DEBUG *************** Clear 1480");
		ClearAllActions();
		if (((GetHasSpellEffect(8, oPC) || GetHasSpellEffect(34, oPC)) || GetHasSpellEffect(37, oPC))) {
			...
			if (GetIsTalentValid(talSpell)) {
				sub7("GENERIC DEBUG *************** Using Breach");
			...
			if ((fDistance > 10.0)) {
				...
				if ((int14 != (-1))) {
					...
					if (GetIsTalentValid(talent3)) {
						sub7("GENERIC DEBUG *************** Malak Using Force Power");
	...
	if ((int7 == 1)) {
		sub7("GENERIC DEBUG *************** Malak Attacking");
		ActionAttack(oPC, 0);
		return 1;
	}
	sub7("GENERIC DEBUG *************** Malak AI Drop Out");
	return 0;
}

int sub15() {
	int int1 = 0;
	if (((sub11(intGLOB_135) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub11(intGLOB_132))) {
...
int sub12() {
	sub7("GENERIC DEBUG *************** Starting Forcefield Search");
	sub7(((("GENERIC DEBUG *************** Shield Boolean (" + sub13(intGLOB_133)) + ") = ") + sub13(sub11(intGLOB_133))));
	if (((sub11(intGLOB_133) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub6(object objectParam1) {
	sub7("");
	sub7(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub8(OBJECT_SELF)));
	sub9();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub7(("GENERIC DEBUG *************** AI STYLE = " + sub10(OBJECT_SELF)));
		if (((((!sub11(intGLOB_128)) && (!sub11(intGLOB_129))) && (!sub11(intGLOB_130))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub11(intGLOB_138) == 1)) {
					if ((sub16() == 1)) {
						return;
					}
				}
				if ((sub11(intGLOB_132) == 1)) {
		...
		if (sub75()) {
			sub7("GENERIC DEBUG *************** DETERMINE COMBAT ROUND END");
		}
		sub7("GENERIC DEBUG *************** WARNING DETERMINE COMBAT ROUND FAILURE");
	}
}
...
void main() {
	int int1 = sub1(10, 0);
	int int3 = 1;
	object oNearestMan28_turret01;
	sub2(int1);
	sub3(OBJECT_SELF, 5, 1);
	sub4("man28_pdroid");
	sub5("man28_turret01");
	oNearestMan28_turret01 = GetNearestObjectByTag("man28_pdroid", OBJECT_SELF, 1);
	while (GetIsObjectValid(oNearestMan28_turret01)) {
		AssignCommand(oNearestMan28_turret01, sub6(OBJECT_INVALID));
		DelayCommand(0.5, ApplyEffectToObject(0, EffectVisualEffect(4003, 0), oNearestMan28_turret01, 0.0));
		(int3++);
		oNearestMan28_turret01 = GetNearestObjectByTag("man28_pdroid", OBJECT_SELF, int3);
	}
	int3 = 1;
	oNearestMan28_turret01 = GetNearestObjectByTag("man28_turret01", OBJECT_SELF, 1);
	while (GetIsObjectValid(oNearestMan28_turret01)) {
		AssignCommand(oNearestMan28_turret01, sub6(OBJECT_INVALID));
		(int3++);
		oNearestMan28_turret01 = GetNearestObjectByTag("man28_turret01", OBJECT_SELF, int3);
	}
}
