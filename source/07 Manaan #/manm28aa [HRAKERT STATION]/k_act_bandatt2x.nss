			...
			if ((intParam1 == intGLOB_115)) {
				...
				if ((intParam1 == intGLOB_116)) {
					...
					if ((intParam1 == intGLOB_117)) {
						...
						sub2(("GENERIC DEBUG *************** Spell Effect 22" + sub8(GetHasSpellEffect(22, OBJECT_SELF))));
						sub2(("GENERIC DEBUG *************** Spell Effect 33" + sub8(GetHasSpellEffect(33, OBJECT_SELF))));
						sub2(("GENERIC DEBUG *************** Spell Effect 36" + sub8(GetHasSpellEffect(36, OBJECT_SELF))));
...
void main() {
	int int1 = 0;
	object oG_bandonlacky = GetObjectByTag("g_darkjedi02", int1);
	object object3 = GetObjectByTag("g_darkjedi02", int1);
	while ((GetIsObjectValid(oG_bandonlacky) || GetIsObjectValid(object3))) {
		if (GetIsObjectValid(oG_bandonlacky)) {
			ChangeToStandardFaction(oG_bandonlacky, 1);
			DelayCommand(0.5, AssignCommand(oG_bandonlacky, ClearAllActions()));
			DelayCommand(0.5, AssignCommand(oG_bandonlacky, sub1(OBJECT_INVALID)));
		}
		if (GetIsObjectValid(object3)) {
			ChangeToStandardFaction(object3, 1);
			DelayCommand(0.5, AssignCommand(object3, ClearAllActions()));
			DelayCommand(0.5, AssignCommand(object3, sub1(OBJECT_INVALID)));
		}
		(int1++);
		oG_bandonlacky = GetObjectByTag("g_bandonlacky", int1);
		object3 = GetObjectByTag("g_bandonlacky", int1);
	}
	ChangeToStandardFaction(GetObjectByTag("g_bandon", 0), 1);
	DelayCommand(0.5, ClearAllActions());
	DelayCommand(0.5, sub1(OBJECT_INVALID));
}
