...
int sub1(object objectParam1) {
	return sub2(GetArea(objectParam1), intGLOB_6);
}
...
void main() {
	...
	if ((int1 == 1001)) {
		...
		if ((((((GetIsObjectValid(oKas22_rebczer_01) == 0) && (GetIsObjectValid(oKas22_rebczer_02) == 0)) && (GetIsObjectValid(oKas22_rebczer_03) == 0)) && (GetIsObjectValid(oKas22_rebczer_04) == 0)) && (sub1(OBJECT_SELF) == 1))) {
