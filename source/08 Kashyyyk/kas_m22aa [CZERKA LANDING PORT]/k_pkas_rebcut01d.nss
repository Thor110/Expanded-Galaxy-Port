...
void sub1(int intParam1, object objectParam2) {
	if (((intParam1 == 1) || (intParam1 == 0))) {
		sub2(GetArea(objectParam2), intGLOB_6, intParam1);
	}
	return;
}
...
void main() {
	...
	ChangeToStandardFaction(oKas22_rebczer_01, 1);
	ChangeToStandardFaction(oKas22_rebczer_02, 1);
	ChangeToStandardFaction(oKas22_rebczer_03, 1);
	ChangeToStandardFaction(oKas22_rebczer_04, 1);
	SetPlotFlag(oKas22_rebczer_01, 0);
	SetPlotFlag(oKas22_rebczer_02, 0);
	SetPlotFlag(oKas22_rebczer_03, 0);
	sub1(1, OBJECT_SELF);
}
