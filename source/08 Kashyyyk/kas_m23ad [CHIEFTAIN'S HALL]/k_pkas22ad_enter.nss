...
int sub7() {
	return sub3(GetArea(OBJECT_SELF), intGLOB_6);
}
...
void sub5(int intParam1) {
	if (((intParam1 == 1) || (intParam1 == 0))) {
		sub6(GetArea(OBJECT_SELF), intGLOB_1, intParam1);
	}
	return;
}

void sub4() {
	object oKas23_freyyrspwn = GetWaypointByTag("kas23_freyyrspwn");
	location location1 = GetLocation(oKas23_freyyrspwn);
	CreateObject(1, "kas23_freyyr_01", location1, 0);
	return;
}
...
int sub2() {
	return sub3(GetArea(OBJECT_SELF), intGLOB_1);
}
