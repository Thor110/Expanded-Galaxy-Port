...
void main() {
	...
	object object13 = GetObjectByTag("kas23_wookguard2", 1);
	sub1(1);
	SetPlotFlag(OBJECT_SELF, 1);
	ChangeToStandardFaction(oKas23_freyyr_01, 1);
	ChangeToStandardFaction(OBJECT_SELF, 2);
	ChangeToStandardFaction(oKas23_czerkaloy, 2);
	ChangeToStandardFaction(object5, 2);
	ChangeToStandardFaction(object7, 2);
	ChangeToStandardFaction(object9, 2);
