...
void sub1(int intParam1) {
	if (((intParam1 == 1) || (intParam1 == 0))) {
		sub2(GetArea(OBJECT_SELF), intGLOB_6, intParam1);
	}
	return;
}
...
void main() {
	...
	DelayCommand(1.0, AssignCommand(object9, ActionMoveToObject(oKas23_meetking3, 0, 1.0)));
	DelayCommand(1.0, AssignCommand(object11, ActionMoveToObject(oKas23_meetking4, 0, 1.0)));
