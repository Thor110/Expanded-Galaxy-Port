...
// Prototypes
void sub87(string stringParam1, int intParam2, int intParam3, float floatParam4);
void sub86();
int sub85(int intParam1, int intParam2);
void sub84();
...
int sub80();
int sub79();
object sub78(object objectParam1);
int sub77(object objectParam1);
int sub76(object objectParam1);
talent sub75(object objectParam1, talent talentParam2);
int sub74(int intParam1);
int sub73(int intParam1);
int sub72();
int sub71();
int sub70();
int sub69();
...
int sub61();
int sub60();
talent sub59(int intParam1);
string sub58(int intParam1);
int sub57();
int sub56();
int sub55();
int sub54();
...
int sub46();
int sub45();
int sub44(int intParam1);
int sub43(int intParam1);
talent sub42(int intParam1);
object sub41();
int sub40(object objectParam1);
talent sub39(object objectParam1, talent talentParam2);
talent sub38(object objectParam1, talent talentParam2);
int sub37();
object sub36();
int sub35();
talent sub34(int intParam1);
talent sub33(int intParam1);
talent sub32(int intParam1);
talent sub31(int intParam1, int intParam2);
int sub30(object objectParam1, float floatParam2);
int sub29(object objectParam1, float floatParam2);
object sub28();
int sub27();
int sub26(object objectParam1);
int sub25();
object sub24(int intParam1);
int sub23(int intParam1, object objectParam2);
object sub22();
int sub21(object objectParam1);
int sub20();
int sub19();
void sub18(int intParam1, int intParam2);
string sub17(int intParam1);
int sub16();
string sub15(object objectParam1);
void sub14();
string sub13(object objectParam1);
void sub12(string stringParam1);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub18(intGLOB_46, 1));
					}
					else {
	...
	if ((!sub10(intGLOB_55))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub10(intGLOB_52)) {
				...
				if (((nLocal < int4) && (!sub10(intGLOB_52)))) {
					int16 = sub85(int4, nLocal);
					nLocal = (nLocal + int16);
				}
				else {
					if ((nLocal == int4)) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub10(intGLOB_53), 2.5, float3);
			if (sub10(intGLOB_46)) {
				ActionDoCommand(sub86());
			}
			SetLocalNumber(OBJECT_SELF, intGLOB_43, nLocal);
			if ((string2 != "UNKNOWN")) {
				ActionDoCommand(sub84());
			}
		}
	}
}
...
int sub82(object objectParam1) {
	...
	sub83(("Walk Initiate for " + GetTag(objectParam1)));
	sub83(("TAG WAY FOUND = " + IntToString(GetIsObjectValid(oWP))));
	sub83(("WAY POINT NAME = " + GetTag(oWP)));
	sub83(("SERIES INT = " + IntToString(nLocal)));
	sub83(("SERIES WAY FOUND = " + IntToString(GetIsObjectValid(object3))));
	sub83(("SERIES Series Tag = " + string8));
	sub83("");
...
int sub80() {
	sub12("GENERIC DEBUG *************** Start Commoner AI");
	...
	if (GetIsObjectValid(oNearest)) {
		sub12("GENERIC DEBUG *************** Clear 2710");
		ClearAllActions();
		ActionMoveAwayFromObject(oNearest, 1, 20.0);
		DelayCommand(0.2, ActionDoCommand(sub81()));
		return 1;
	}
	else {
		if (GetIsObjectValid(object3)) {
			sub12(("GENERIC DEBUG *************** Object Flee = " + sub13(object3)));
			sub12("GENERIC DEBUG *************** Clear 2720");
			ClearAllActions();
...
int sub79() {
	sub12(("GENERIC DEBUG *************** Post DCR Checks for " + sub13(OBJECT_SELF)));
	if ((sub10(intGLOB_101) && (!sub10(intGLOB_102)))) {
		if (sub80()) {
			return 1;
		}
	}
	else {
		if (sub10(intGLOB_102)) {
			sub12("GENERIC DEBUG *************** Clear 1000");
			ClearAllActions();
			return 1;
		}
	}
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub82(OBJECT_SELF) == 1))) {
		sub12("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
		DelayCommand(1.0, sub84());
		return 1;
	}
	else {
		if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetIsObjectValid(GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF)))) && IsObjectPartyMember(OBJECT_SELF))) {
			if ((!GetSoloMode())) {
				sub87("NO TARGET: FOLLOW LEADER", 10, 10, 4.0);
				CancelCombat(OBJECT_SELF);
				sub12("GENERIC DEBUG *************** Clear 1200");
				ClearAllActions();
				ActionFollowLeader();
			}
			return 1;
...
object sub78(object objectParam1) {
	sub12("GENERIC DEBUG *************** Starting: Determine Attack Target");
	int nStyle = GetPartyAIStyle();
	int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
	object object1;
	object oLastTarget = GetLastHostileTarget(OBJECT_SELF);
	sub12(((("GENERIC DEBUG *************** Intruder = " + IntToString(GetIsObjectValid(objectParam1))) + " Last Target = ") + IntToString(GetIsObjectValid(oLastTarget))));
	if (((GetIsObjectValid(objectParam1) && (!GetIsDead(objectParam1))) && (!GetIsDebilitated(objectParam1)))) {
		sub12(("GENERIC DEBUG *************** Intruder Target Returned = " + ObjectToString(objectParam1)));
		return objectParam1;
	}
	else {
		if (((GetIsObjectValid(oLastTarget) && (!GetIsDead(oLastTarget))) && (!GetIsDebilitated(oLastTarget)))) {
			sub12(("GENERIC DEBUG *************** Last Target Returned = " + ObjectToString(objectParam1)));
			return oLastTarget;
		}
		else {
			if ((nStyle == 0)) {
				int int13 = 1;
				sub12("GENERIC DEBUG *************** Getting nearest target - 249");
				...
				if ((nStyle == 1)) {
					...
					if (GetIsObjectValid(oLastActor)) {
						sub12("GENERIC DEBUG *************** Getting nearest target - 262");
						...
						if (GetIsObjectValid(oLastActor)) {
							sub12("GENERIC DEBUG *************** Getting nearest target - 269");
							object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
						}
					}
				}
					...
					if ((nStyle != 2)) {
						sub12("GENERIC DEBUG *************** Getting nearest target - 275");
						object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
					}
					else {
						sub12("GENERIC DEBUG *************** Getting nearest target - 279");
						object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
					}
				}
			}
	...
	if (GetIsObjectValid(object1)) {
		sub12(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub13(object1)));
		return object1;
	}
	sub12("GENERIC DEBUG *************** No Attack Targets Found");
	return OBJECT_INVALID;
}

int sub77(object objectParam1) {
	object object1 = sub41();
	talent talent1;
	object object3;
	if ((GetRacialType(OBJECT_SELF) == 5)) {
		return sub40(OBJECT_INVALID);
	}
	if (sub23(intGLOB_117, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub23(intGLOB_115, object1)) {
			return 1;
		}
	}
	object object4 = sub22();
	if (GetIsObjectValid(object4)) {
		if (sub23(intGLOB_116, object4)) {
			return 1;
		}
	}
	object3 = sub36();
	sub12(("GENERIC DEBUG *************** Jedi Support AI: AOE Target = " + sub17(GetIsObjectValid(object3))));
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub31(intGLOB_2, 1);
		}
		else {
			talent1 = sub31(intGLOB_2, 0);
		}
	}
	else {
		sub12("GENERIC DEBUG *************** Jedi Support AI: Inside the Party AI Section");
		object3 = sub78(OBJECT_INVALID);
		sub12(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub13(object3)));
		if (GetIsObjectValid(object3)) {
			sub12(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub13(object3)));
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub31(intGLOB_3, 1);
			}
			else {
				talent1 = sub31(intGLOB_3, 0);
			}
		}
	}
	talent1 = sub38(object3, talent1);
	talent1 = sub39(object3, talent1);
	if ((GetIsObjectValid(object3) && GetIsTalentValid(talent1))) {
		sub12("GENERIC DEBUG *************** Clear 1450");
		ClearAllActions();
		ActionUseTalentOnObject(talent1, object3);
		return 1;
	}
	sub12("GENERIC DEBUG *************** Jedi Support AI: Fall Through");
	return sub40(OBJECT_INVALID);
}
...
int sub76(object objectParam1) {
	if ((IsObjectPartyMember(OBJECT_SELF) || (d100(1) > 50))) {
		...
		if (((GetIsObjectValid(object1) && GetIsTalentValid(talent1)) && GetCreatureHasTalent(talent1, OBJECT_SELF))) {
			sub12("GENERIC DEBUG *************** Clear 1400");
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			return 1;
		}
		sub12("GENERIC DEBUG *************** Grenade AI Failure");
		return sub40(objectParam1);
	}
	return 0;
}
...
talent sub75(object objectParam1, talent talentParam2) {
	int int1;
	sub12("GENERIC DEBUG *************** Starting Droid Talent Double Check");
	if ((GetTypeFromTalent(talentParam2) == 0)) {
		sub12("GENERIC DEBUG *************** Droid Talent is a Spell");
...
int sub74(int intParam1) {
	int int1;
	int nRandom = d4(1);
	if ((sub26(OBJECT_SELF) != 0)) {
		while ((int1 == 0)) {
			if ((sub26(OBJECT_SELF) == 1)) {
				if ((nRandom == 1)) {
					nRandom = intGLOB_17;
				}
				else {
																...
																if ((intParam1 == intGLOB_17)) {
																	...
																	if ((intParam1 == intGLOB_18)) {
																		...
																		if (((intParam1 == intGLOB_19) || (intParam1 == intGLOB_15))) {
																			sub12("GENERIC DEBUG *************** Melee/Ranged Breather");
																		}
																		else {
				...
				if ((intParam1 == intGLOB_19)) {
					...
					if ((intParam1 == intGLOB_20)) {
						...
						if ((intParam1 == intGLOB_21)) {
							...
							if ((intParam1 == intGLOB_22)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub45())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_23)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub45())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_24)) {
										...
										if ((intParam1 == intGLOB_25)) {
											...
											if ((intParam1 == intGLOB_26)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub49() && sub50()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_27)) {
													...
													if ((intParam1 == intGLOB_28)) {
														talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
														if ((sub52() && GetIsTalentValid(talRandom))) {
															return 1;
														}
													}
													else {
														if ((intParam1 == intGLOB_29)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub47() && sub53()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_30)) {
																if (((sub53() && sub46()) && sub54())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_31)) {
																	if (((sub51() && sub46()) && sub48())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_32)) {
																		if (((sub52() && sub46()) && sub48())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_32)) {
																			if (((sub47() && sub55()) && sub46())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_34)) {
																				talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																				if ((sub55() && GetIsTalentValid(talRandom))) {
																					return 1;
																				}
																			}
																			else {
																				if ((intParam1 == intGLOB_35)) {
																					if (((sub55() && sub46()) && sub54())) {
																						return 1;
																					}
																				}
																				else {
																					if ((intParam1 == intGLOB_36)) {
																						...
																						if ((intParam1 == intGLOB_37)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub46() && sub53()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_38)) {
																								talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																								if (((sub55() && sub56()) && GetIsTalentValid(talRandom))) {
																									return 1;
																								}
																							}
																							else {
																								if (((intParam1 == intGLOB_39) || (intParam1 == intGLOB_40))) {
																									...
																									sub12(((("GENERIC DEBUG *************** Droid Items = " + sub13(oLArmItem)) + " / ") + sub13(oRArmItem)));
																									if (sub57()) {
																										sub12("GENERIC DEBUG *************** Droid Utility Check is TRUE");
																										return 1;
																									}
																									sub12("GENERIC DEBUG *************** Droid Utility Check is FALSE");
																								}
																							}
																						}
																					}
...
talent sub42(int intParam1) {
	...
	talent talent1;
	int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
	sub12("GENERIC DEBUG *************** Starting GetComboMove");
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				int2 = sub43(intParam1);
				sub12(("GENERIC DEBUG *************** Starting Jedi Combo " + sub58(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					int2 = sub73(intParam1);
					sub12(("GENERIC DEBUG *************** Starting Droid Combo " + sub58(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub59(int2);
				}
				else {
					int2 = sub74(intParam1);
					sub12(("GENERIC DEBUG *************** Starting NPC Combo " + sub58(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub59(int2);
				}
		...
		sub12(("GENERIC DEBUG *************** Continuing Combo " + sub58(structGLOB_1.int15)));
		return sub59(structGLOB_1.int15);
	}
	return talent1;
}

object sub41() {
	sub12("GENERIC DEBUG *************** Starting Poison Check");
	effect efNext;
	...
	sub12("GENERIC DEBUG ***************  Returning Invalid Poison Object");
	return OBJECT_INVALID;
}
...
int sub40(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub23(intGLOB_115, oNPC)) {
			return 1;
		}
	}
	oNPC = sub22();
	if (GetIsObjectValid(oNPC)) {
		if (sub23(intGLOB_116, oNPC)) {
			return 1;
		}
	}
	talent1 = sub42(0);
	...
	if ((nLocalBool == 1)) {
		...
		sub12("GENERIC DEBUG *************** Default AI Debug Start *************************");
		sub12(("GENERIC DEBUG *************** Intruder    = " + sub13(objectParam1)));
		sub12(("GENERIC DEBUG *************** Last Target = " + sub13(oNPC)));
		sub12(("GENERIC DEBUG *************** Closest     = " + sub13(oNearest)));
		if ((((IsObjectPartyMember(OBJECT_SELF) && GetIsObjectValid(oNPC)) && (!GetIsDead(oNPC))) && GetObjectSeen(oNPC, OBJECT_SELF))) {
			...
			if ((GetIsObjectValid(objectParam1) && GetObjectSeen(objectParam1, OBJECT_SELF))) {
				sub12("GENERIC DEBUG *************** Intruder becomes Target");
				oNPC = objectParam1;
			}
			else {
				if ((GetIsObjectValid(oNearest) && GetObjectSeen(oNearest, OBJECT_SELF))) {
					if (((((!GetIsObjectValid(oNPC)) || (!GetIsEnemy(oNPC, OBJECT_SELF))) || GetIsDead(oNPC)) || (GetCurrentHitPoints(oNPC) < GetCurrentHitPoints(oNearest)))) {
						sub12("GENERIC DEBUG *************** Closest becomes Target");
						oNPC = oNearest;
					}
				}
			}
	...
	if ((GetRacialType(OBJECT_SELF) == 5)) {
		talent1 = sub75(oNPC, talent1);
	}
	talent1 = sub38(oNPC, talent1);
	talent1 = sub39(oNPC, talent1);
	sub12("GENERIC DEBUG *************** Default AI Debug End ***************************");
	sub12(((("GENERIC DEBUG *************** Target = " + sub13(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	if (GetIsObjectValid(oNPC)) {
		sub12("GENERIC DEBUG *************** Clear 1300");
		ClearAllActions();
		if (sub25()) {
			sub12("GENERIC DEBUG *************** Switching Weapons");
		}
		if ((GetIsTalentValid(talent1) && GetIsEnemy(oNPC, OBJECT_SELF))) {
			sub12("GENERIC DEBUG *************** Using Talent on Target");
			ActionUseTalentOnObject(talent1, oNPC);
			return 1;
		}
		else {
			if (GetIsEnemy(oNPC, OBJECT_SELF)) {
				sub12("GENERIC DEBUG *************** Action Attack by Default");
				ActionAttack(oNPC, 0);
				return 1;
			}
		}
	}
	sub12("GENERIC DEBUG *************** Default AI has failed to do an action");
	return 0;
}
...
talent sub38(object objectParam1, talent talentParam2) {
	...
	if ((GetTypeFromTalent(talentParam2) == 0)) {
		if (((GetIdFromTalent(talentParam2) == 49) || (GetIdFromTalent(talentParam2) == 4))) {
			sub12(("GENERIC DEBUG *************** Lightsaber Throw Check = " + FloatToString(GetDistanceBetween(OBJECT_SELF, objectParam1), 4, 2)));
...
int sub37() {
	sub12("GENERIC DEBUG *************** Boss AI: Start Targeted Action Routine");
	talent talent1;
	object object1;
	int int1;
	int nRandom = d6(1);
	...
	sub12((("GENERIC DEBUG *************** Boss AI: Get the #" + sub17(nRandom)) + " target"));
	object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, int4, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
	sub12(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub13(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub12(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub13(oNearest)) + " nCnt = ") + sub17(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub12(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub13(oNearest)));
			object1 = oNearest;
		}
		(int4++);
	...
	if ((int7 == 1)) {
		if (GetIsTalentValid(talent1)) {
			if ((GetTypeFromTalent(talent1) == 1)) {
				sub12(("GENERIC DEBUG *************** Boss AI: Talent Feat = " + sub17(GetIdFromTalent(talent1))));
			}
			else {
				if ((GetTypeFromTalent(talent1) == 0)) {
					sub12(("GENERIC DEBUG *************** Boss AI: Talent Power = " + sub17(GetIdFromTalent(talent1))));
				}
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			sub12("GENERIC DEBUG *************** Boss AI: Get Boss Combat Move AI Droid");
			int1 = 1;
		}
		talent1 = sub31(intGLOB_3, int1);
		talent1 = sub38(object1, talent1);
		talent1 = sub39(object1, talent1);
		sub12(("GENERIC DEBUG *************** Boss AI: Target = " + sub17(GetIsObjectValid(object1))));
		sub12(("GENERIC DEBUG *************** Boss AI: Talent = " + sub17(GetIsTalentValid(talent1))));
		if ((GetIsTalentValid(talent1) && GetIsObjectValid(object1))) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub12("GENERIC DEBUG *************** Boss AI: Targeted Power Success");
			return 1;
		}
	}
	sub12("GENERIC DEBUG *************** Boss AI: Targeted Failure");
	return 0;
}
...
int sub35() {
	sub12("GENERIC DEBUG *************** Boss AI: AOE Function Starting");
	talent talent1;
	object object1 = sub36();
	sub12(("GENERIC DEBUG *************** Boss AI: AOE Target = " + sub17(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub31(intGLOB_2, int2);
		if (GetIsTalentValid(talent1)) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub12("GENERIC DEBUG *************** Boss AI: AOE Success");
			return 1;
		}
	}
	sub12("GENERIC DEBUG *************** Boss AI: AOE Failure");
	return 0;
}
...
talent sub33(int intParam1) {
	...
	sub12(("GENERIC DEBUG *************** Last Force Power Used = " + sub17(nLastForce)));
	...
	sub12(("GENERIC DEBUG *************** Force Power Returned = " + sub17(GetIdFromTalent(talent1))));
	return talent1;
}
...
talent sub32(int intParam1) {
	...
	sub12("GENERIC DEBUG *************** Grenade Selection Failure");
	talent talent11;
	return talent11;
	return talent11;
}
...
talent sub31(int intParam1, int intParam2) {
	...
	if (((intParam1 == intGLOB_1) || (intParam1 == intGLOB_5))) {
		talRandom = sub32(intParam2);
		if (GetIsTalentValid(talRandom)) {
			sub12("GENERIC DEBUG *************** Boss AI: Grenade Talent Chosen");
			return talRandom;
		}
	}
	if (((intParam1 == intGLOB_2) || (intParam1 == intGLOB_5))) {
		talRandom = sub33(intParam2);
		if (GetIsTalentValid(talRandom)) {
			sub12("GENERIC DEBUG *************** Boss AI: AOE Force Power Talent Chosen");
			return talRandom;
		}
	}
	if (((intParam1 == intGLOB_3) || (intParam1 == intGLOB_5))) {
		if ((d100(1) > 50)) {
			talRandom = sub34(intParam2);
			if (GetIsTalentValid(talRandom)) {
				sub12("GENERIC DEBUG *************** Boss AI: Targeted Force Power Talent Chosen");
				return talRandom;
			}
			talRandom = sub33(intParam2);
			if (GetIsTalentValid(talRandom)) {
		...
		if ((sub26(OBJECT_SELF) == 1)) {
			sub12("GENERIC DEBUG *************** Boss AI: Melee Feat Talent Chosen");
			talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
		}
		else {
			sub12("GENERIC DEBUG *************** Boss AI: Range Feat Talent Chosen");
		...
		if (((intParam1 == intGLOB_4) || (intParam1 == intGLOB_5))) {
			...
			sub12("GENERIC DEBUG *************** Boss AI: No Feats Available");
		}
	}
	return talRandom;
}
...
object sub28() {
	...
	while (GetIsObjectValid(oShapeObject)) {
		if ((GetObjectSeen(oShapeObject, OBJECT_SELF) && (!GetIsDead(oShapeObject)))) {
			int3 = sub29(oShapeObject, 4.0);
			int4 = sub30(oShapeObject, 4.0);
...
int sub27() {
	sub12("GENERIC DEBUG *************** Boss AI: Grenade Function Starting");
	talent talent1;
	object object1 = sub28();
	sub12(("GENERIC DEBUG *************** Boss AI: Grenade Target = " + sub17(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub31(intGLOB_1, int2);
		if (GetIsTalentValid(talent1)) {
			sub12("GENERIC DEBUG *************** Clear 1460");
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub12("GENERIC DEBUG *************** Boss AI: AOE Success");
			return 1;
...
int sub26(object objectParam1) {
	...
	sub12("GENERIC DEBUG *************** Return No Weapon Type");
	return 0;
}

int sub25() {
	object oInvItem;
	if (((((GetIsObjectValid(GetAttackTarget(OBJECT_SELF)) && (GetDistanceBetween(GetAttackTarget(OBJECT_SELF), OBJECT_SELF) <= 3.0)) && (sub26(OBJECT_SELF) != 1)) && (GetRacialType(OBJECT_SELF) == 6)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		oInvItem = GetFirstItemInInventory(OBJECT_SELF);
		while (GetIsObjectValid(oInvItem)) {
			sub12("GENERIC DEBUG *************** Checking Melee Weapon");
			if (((((((((((((((GetBaseItemType(oInvItem) == 9) || (GetBaseItemType(oInvItem) == 6)) || (GetBaseItemType(oInvItem) == 80)) || (GetBaseItemType(oInvItem) == 78)) || (GetBaseItemType(oInvItem) == 8)) || (GetBaseItemType(oInvItem) == 2)) || (GetBaseItemType(oInvItem) == 0)) || (GetBaseItemType(oInvItem) == 10)) || (GetBaseItemType(oInvItem) == 4)) || (GetBaseItemType(oInvItem) == 1)) || (GetBaseItemType(oInvItem) == 5)) || (GetBaseItemType(oInvItem) == 7)) || (GetBaseItemType(oInvItem) == 3)) || (GetBaseItemType(oInvItem) == 79))) {
				sub12("GENERIC DEBUG *************** Equipping Melee Weapon");
		...
		if (((((((sub26(OBJECT_SELF) != 2) && (GetLevelByClass(4, OBJECT_SELF) == 0)) && (GetLevelByClass(3, OBJECT_SELF) == 0)) && (GetLevelByClass(5, OBJECT_SELF) == 0)) && (GetDistanceBetween(GetAttemptedAttackTarget(), OBJECT_SELF) > 3.0)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
			oInvItem = GetFirstItemInInventory(OBJECT_SELF);
			while (GetIsObjectValid(oInvItem)) {
				sub12("GENERIC DEBUG *************** Checking Ranged Weapon");
				if ((((((((((((((((GetBaseItemType(oInvItem) == 20) || (GetBaseItemType(oInvItem) == 12)) || (GetBaseItemType(oInvItem) == 77)) || (GetBaseItemType(oInvItem) == 19)) || (GetBaseItemType(oInvItem) == 16)) || (GetBaseItemType(oInvItem) == 21)) || (GetBaseItemType(oInvItem) == 13)) || (GetBaseItemType(oInvItem) == 24)) || (GetBaseItemType(oInvItem) == 14)) || (GetBaseItemType(oInvItem) == 15)) || (GetBaseItemType(oInvItem) == 18)) || (GetBaseItemType(oInvItem) == 23)) || (GetBaseItemType(oInvItem) == 17)) || (GetBaseItemType(oInvItem) == 22)) || (GetBaseItemType(oInvItem) == 17))) {
					sub12("GENERIC DEBUG *************** Equipping Ranged Weapon");
	...
	sub12("GENERIC DEBUG *************** Should not currently change weapons");
	return 0;
}
...
object sub24(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		sub12("GENERIC DEBUG *************** Searching for Alternate Target");
		oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0, 6, 0xFFFFFFFF, 0xFFFFFFFF);
		sub12(("GENERIC DEBUG *************** Alternate Target = " + sub13(oNearest)));
	}
	sub12(("GENERIC DEBUG *************** Heal Drain Target = " + sub17(intParam1)));
	sub12(("GENERIC DEBUG *************** Get Active Party Member: " + sub13(oNearest)));
	return oNearest;
}
...
int sub23(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_114)) {
			...
			if ((intParam1 == intGLOB_115)) {
				...
				if ((intParam1 == intGLOB_116)) {
					sub12(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub13(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
					if ((GetRacialType(OBJECT_SELF) != 5)) {
					...
					int3 = 0;
					if ((GetCreatureHasTalent(talSpell, OBJECT_SELF) || GetCreatureHasTalent(talent2, OBJECT_SELF))) {
						sub12("GENERIC DEBUG *************** I have Heal or Cure");
						int3 = 1;
						if (GetCreatureHasTalent(talSpell, OBJECT_SELF)) {
							talent8 = talSpell;
						}
						...
						if (((GetIsTalentValid(talBest) || GetCreatureHasTalent(talent6, OBJECT_SELF)) || GetCreatureHasTalent(talent7, OBJECT_SELF))) {
							if ((objectParam2 == OBJECT_SELF)) {
								if ((GetCreatureHasTalent(talent7, OBJECT_SELF) && (!IsObjectPartyMember(OBJECT_SELF)))) {
									sub12("GENERIC DEBUG *************** I have Death Field");
									int3 = 1;
									int4 = 1;
									talent8 = talent7;
								}
									...
									if ((GetCreatureHasTalent(talent6, OBJECT_SELF) && (!IsObjectPartyMember(OBJECT_SELF)))) {
										sub12("GENERIC DEBUG *************** I have Drain Life");
										int3 = 1;
										int4 = 1;
										talent8 = talent6;
									}
									else {
										sub12("GENERIC DEBUG *************** I have a Med Pack");
										int3 = 1;
										talent8 = talBest;
									}
								}
					...
					if ((intParam1 == intGLOB_117)) {
						...
						if (((((!GetHasSpellEffect(36, OBJECT_SELF)) && (!GetHasSpellEffect(33, OBJECT_SELF))) && (!GetHasSpellEffect(22, OBJECT_SELF))) && (int3 == 1))) {
							sub12("GENERIC DEBUG *************** I do have VALOR");
							int3 = 1;
						}
						else {
							sub12("GENERIC DEBUG *************** I do not have VALOR");
							int3 = 0;
						}
					}
				}
		...
		if (((int3 == 1) && (int4 == 0))) {
			sub12("GENERIC DEBUG *************** Clear 2300");
			int nTalent = GetIdFromTalent(talent8);
			sub12(("GENERIC DEBUG *************** Spells.2DA ID = " + sub17(nTalent)));
			ClearAllActions();
			...
			if (((int3 == 1) && (int4 == 1))) {
				objectParam2 = sub24(1);
				if (GetIsObjectValid(objectParam2)) {
					sub12(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub13(objectParam2)));
					sub12("GENERIC DEBUG *************** Clear 2400");
					ClearAllActions();
		...
		if ((GetIsTalentValid(talent8) && (!GetHasSpellEffect(GetIdFromTalent(talent8), OBJECT_SELF)))) {
			if (GetIsObjectValid(objectParam2)) {
				sub12("GENERIC DEBUG *************** Clear 2500");
				ClearAllActions();
				sub12(((("GENERIC DEBUG *************** Target = " + GetName(objectParam2)) + " Talent Code = ") + IntToString(int2)));
				ActionUseTalentOnObject(talent8, OBJECT_SELF);
				return 1;
			}
		}
	}
	sub12(((((("GENERIC DEBUG *************** " + sub13(OBJECT_SELF)) + " VP = ") + sub17(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub17(GetMaxHitPoints(OBJECT_SELF))));
	sub12("GENERIC DEBUG *************** Healing Not Used");
	return 0;
}

object sub22() {
	sub12("GENERIC DEBUG ***************  Starting Injury Check Function");
...
int sub21(object objectParam1) {
	sub12("GENERIC DEBUG *************** Boss AI Start");
	object object1 = sub22();
	if (GetIsObjectValid(object1)) {
		if (sub23(intGLOB_116, object1)) {
			return 1;
		}
	}
	if (sub25()) {
	...
	sub12("GENERIC DEBUG *************** Boss AI: Fall Through");
	return sub40(OBJECT_INVALID);
}

int sub20() {
	sub12("GENERIC DEBUG *************** Malak AI Start");
	...
	sub12(("GENERIC DEBUG *************** Malak Distance to PC = " + FloatToString(GetDistanceBetween(OBJECT_SELF, oPC), 4, 4)));
	if ((fDistance > 10.0)) {
		int6 = 1;
	}
	if ((int6 == 1)) {
		sub12("GENERIC DEBUG *************** Clear 1480");
		ClearAllActions();
		if (((GetHasSpellEffect(8, oPC) || GetHasSpellEffect(34, oPC)) || GetHasSpellEffect(37, oPC))) {
			...
			if (GetIsTalentValid(talSpell)) {
				sub12("GENERIC DEBUG *************** Using Breach");
			...
			if ((fDistance > 10.0)) {
				...
				if ((int14 != (-1))) {
					...
					if (GetIsTalentValid(talent3)) {
						sub12("GENERIC DEBUG *************** Malak Using Force Power");
	...
	if ((int7 == 1)) {
		sub12("GENERIC DEBUG *************** Malak Attacking");
		ActionAttack(oPC, 0);
		return 1;
	}
	sub12("GENERIC DEBUG *************** Malak AI Drop Out");
	return 0;
}

int sub19() {
	int int1 = 0;
	if (((sub10(intGLOB_108) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub10(intGLOB_105))) {
			...
			if ((int1 == 1)) {
				sub12("GENERIC DEBUG *************** Clear 1710");
				ClearAllActions();
...
int sub16() {
	sub12("GENERIC DEBUG *************** Starting Forcefield Search");
	sub12(((("GENERIC DEBUG *************** Shield Boolean (" + sub17(intGLOB_106)) + ") = ") + sub17(sub10(intGLOB_106))));
	if (((sub10(intGLOB_106) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
		...
		if (GetCreatureHasTalent(talSpell, OBJECT_SELF)) {
			sub12("GENERIC DEBUG *************** Clear 1700");
			ClearAllActions();
...
void sub11(object objectParam1) {
	sub12("");
	sub12(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub13(OBJECT_SELF)));
	sub14();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub12(("GENERIC DEBUG *************** AI STYLE = " + sub15(OBJECT_SELF)));
		if (((((!sub10(intGLOB_101)) && (!sub10(intGLOB_102))) && (!sub10(intGLOB_103))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub10(intGLOB_111) == 1)) {
					if ((sub20() == 1)) {
						return;
					}
				}
				if ((sub10(intGLOB_105) == 1)) {
					if ((sub21(objectParam1) == 1)) {
						return;
					}
				}
				if ((nNPCStyle == 0)) {
					if ((sub40(objectParam1) == 1)) {
						return;
					}
				}
				else {
					if ((nNPCStyle == 4)) {
						if ((sub76(objectParam1) == 1)) {
							return;
						}
					}
					else {
						if ((nNPCStyle == 5)) {
							if ((sub77(objectParam1) == 1)) {
								return;
							}
						}
					}
		...
		if (sub79()) {
			sub12("GENERIC DEBUG *************** DETERMINE COMBAT ROUND END");
		}
		sub12("GENERIC DEBUG *************** WARNING DETERMINE COMBAT ROUND FAILURE");
	}
}
...
void main() {
	sub1(intGLOB_73);
	sub2();
	DelayCommand(4.0, ApplyEffectToObject(0, EffectDamage(GetCurrentHitPoints(OBJECT_SELF), 8, 0), OBJECT_SELF, 0.0));
	DelayCommand(1.0, sub11(GetObjectByTag("kas22_kinrath_05", 0)));
}
