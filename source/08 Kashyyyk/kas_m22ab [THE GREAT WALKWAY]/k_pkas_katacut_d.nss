...
void main() {
	object oKas22_katarn_03 = GetObjectByTag("kas22_katarn_03", 0);
	object oKas22_katarn_04 = GetObjectByTag("kas22_katarn_04", 0);
	object oKas22_katarn_05 = GetObjectByTag("kas22_katarn_05", 0);
	SetPlotFlag(oKas22_katarn_03, 0);
	SetPlotFlag(oKas22_katarn_04, 0);
	SetPlotFlag(oKas22_katarn_05, 0);
	ChangeToStandardFaction(oKas22_katarn_03, 1);
	ChangeToStandardFaction(oKas22_katarn_04, 1);
	ChangeToStandardFaction(oKas22_katarn_05, 1);
	AssignCommand(oKas22_katarn_03, sub1(OBJECT_INVALID));
	AssignCommand(oKas22_katarn_04, sub1(OBJECT_INVALID));
	AssignCommand(oKas22_katarn_05, sub1(OBJECT_INVALID));
}
