...
// Prototypes
void sub81(object objectParam1, int intParam2, int intParam3);
...
void sub80(int intParam1) {
	if (((intParam1 == 1) || (intParam1 == 0))) {
		sub81(OBJECT_SELF, intGLOB_2, intParam1);
	}
	return;
}
...
void main() {
	...
	while (GetIsObjectValid(oAreaObject)) {
		if ((GetTag(oAreaObject) == "kas24_tach")) {
	...
	while (GetIsObjectValid(object4)) {
		if (((GetTag(object4) == "kas24_pgener_01") || (GetTag(object4) == "kas24_poffice_01"))) {
			...
			if ((GetTag(object4) == "kas24_emitter")) {
				AssignCommand(object4, sub80(1));
			}
		}
		object4 = GetNextObjectInArea(GetArea(OBJECT_SELF), 1);
	}
}
