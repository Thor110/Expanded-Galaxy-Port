...
void main() {
	...
	object oKas_calo = GetObjectByTag("kas_calo", 0);
	...
	DelayCommand(4.7, AssignCommand(oKas_calo_thug1, SetFacingPoint(GetPosition(GetFirstPC()))));
	DelayCommand(5.0, AssignCommand(oKas_calo, SetFacingPoint(GetPosition(GetFirstPC()))));
