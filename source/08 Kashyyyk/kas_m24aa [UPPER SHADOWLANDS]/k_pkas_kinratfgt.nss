...
void sub1(int intParam1, object objectParam2) {
	if (((intParam1 == 1) || (intParam1 == 0))) {
		sub2(GetArea(objectParam2), intGLOB_9, intParam1);
	}
	return;
}

void main() {
	object oKas24_kinrath_wp = GetWaypointByTag("kas24_kinrath_wp");
	object oKas24_joleefgt = GetWaypointByTag("kas24_joleefgt");
	location location1 = GetLocation(oKas24_kinrath_wp);
	object oG_kinrath01 = CreateObject(1, "g_kinrath01", location1, 0);
	object object7 = CreateObject(1, "g_kinrath01", location1, 0);
	object object9 = CreateObject(1, "g_kinrath01", location1, 0);
	DelayCommand(5.0, sub1(1, OBJECT_SELF));
	DelayCommand(1.0, AssignCommand(oG_kinrath01, ActionMoveToObject(oKas24_joleefgt, 1, 1.0)));
	DelayCommand(1.0, AssignCommand(object7, ActionMoveToObject(oKas24_joleefgt, 1, 1.0)));
	DelayCommand(1.0, AssignCommand(object9, ActionMoveToObject(oKas24_joleefgt, 1, 1.0)));
	sub3(OBJECT_INVALID);
	SetCommandable(0, OBJECT_SELF);
	DelayCommand(5.0, SetCommandable(1, OBJECT_SELF));
}
