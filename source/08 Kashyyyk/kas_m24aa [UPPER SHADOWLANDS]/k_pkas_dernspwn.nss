			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub1(intGLOB_73, 1));
					}
					else {
...
void sub6(object objectParam1) {
	...
	if ((nLevel > intGLOB_85)) {
		...
		if (((nLevel <= intGLOB_85) && (nLevel > intGLOB_86))) {
			sub8();
			if ((Random(3) == 0)) {
				sub7();
			}
			...
			if (((nLevel <= intGLOB_86) && (nLevel > intGLOB_87))) {
				sub8();
				if ((Random(2) == 0)) {
					sub10();
				}
...
int sub5(object objectParam1) {
	...
	if ((((Random(4) == 0) && (nRace != 5)) && (int5 != intGLOB_88))) {
		sub6(objectParam1);
		return 1;
	}
	return 0;
...
void sub4() {
	...
	int3 = (int3 - 1);
	if ((int3 > 0)) {
		SetLocalNumber(OBJECT_SELF, intGLOB_71, int3);
	}
}
...
void sub3() {
	...
	if ((sub11(intGLOB_139) || GetIsEncounterCreature(OBJECT_SELF))) {
		string string3;
		int int7 = 1;
		object object1;
		object object2;
		...
		if ((GetIsObjectValid(object1) && (float2 < 30.0))) {
			...
			SetLocalNumber(OBJECT_SELF, intGLOB_38, int10);
		}
	}
}
