...
void sub5(int intParam1) {
	SetGlobalNumber("kas_PoachersDead", intParam1);
	return;
}
...
void sub3(int intParam1, object objectParam2) {
	if (((intParam1 == 1) || (intParam1 == 0))) {
		sub2(objectParam2, intGLOB_2, intParam1);
	}
	return;
}
...
void main() {
	...
	sub1(1, oKas24_poffice_01);
	sub3(1, OBJECT_SELF);
	sub5((sub4() + 1));
	NoClicksFor(0.7);
	AssignCommand(oKas24_poffice_01, DelayCommand(0.5, ActionStartConversation(oPC, "", 0, 0, 1, "", "", "", "", "", "")));
	ChangeToStandardFaction(oKas24_poffice_01, 2);
