...
// Prototypes
void sub80(object objectParam1, int intParam2);
...
void sub80(object objectParam1, int intParam2) {
	...
	int int3;
	if ((((intParam2 == intGLOB_139) || (intParam2 == intGLOB_140)) || (intParam2 == intGLOB_141))) {
		int3 = 3;
	}
	else {
		int3 = 2;
	...
	if (((int5 == 1) && (intParam2 == intGLOB_142))) {
		int4 = 1;
	}
	else {
		if (((int5 == 5) && (intParam2 == intGLOB_141))) {
			int4 = 1;
		}
	}
...
void sub79(object objectParam1) {
	sub80(objectParam1, intGLOB_139);
}
...
void main() {
	...
	ApplyEffectToObject(0, EffectHeal(75), OBJECT_SELF, 0.0);
