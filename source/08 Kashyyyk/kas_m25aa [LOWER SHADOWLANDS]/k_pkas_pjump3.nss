...
void main() {
	...
	object object3 = GetPartyMemberByIndex(1);
	object object5 = GetPartyMemberByIndex(2);
	object oNearestBP_JUMP0_WPx = GetNearestObjectByTag("BP_JUMP0_WPx", oNPC, 1);
	object oNearestBP_JUMP1_WPx = GetNearestObjectByTag("BP_JUMP1_WPx", oNPC, 1);
	object oNearestBP_JUMP2_WPx = GetNearestObjectByTag("BP_JUMP2_WPx", oNPC, 1);
	sub1(oNearestBP_JUMP0_WPx, oNearestBP_JUMP1_WPx, oNearestBP_JUMP2_WPx);
}
