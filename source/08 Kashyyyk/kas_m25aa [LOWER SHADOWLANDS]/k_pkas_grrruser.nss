...
void main() {
	...
	if ((int1 == 1001)) {
		if ((((GetCurrentHitPoints(OBJECT_SELF) < FloatToInt((GetMaxHitPoints(OBJECT_SELF) / 2.0))) && (GetIsInCombat(OBJECT_SELF) == 0)) && (GetIsInConversation(OBJECT_SELF) == 0))) {
			...
			PlayAnimation(12, 1.0, 6.0);
		}
		if (((((GetIsInCombat(OBJECT_SELF) == 0) && (GetIsInConversation(OBJECT_SELF) == 0)) && (GetDistanceToObject(oPC) < 10.0)) && (sub1(OBJECT_SELF) == 0))) {
		...
		if ((int1 == 1002)) {
			...
			if ((int1 == 1003)) {
				...
				if (((((GetIsObjectValid(oKas25_mandalor05) == 0) && (GetIsObjectValid(oKas25_mandalor06) == 0)) && (GetIsObjectValid(oKas25_mandalor07) == 0)) && (GetIsInCombat(OBJECT_SELF) == 1))) {
					CancelCombat(OBJECT_SELF);
				}
			}
			else {
