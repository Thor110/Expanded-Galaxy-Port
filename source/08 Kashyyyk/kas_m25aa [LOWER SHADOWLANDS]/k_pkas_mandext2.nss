...
void main() {
	...
	if (((GetIsPC(oExiting) == 1) && (!sub1(oExiting)))) {
		if (((GetIsObjectValid(GetItemInSlot(4, oExiting)) == 0) && (GetIsObjectValid(GetItemInSlot(5, oExiting)) == 0))) {
			AssignCommand(oNearestKas25_mand_invis, ActionStartConversation(oExiting, "", 0, 0, 1, "", "", "", "", "", ""));
