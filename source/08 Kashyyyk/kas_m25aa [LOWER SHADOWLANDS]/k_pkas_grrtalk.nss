	...
	if ((!sub1(intGLOB_103))) {
		...
		if ((((!GetIsObjectValid(oLastActor)) || GetIsDead(oLastActor)) || (!GetObjectSeen(oLastActor, oSpeaker)))) {
			if (GetCommandable(OBJECT_SELF)) {
				...
				if ((((int1 == (-1)) && (GetDistanceToObject(oNearest) < 10.0)) && (GetDistanceToObject(oNearest) > 0.0))) {
					ClearAllActions();
					if (sub1(intGLOB_90)) {
					...
					if (((((int1 != (-1)) && GetIsObjectValid(oSpeaker)) && (!GetIsPC(oSpeaker))) && GetIsFriend(oSpeaker, OBJECT_SELF))) {
						if ((int1 >= 1)) {
							object3 = GetLastHostileActor(oSpeaker);
							if ((!GetIsObjectValid(object3))) {
								object3 = GetAttemptedAttackTarget();
								if ((!GetIsObjectValid(object3))) {
									object3 = GetAttemptedSpellTarget();
									if ((!GetIsObjectValid(object3))) {
										object3 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
										if ((!GetIsObjectValid(object3))) {
											sub2("GENERIC DEBUG *************** No Intruder Object For Shout");
											object3 = OBJECT_INVALID;
										}
									}
								}
							}
						}
						sub3(oSpeaker, int1, object3);
					}
				}
			}
		}
