...
void main() {
	DelayCommand(0.5, ApplyEffectToObject(1, EffectVisualEffect(8001, 0), OBJECT_SELF, 5.0));
	ApplyEffectToObject(2, EffectDamageResistance(8, 50, 0), OBJECT_SELF, 0.0);
	DelayCommand(0.6, ActionPlayAnimation(115, 1.0, 0.0));
	sub1(intGLOB_82, 1);
	sub1(intGLOB_81, 1);
