...
void main() {
	...
	object oKas25_mandalor06 = GetObjectByTag("kas25_mandalor06", 0);
	object oKas25_mandalor07 = GetObjectByTag("kas25_mandalor07", 0);
	int int1 = (GetMaxHitPoints(oKas25_hurt_01) - 1);
	SetPlotFlag(oKas25_mandalor06, 0);
	SetPlotFlag(oKas25_mandalor07, 0);
	SetPlotFlag(oKas25_hurt_01, 0);
	ApplyEffectToObject(0, EffectDamage(int1, 8, 0), oKas25_hurt_01, 0.0);
	ChangeToStandardFaction(oKas25_mandalor06, 1);
	ChangeToStandardFaction(oKas25_mandalor07, 1);
	AssignCommand(oKas25_hurt_01, sub1(OBJECT_INVALID));
	AssignCommand(oKas25_mandalor06, sub1(OBJECT_INVALID));
	AssignCommand(oKas25_mandalor07, sub1(OBJECT_INVALID));
}
