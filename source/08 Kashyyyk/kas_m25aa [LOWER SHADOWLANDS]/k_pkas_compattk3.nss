...
void main() {
	...
	ChangeToStandardFaction(oKas25_drdmkfour1, 1);
	ChangeToStandardFaction(oKas25_drdmkfour2, 1);
	AssignCommand(oKas25_drdmkfour1, sub1(OBJECT_INVALID));
	AssignCommand(oKas25_drdmkfour2, sub1(OBJECT_INVALID));
}
