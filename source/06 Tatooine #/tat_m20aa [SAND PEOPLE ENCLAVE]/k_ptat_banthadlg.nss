	...
	if ((!sub1(intGLOB_55))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub1(intGLOB_52)) {
				...
				if (((nLocal < int4) && (!sub1(intGLOB_52)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub1(intGLOB_53), 2.5, float3);
			if (sub1(intGLOB_46)) {
...
int sub73() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		if (GetIsObjectValid(object3)) {
			sub2(("GENERIC DEBUG *************** Object Flee = " + sub5(object3)));
...
int sub72() {
	sub2(("GENERIC DEBUG *************** Post DCR Checks for " + sub5(OBJECT_SELF)));
	if ((sub1(intGLOB_101) && (!sub1(intGLOB_102)))) {
		if (sub73()) {
			return 1;
		}
	}
...
object sub71(object objectParam1) {
	...
	if (GetIsObjectValid(object1)) {
		sub2(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub5(object1)));
		return object1;
	}
...
int sub70(object objectParam1) {
	...
	if (GetIsObjectValid(object3)) {
		...
		sub2(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub5(object3)));
		if (GetIsObjectValid(object3)) {
			sub2(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub5(object3)));
			if ((GetRacialType(object3) == 5)) {
																						...
																						if ((intParam1 == intGLOB_37)) {
																							...
																							if ((intParam1 == intGLOB_38)) {
																								...
																								if (((intParam1 == intGLOB_39) || (intParam1 == intGLOB_40))) {
																									...
																									sub2(((("GENERIC DEBUG *************** Droid Items = " + sub5(oLArmItem)) + " / ") + sub5(oRArmItem)));
																									if (sub50()) {
...
int sub33(object objectParam1) {
	...
	if ((nLocalBool == 1)) {
		...
		sub2(("GENERIC DEBUG *************** Intruder    = " + sub5(objectParam1)));
		sub2(("GENERIC DEBUG *************** Last Target = " + sub5(oNPC)));
		sub2(("GENERIC DEBUG *************** Closest     = " + sub5(oNearest)));
	...
	sub2(((("GENERIC DEBUG *************** Target = " + sub5(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	if (GetIsObjectValid(oNPC)) {
...
int sub30() {
	...
	sub2(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub5(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub2(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub5(oNearest)) + " nCnt = ") + sub10(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub2(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub5(oNearest)));
			object1 = oNearest;
		}
		(int4++);
...
object sub17(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		...
		sub2(("GENERIC DEBUG *************** Alternate Target = " + sub5(oNearest)));
	}
	sub2(("GENERIC DEBUG *************** Heal Drain Target = " + sub10(intParam1)));
	sub2(("GENERIC DEBUG *************** Get Active Party Member: " + sub5(oNearest)));
	return oNearest;
}
...
int sub16(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_114)) {
			...
			if ((intParam1 == intGLOB_115)) {
				...
				if ((intParam1 == intGLOB_116)) {
					sub2(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub5(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
					if ((GetRacialType(OBJECT_SELF) != 5)) {
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			if (((int3 == 1) && (int4 == 1))) {
				...
				if (GetIsObjectValid(objectParam2)) {
					sub2(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub5(objectParam2)));
	...
	sub2(((((("GENERIC DEBUG *************** " + sub5(OBJECT_SELF)) + " VP = ") + sub10(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub10(GetMaxHitPoints(OBJECT_SELF))));
...
int sub12() {
	int int1 = 0;
	if (((sub1(intGLOB_108) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub1(intGLOB_105))) {
...
int sub9() {
	...
	sub2(((("GENERIC DEBUG *************** Shield Boolean (" + sub10(intGLOB_106)) + ") = ") + sub10(sub1(intGLOB_106))));
	if (((sub1(intGLOB_106) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub6(object objectParam1) {
	sub2("");
	sub2(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub5(OBJECT_SELF)));
	sub7();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub2(("GENERIC DEBUG *************** AI STYLE = " + sub8(OBJECT_SELF)));
		if (((((!sub1(intGLOB_101)) && (!sub1(intGLOB_102))) && (!sub1(intGLOB_103))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub1(intGLOB_111) == 1)) {
					if ((sub13() == 1)) {
						return;
					}
				}
				if ((sub1(intGLOB_105) == 1)) {
...
void sub3(object objectParam1, int intParam2, object oTarget) {
	sub4("");
	sub4(("GENERIC SHOUT DEBUG *************** Respond to Shout Started for " + sub5(OBJECT_SELF)));
	sub4(("GENERIC SHOUT DEBUG *************** Intruder Object = " + sub5(oTarget)));
	int int1;
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
					...
					if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
						...
						if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (nStyle != 2)) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
							...
							if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
								...
								sub4(("GENERIC SHOUT DEBUG *************** Intruder = " + sub5(oTarget)));
								if (GetObjectSeen(oTarget, OBJECT_SELF)) {
									...
									if (GetIsObjectValid(oTarget)) {
										...
										if (IsObjectPartyMember(OBJECT_SELF)) {
											...
											sub4(("GENERIC SHOUT DEBUG *************** Attack Intruder = " + sub5(oTarget)));
											if (GetIsObjectValid(oTarget)) {
												sub6(oTarget);
											}
											else {
												oTarget = GetSpellTarget(objectParam1);
												sub4(("GENERIC SHOUT DEBUG *************** Spell Intruder = " + sub5(oTarget)));
												if (GetIsObjectValid(oTarget)) {
													sub6(oTarget);
												}
											}
	...
	if ((!sub1(intGLOB_103))) {
		...
		if ((((!GetIsObjectValid(oLastActor)) || GetIsDead(oLastActor)) || (!GetObjectSeen(oLastActor, oSpeaker)))) {
			if (GetCommandable(OBJECT_SELF)) {
				if ((int1 == (-1))) {
					ClearAllActions();
					PlaySound("c_bantha_bat1");
					ActionPlayAnimation(1, 1.0, 2.0);
				}
				else {
							...
							if ((!GetIsObjectValid(oNearest))) {
								...
								if ((!GetIsObjectValid(oNearest))) {
									...
									if ((!GetIsObjectValid(oNearest))) {
										...
										if ((!GetIsObjectValid(oNearest))) {
											sub2("GENERIC DEBUG *************** No Intruder Object For Shout");
											oNearest = OBJECT_INVALID;
										}
									}
								}
