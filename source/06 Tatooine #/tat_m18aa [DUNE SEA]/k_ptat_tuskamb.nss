...
void main() {
	object oTat18_wp_tuskam1 = GetWaypointByTag("tat18_wp_tuskam1");
	object oTat18_wp_tuskam2 = GetWaypointByTag("tat18_wp_tuskam2");
	object oTat18_wp_tuskam3 = GetWaypointByTag("tat18_wp_tuskam3");
	object oTat18_wp_tuskam4 = GetWaypointByTag("tat18_wp_tuskam4");
	object oTat18_wp_tuskam5 = GetWaypointByTag("tat18_wp_tuskam5");
	object oTat18_wp_tuskam6 = GetWaypointByTag("tat18_wp_tuskam6");
	object oTat18_wp_tuskmov = GetWaypointByTag("tat18_wp_tuskmov");
	object oTat18_wp_tuskmo2 = GetWaypointByTag("tat18_wp_tuskmo2");
	object oTat18_wp_tuskmo3 = GetWaypointByTag("tat18_wp_tuskmo3");
	object oTat18_wp_tuskmo4 = GetWaypointByTag("tat18_wp_tuskmo4");
	location location1 = GetLocation(oTat18_wp_tuskam1);
	location location3 = GetLocation(oTat18_wp_tuskam2);
	location location5 = GetLocation(oTat18_wp_tuskam3);
	location location7 = GetLocation(oTat18_wp_tuskam4);
	location location9 = GetLocation(oTat18_wp_tuskam5);
	location location11 = GetLocation(oTat18_wp_tuskam6);
	ActionPauseConversation();
	DelayCommand(5.0, ActionResumeConversation());
	DelayCommand(2.0, SetDialogPlaceableCamera(3));
	sub1(1);
	object oTat18_tusken04 = CreateObject(1, "tat18_tusken04", location1, 0);
	object object23 = CreateObject(1, "tat18_tusken04", location3, 0);
	object object25 = CreateObject(1, "tat18_tusken04", location5, 0);
	object object27 = CreateObject(1, "tat18_tusken04", location7, 0);
	AssignCommand(oTat18_tusken04, DelayCommand(0.1, ActionMoveToObject(oTat18_wp_tuskmov, 1, 1.0)));
	AssignCommand(object23, DelayCommand(0.1, ActionMoveToObject(oTat18_wp_tuskmo2, 1, 1.0)));
	AssignCommand(object25, DelayCommand(0.1, ActionMoveToObject(oTat18_wp_tuskmo3, 1, 1.0)));
	AssignCommand(object27, DelayCommand(0.1, ActionMoveToObject(oTat18_wp_tuskmo4, 1, 1.0)));
	object oAreaObject = GetFirstObjectInArea(OBJECT_INVALID, 1);
	while ((GetIsObjectValid(oAreaObject) == 1)) {
		if (((GetTag(oAreaObject) == "tat18_13craw1_01") || (GetTag(oAreaObject) == "tat18_13craw2_01"))) {
			ChangeToStandardFaction(oAreaObject, 2);
			AssignCommand(oAreaObject, ClearAllActions());
			AssignCommand(oAreaObject, sub3(OBJECT_INVALID));
		}
