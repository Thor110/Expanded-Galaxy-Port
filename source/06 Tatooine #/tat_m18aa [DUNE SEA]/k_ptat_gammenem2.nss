...
void sub1(int intParam1) {
	if (((intParam1 == 1) || (intParam1 == 0))) {
		SetGlobalBoolean("tat_GammoreansDead", intParam1);
	}
	return;
}
...
void main() {
	...
	ClearAllActions();
	sub1(1);
	ChangeToStandardFaction(oTat18_12narka_01, 1);
	ChangeToStandardFaction(oTat18_12ugzak_01, 1);
	ChangeToStandardFaction(oTat18_12gurke_01, 1);
	AssignCommand(oTat18_12narka_01, sub2(OBJECT_INVALID));
	AssignCommand(oTat18_12ugzak_01, sub2(OBJECT_INVALID));
	AssignCommand(oTat18_12gurke_01, sub2(OBJECT_INVALID));
}
