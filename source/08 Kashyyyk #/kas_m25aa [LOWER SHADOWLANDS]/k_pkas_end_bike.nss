...
void main() {
	object oKas25_mandalor03 = GetObjectByTag("kas25_mandalor03", 0);
	object oKas25_mandalor04 = GetObjectByTag("kas25_mandalor04", 0);
	object oKas25_mandcomm = GetObjectByTag("kas25_mandcomm", 0);
	ChangeToStandardFaction(oKas25_mandcomm, 1);
	ChangeToStandardFaction(oKas25_mandalor03, 1);
	ChangeToStandardFaction(oKas25_mandalor04, 1);
	AssignCommand(oKas25_mandcomm, sub1(OBJECT_INVALID));
	AssignCommand(oKas25_mandalor03, sub1(OBJECT_INVALID));
	AssignCommand(oKas25_mandalor04, sub1(OBJECT_INVALID));
}
