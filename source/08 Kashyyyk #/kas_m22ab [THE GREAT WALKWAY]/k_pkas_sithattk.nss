...
void main() {
	object oKas22_darkjedi02 = GetObjectByTag("kas22_darkjedi02", 0);
	object oKas22_darkjedi03 = GetObjectByTag("kas22_darkjedi03", 0);
	ChangeToStandardFaction(oKas22_darkjedi02, 1);
	ChangeToStandardFaction(oKas22_darkjedi03, 1);
	ChangeToStandardFaction(OBJECT_SELF, 1);
	AssignCommand(oKas22_darkjedi02, DelayCommand(1.0, sub1(OBJECT_INVALID)));
	AssignCommand(oKas22_darkjedi03, DelayCommand(1.0, sub1(OBJECT_INVALID)));
