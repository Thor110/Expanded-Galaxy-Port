...
void main() {
	...
	if ((int1 == 1001)) {
		...
		if (((((GetObjectSeen(GetNearestCreature(3, 1, OBJECT_SELF, 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF), OBJECT_SELF) == 0) && (GetDistanceToObject(oPC) < 20.0)) && (sub1(OBJECT_SELF) == 0)) && (GetIsObjectValid(oKas22_wookf_trig) == 0))) {
			ClearAllActions();
