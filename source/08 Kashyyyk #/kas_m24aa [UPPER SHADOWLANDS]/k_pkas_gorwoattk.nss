...
void main() {
	object oKas24_gorguard_1 = GetWaypointByTag("kas24_gorguard_1");
	object oKas24_gorguard_2 = GetWaypointByTag("kas24_gorguard_2");
	location location1 = GetLocation(oKas24_gorguard_1);
	location location3 = GetLocation(oKas24_gorguard_2);
	object oKas24_gorguar_01 = CreateObject(1, "kas24_gorguar_01", location1, 0);
	object object7 = CreateObject(1, "kas24_gorguar_01", location3, 0);
	ChangeToStandardFaction(OBJECT_SELF, 20);
	AssignCommand(oKas24_gorguar_01, DelayCommand(1.0, sub1(OBJECT_INVALID)));
	AssignCommand(object7, DelayCommand(1.0, sub1(OBJECT_INVALID)));
	DelayCommand(1.0, sub1(OBJECT_INVALID));
}
