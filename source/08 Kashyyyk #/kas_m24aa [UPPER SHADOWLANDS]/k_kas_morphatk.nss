...
void main() {
	...
	if ((GetGlobalNumber("KAS_RULAN_NPC") == 1)) {
		...
		if ((GetGlobalNumber("KAS_RULAN_NPC") == 2)) {
			string1 = "rulan_juhani";
		}
		else {
			if ((GetGlobalNumber("KAS_RULAN_NPC") == 3)) {
				string1 = "rulan_jolee";
			}
			else {
				if ((GetGlobalNumber("KAS_RULAN_NPC") == 4)) {
					...
					if ((GetGlobalNumber("KAS_RULAN_NPC") == 5)) {
						string1 = "rulan_hk47";
					}
					else {
						if ((GetGlobalNumber("KAS_RULAN_NPC") == 6)) {
							string1 = "rulan_zaalbar";
						}
						else {
							if ((GetGlobalNumber("KAS_RULAN_NPC") == 7)) {
								string1 = "rulan_mission";
							}
							else {
								string1 = "rulan_bastila";
							}
						}
					}
				}
	...
	DelayCommand(0.2, AssignCommand(GetObjectByTag(string1, 0), ChangeToStandardFaction(OBJECT_SELF, 1)));
	DelayCommand(0.8, AssignCommand(GetObjectByTag(string1, 0), sub1(OBJECT_INVALID)));
}
