					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								int nGlobal = GetGlobalNumber("kas_JoleeKatarn");
								switch (nGlobal) {
									case 0:
										SetGlobalNumber("kas_JoleeKatarn", (GetGlobalNumber("kas_JoleeKatarn") + 1));
									...
									case 3:
										SetGlobalNumber("kas_JoleeKatarn", (GetGlobalNumber("kas_JoleeKatarn") + 1));
										AssignCommand(oKas24_joleespeak, ActionResumeConversation());
										break;
								}
							}
							else {
