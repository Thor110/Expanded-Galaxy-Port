...
// Prototypes
void sub7(int intParam1, string stringParam2, location locationParam3);
int sub6();
...
void sub4(int intParam1, object objectParam2) {
	if (((intParam1 == 1) || (intParam1 == 0))) {
		sub5(objectParam2, intGLOB_8, intParam1);
	}
	return;
}
...
int sub2(object objectParam1) {
	return sub3(objectParam1, intGLOB_8);
}
