					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								if (((((!GetIsObjectValid(oKas_xor2)) || GetIsDead(oKas_xor2)) && ((!GetIsObjectValid(oKas_xor3)) || GetIsDead(oKas_xor3))) && sub1(GetObjectByTag("kas_xor1", 0)))) {
									CancelCombat(GetPartyMemberByIndex(0));
									CancelCombat(GetPartyMemberByIndex(1));
									CancelCombat(GetPartyMemberByIndex(2));
									NoClicksFor(1.2);
									AssignCommand(GetObjectByTag("invis_xor_conv", 0), DelayCommand(1.0, ActionStartConversation(OBJECT_SELF, "", 0, 0, 0, "", "", "", "", "", "")));
								}
							}
							else {
								if ((int1 == 1008)) {
