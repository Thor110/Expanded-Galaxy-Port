...
void main() {
	ChangeToStandardFaction(GetObjectByTag("unk41_rancor01", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("unk41_rancor02", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("unk41_blk1", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("unk41_blk2", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("unk41_blk3", 0), 1);
	ChangeToStandardFaction(GetObjectByTag("unk41_blk4", 0), 1);
	DelayCommand(0.5, AssignCommand(GetObjectByTag("unk41_rancor01", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("unk41_rancor02", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("unk41_blk1", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("unk41_blk2", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("unk41_blk3", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(GetObjectByTag("unk41_blk4", 0), sub1(OBJECT_INVALID)));
}
