...
void main() {
	...
	sub2(GetPartyMemberByIndex(0), GetLocation(GetObjectByTag("playerwp", 0)));
	sub2(GetPartyMemberByIndex(1), GetLocation(GetObjectByTag("pm1wp", 0)));
	sub2(GetPartyMemberByIndex(2), GetLocation(GetObjectByTag("pm2wp", 0)));
