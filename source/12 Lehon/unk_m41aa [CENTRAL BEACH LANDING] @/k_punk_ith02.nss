...
void main() {
	DelayCommand(0.1, ChangeToStandardFaction(GetObjectByTag("unk41_ithor01", 0), 1));
	DelayCommand(0.1, ChangeToStandardFaction(GetObjectByTag("unk41_ithor02", 0), 1));
	DelayCommand(0.4, AssignCommand(GetObjectByTag("unk41_ithor01", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.4, AssignCommand(GetObjectByTag("unk41_ithor02", 0), sub1(OBJECT_INVALID)));
}
