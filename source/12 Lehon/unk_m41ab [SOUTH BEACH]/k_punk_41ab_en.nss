...
// Prototypes
/*
void sub81(string stringParam1, int intParam2, int intParam3, float floatParam4);
void sub80();
int sub79(int intParam1, int intParam2);
void sub78();
void sub77(string stringParam1);
int sub76(object objectParam1);
void sub75();
int sub74();
int sub73();
object sub72(object objectParam1);
int sub71(object objectParam1);
int sub70(object objectParam1);
talent sub69(object objectParam1, talent talentParam2);
...
int sub55();
int sub54();
talent sub53(int intParam1);
string sub52(int intParam1);
int sub51();
int sub50();
int sub49();
int sub48();
...
talent sub25(int intParam1, int intParam2);
int sub24(object objectParam1, float floatParam2);
int sub23(object objectParam1, float floatParam2);
object sub22();
int sub21();
int sub20(object objectParam1);
int sub19();
object sub18(int intParam1);
int sub17(int intParam1, object objectParam2);
object sub16();
int sub15(object objectParam1);
int sub14();
int sub13();
void sub12(int intParam1, int intParam2);
string sub11(int intParam1);
int sub10();
int sub9(int intParam1);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub12(intGLOB_73, 1));
					}
					else {
	...
	if ((!sub9(intGLOB_82))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub9(intGLOB_79)) {
				...
				if (((nLocal < int4) && (!sub9(intGLOB_79)))) {
					int16 = sub79(int4, nLocal);
					nLocal = (nLocal + int16);
				}
				else {
					if ((nLocal == int4)) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub9(intGLOB_80), 2.5, float3);
			if (sub9(intGLOB_73)) {
...
int sub76(object objectParam1) {
	...
	sub77(("Walk Initiate for " + GetTag(objectParam1)));
	sub77(("TAG WAY FOUND = " + IntToString(GetIsObjectValid(oWP))));
	sub77(("WAY POINT NAME = " + GetTag(oWP)));
	sub77(("SERIES INT = " + IntToString(nLocal)));
	sub77(("SERIES WAY FOUND = " + IntToString(GetIsObjectValid(object3))));
	sub77(("SERIES Series Tag = " + string8));
	sub77("");
...
int sub74() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		DelayCommand(0.2, ActionDoCommand(sub75()));
		return 1;
	}
	else {
		if (GetIsObjectValid(object3)) {
			sub5(("GENERIC DEBUG *************** Object Flee = " + sub6(object3)));
...
int sub73() {
	sub5(("GENERIC DEBUG *************** Post DCR Checks for " + sub6(OBJECT_SELF)));
	if ((sub9(intGLOB_128) && (!sub9(intGLOB_129)))) {
		if (sub74()) {
			return 1;
		}
	}
	...
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub76(OBJECT_SELF) == 1))) {
		sub5("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
		DelayCommand(1.0, sub78());
		return 1;
	}
	else {
		if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetIsObjectValid(GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF)))) && IsObjectPartyMember(OBJECT_SELF))) {
			if ((!GetSoloMode())) {
				sub81("NO TARGET: FOLLOW LEADER", 10, 10, 4.0);
...
object sub72(object objectParam1) {
	...
	if (GetIsObjectValid(object1)) {
		sub5(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub6(object1)));
		return object1;
	}
...
int sub71(object objectParam1) {
	object object1 = sub35();
	talent talent1;
	object object3;
	if ((GetRacialType(OBJECT_SELF) == 5)) {
		return sub34(OBJECT_INVALID);
	}
	if (sub17(intGLOB_144, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub17(intGLOB_142, object1)) {
			return 1;
		}
	}
	object object4 = sub16();
	if (GetIsObjectValid(object4)) {
		if (sub17(intGLOB_143, object4)) {
			return 1;
		}
	}
	object3 = sub30();
	sub5(("GENERIC DEBUG *************** Jedi Support AI: AOE Target = " + sub11(GetIsObjectValid(object3))));
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub25(intGLOB_29, 1);
		}
		else {
			talent1 = sub25(intGLOB_29, 0);
		}
	}
	else {
		sub5("GENERIC DEBUG *************** Jedi Support AI: Inside the Party AI Section");
		object3 = sub72(OBJECT_INVALID);
		sub5(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub6(object3)));
		if (GetIsObjectValid(object3)) {
			sub5(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub6(object3)));
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub25(intGLOB_30, 1);
			}
			else {
				talent1 = sub25(intGLOB_30, 0);
			}
		}
	}
...
int sub68(int intParam1) {
	int int1;
	int nRandom = d4(1);
	if ((sub20(OBJECT_SELF) != 0)) {
		while ((int1 == 0)) {
			if ((sub20(OBJECT_SELF) == 1)) {
				if ((nRandom == 1)) {
					nRandom = intGLOB_44;
				}
				else {
				...
				if ((intParam1 == intGLOB_46)) {
					...
					if ((intParam1 == intGLOB_47)) {
						...
						if ((intParam1 == intGLOB_48)) {
							...
							if ((intParam1 == intGLOB_49)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub39())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_50)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub39())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_51)) {
										...
										if ((intParam1 == intGLOB_52)) {
											...
											if ((intParam1 == intGLOB_53)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub43() && sub44()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_54)) {
													...
													if ((intParam1 == intGLOB_55)) {
														...
														if ((intParam1 == intGLOB_56)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub41() && sub47()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_57)) {
																if (((sub47() && sub40()) && sub48())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_58)) {
																	if (((sub45() && sub40()) && sub42())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_59)) {
																		if (((sub46() && sub40()) && sub42())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_59)) {
																			if (((sub41() && sub49()) && sub40())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_61)) {
																				talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																				if ((sub49() && GetIsTalentValid(talRandom))) {
																					return 1;
																				}
																			}
																			else {
																				if ((intParam1 == intGLOB_62)) {
																					if (((sub49() && sub40()) && sub48())) {
																						return 1;
																					}
																				}
																				else {
																					if ((intParam1 == intGLOB_63)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if ((sub40() && GetIsTalentValid(talRandom))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_64)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub40() && sub47()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_65)) {
																								...
																								if (((intParam1 == intGLOB_66) || (intParam1 == intGLOB_67))) {
																									...
																									sub5(((("GENERIC DEBUG *************** Droid Items = " + sub6(oLArmItem)) + " / ") + sub6(oRArmItem)));
																									if (sub51()) {
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				int2 = sub37(intParam1);
				sub5(("GENERIC DEBUG *************** Starting Jedi Combo " + sub52(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub5(("GENERIC DEBUG *************** Starting Droid Combo " + sub52(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub53(int2);
				}
					...
					sub5(("GENERIC DEBUG *************** Starting NPC Combo " + sub52(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub53(int2);
				}
		...
		sub5(("GENERIC DEBUG *************** Continuing Combo " + sub52(structGLOB_1.int15)));
		return sub53(structGLOB_1.int15);
	}
	return talent1;
}
...
int sub34(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub17(intGLOB_142, oNPC)) {
			return 1;
		}
	}
	oNPC = sub16();
	if (GetIsObjectValid(oNPC)) {
		if (sub17(intGLOB_143, oNPC)) {
			return 1;
		}
	}
	talent1 = sub36(0);
	...
	if ((nLocalBool == 1)) {
		...
		sub5(("GENERIC DEBUG *************** Intruder    = " + sub6(objectParam1)));
		sub5(("GENERIC DEBUG *************** Last Target = " + sub6(oNPC)));
		sub5(("GENERIC DEBUG *************** Closest     = " + sub6(oNearest)));
	...
	if ((GetRacialType(OBJECT_SELF) == 5)) {
		talent1 = sub69(oNPC, talent1);
	}
	talent1 = sub32(oNPC, talent1);
	talent1 = sub33(oNPC, talent1);
	sub5("GENERIC DEBUG *************** Default AI Debug End ***************************");
	sub5(((("GENERIC DEBUG *************** Target = " + sub6(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	if (GetIsObjectValid(oNPC)) {
...
int sub31() {
	...
	sub5((("GENERIC DEBUG *************** Boss AI: Get the #" + sub11(nRandom)) + " target"));
	object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, int4, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
	sub5(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub6(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub5(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub6(oNearest)) + " nCnt = ") + sub11(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub5(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub6(oNearest)));
			object1 = oNearest;
		}
		(int4++);
	...
	if ((int7 == 1)) {
		if (GetIsTalentValid(talent1)) {
			if ((GetTypeFromTalent(talent1) == 1)) {
				sub5(("GENERIC DEBUG *************** Boss AI: Talent Feat = " + sub11(GetIdFromTalent(talent1))));
			}
			else {
				if ((GetTypeFromTalent(talent1) == 0)) {
					sub5(("GENERIC DEBUG *************** Boss AI: Talent Power = " + sub11(GetIdFromTalent(talent1))));
				}
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		...
		talent1 = sub25(intGLOB_30, int1);
		talent1 = sub32(object1, talent1);
		talent1 = sub33(object1, talent1);
		sub5(("GENERIC DEBUG *************** Boss AI: Target = " + sub11(GetIsObjectValid(object1))));
		sub5(("GENERIC DEBUG *************** Boss AI: Talent = " + sub11(GetIsTalentValid(talent1))));
...
int sub29() {
	...
	talent talent1;
	object object1 = sub30();
	sub5(("GENERIC DEBUG *************** Boss AI: AOE Target = " + sub11(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub25(intGLOB_29, int2);
		if (GetIsTalentValid(talent1)) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
...
talent sub27(int intParam1) {
	...
	sub5(("GENERIC DEBUG *************** Last Force Power Used = " + sub11(nLastForce)));
	...
	sub5(("GENERIC DEBUG *************** Force Power Returned = " + sub11(GetIdFromTalent(talent1))));
	return talent1;
}
...
object sub22() {
	...
	while (GetIsObjectValid(oShapeObject)) {
		if ((GetObjectSeen(oShapeObject, OBJECT_SELF) && (!GetIsDead(oShapeObject)))) {
			int3 = sub23(oShapeObject, 4.0);
			int4 = sub24(oShapeObject, 4.0);
...
int sub21() {
	...
	talent talent1;
	object object1 = sub22();
	sub5(("GENERIC DEBUG *************** Boss AI: Grenade Target = " + sub11(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub25(intGLOB_28, int2);
		if (GetIsTalentValid(talent1)) {
...
int sub19() {
	object oInvItem;
	if (((((GetIsObjectValid(GetAttackTarget(OBJECT_SELF)) && (GetDistanceBetween(GetAttackTarget(OBJECT_SELF), OBJECT_SELF) <= 3.0)) && (sub20(OBJECT_SELF) != 1)) && (GetRacialType(OBJECT_SELF) == 6)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		...
		if (((((((sub20(OBJECT_SELF) != 2) && (GetLevelByClass(4, OBJECT_SELF) == 0)) && (GetLevelByClass(3, OBJECT_SELF) == 0)) && (GetLevelByClass(5, OBJECT_SELF) == 0)) && (GetDistanceBetween(GetAttemptedAttackTarget(), OBJECT_SELF) > 3.0)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
			oInvItem = GetFirstItemInInventory(OBJECT_SELF);
			while (GetIsObjectValid(oInvItem)) {
...
object sub18(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		...
		sub5(("GENERIC DEBUG *************** Alternate Target = " + sub6(oNearest)));
	}
	sub5(("GENERIC DEBUG *************** Heal Drain Target = " + sub11(intParam1)));
	sub5(("GENERIC DEBUG *************** Get Active Party Member: " + sub6(oNearest)));
	return oNearest;
}
...
int sub17(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_141)) {
			...
			if ((intParam1 == intGLOB_142)) {
				...
				if ((intParam1 == intGLOB_143)) {
					sub5(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub6(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
					if ((GetRacialType(OBJECT_SELF) != 5)) {
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub5(("GENERIC DEBUG *************** Spells.2DA ID = " + sub11(nTalent)));
			ClearAllActions();
			...
			if (((int3 == 1) && (int4 == 1))) {
				objectParam2 = sub18(1);
				if (GetIsObjectValid(objectParam2)) {
					sub5(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub6(objectParam2)));
	...
	sub5(((((("GENERIC DEBUG *************** " + sub6(OBJECT_SELF)) + " VP = ") + sub11(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub11(GetMaxHitPoints(OBJECT_SELF))));
...
int sub15(object objectParam1) {
	...
	object object1 = sub16();
	if (GetIsObjectValid(object1)) {
		if (sub17(intGLOB_143, object1)) {
			return 1;
		}
	}
	if (sub19()) {
...
int sub13() {
	int int1 = 0;
	if (((sub9(intGLOB_135) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub9(intGLOB_132))) {
...
int sub10() {
	...
	sub5(((("GENERIC DEBUG *************** Shield Boolean (" + sub11(intGLOB_133)) + ") = ") + sub11(sub9(intGLOB_133))));
	if (((sub9(intGLOB_133) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub4(object objectParam1) {
	sub5("");
	sub5(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub6(OBJECT_SELF)));
	sub7();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub5(("GENERIC DEBUG *************** AI STYLE = " + sub8(OBJECT_SELF)));
		if (((((!sub9(intGLOB_128)) && (!sub9(intGLOB_129))) && (!sub9(intGLOB_130))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub9(intGLOB_138) == 1)) {
					if ((sub14() == 1)) {
						return;
					}
				}
				if ((sub9(intGLOB_132) == 1)) {
					if ((sub15(objectParam1) == 1)) {
						return;
					}
				}
				if ((nNPCStyle == 0)) {
					if ((sub34(objectParam1) == 1)) {
						return;
					}
				}
				else {
...
void sub3() {
	...
	while (GetIsObjectValid(oAreaObject)) {
		if ((((((GetTag(oAreaObject) != "unk42_breed01") && (GetTag(oAreaObject) != "unk42_breed02")) && (GetTag(oAreaObject) != "unk42_breed03")) && (GetTag(oAreaObject) != "unk41_gizka")) && (IsObjectPartyMember(oAreaObject) == 0))) {
			ChangeToStandardFaction(oAreaObject, 1);
			AssignCommand(oAreaObject, ClearAllActions());
			//AssignCommand(oAreaObject, sub4(OBJECT_INVALID));
		}
