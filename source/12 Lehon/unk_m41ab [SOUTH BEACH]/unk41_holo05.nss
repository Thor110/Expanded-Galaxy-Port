...
void main() {
	...
	DelayCommand(1.0, sub1("unk41_pillar1", 20.0, 1));
	DelayCommand(1.0, sub1("unk41_pillar2", 20.0, 1));
	DelayCommand(1.0, sub1("unk41_pillar3", 20.0, 1));
	DelayCommand(1.0, sub1("unk41_pillar4", 20.0, 1));
	DelayCommand(1.0, sub1("unk41_pillar5", 20.0, 1));
	DelayCommand(1.0, sub1("unk41_pillar6", 20.0, 1));
	ActionWait(1.0);
