	...
	while ((int1 < intParam3)) {
		switch (intParam2) {
			case 0:
				switch (Random(3)) {
					case 0:
						CreateItemOnObject("G_I_CREDITS001", objectParam1, (Random(50) + 20));
						break;
					case 1:
						CreateItemOnObject("G_I_MEDEQPMNT04", objectParam1, 1);
						break;
					default:
						CreateItemOnObject("G_I_MEDEQPMNT02", objectParam1, 1);
				}
				break;
			case 1:
				switch (Random(5)) {
					...
					case 1:
						...
						break;
					case 2:
						CreateItemOnObject("G_I_DRDREPEQP002", objectParam1, 1);
						break;
					case 3:
						CreateItemOnObject("G_I_PARTS01", objectParam1, 1);
						break;
					default:
						CreateItemOnObject("G_I_MEDEQPMNT02", objectParam1, 1);
				}
