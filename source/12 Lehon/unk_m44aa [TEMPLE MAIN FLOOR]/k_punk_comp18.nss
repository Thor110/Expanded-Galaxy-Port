...
void main() {
	...
	sub1(GetObjectByTag("TempleComp2", 0), 9, 1);
	AssignCommand(GetObjectByTag("TempleComp2", 0), ActionPlayAnimation(201, 1.0, 0.0));
	AssignCommand(GetObjectByTag("TempleComp2", 0), sub2("TempleComp2", 10.0, 1));
}
