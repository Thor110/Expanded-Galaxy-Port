...
void main() {
	SetGlobalBoolean("UNK_SCO", 1);
	sub1(GetObjectByTag("TempleComp1", 0), 9, 1);
	AssignCommand(GetObjectByTag("TempleComp1", 0), ActionPlayAnimation(201, 1.0, 0.0));
	AssignCommand(GetObjectByTag("TempleComp1", 0), sub2("TempleComp1", 10.0, 1));
}
