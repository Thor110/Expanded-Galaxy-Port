...
void main() {
	SetGlobalBoolean("UNK_NCO", 1);
	sub1(GetObjectByTag("TempleComp3", 0), 9, 1);
	AssignCommand(GetObjectByTag("TempleComp3", 0), ActionPlayAnimation(201, 1.0, 0.0));
	AssignCommand(GetObjectByTag("TempleComp3", 0), sub2("TempleComp3", 10.0, 1));
}
