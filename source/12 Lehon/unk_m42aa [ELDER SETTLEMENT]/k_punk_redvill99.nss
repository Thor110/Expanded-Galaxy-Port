...
void main() {
	sub1();
	CreateObject(1, "g_rakatan04", GetLocation(GetObjectByTag("rakspawn1", 0)), 0);
	CreateObject(1, "g_rakatan05", GetLocation(GetObjectByTag("rakspawn2", 0)), 0);
	DelayCommand(1.0, sub2(OBJECT_INVALID));
}
