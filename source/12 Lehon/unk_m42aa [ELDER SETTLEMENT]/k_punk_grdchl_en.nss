...
void main() {
	...
	object oNearestRedrakata422;
	if (((GetIsPC(oEntering) && (!sub1(OBJECT_SELF))) && (!sub2()))) {
		sub3(OBJECT_SELF, 1);
		oNearestRedrakata422 = GetNearestObjectByTag("redrakata422", oEntering, 1);
		AssignCommand(oNearestRedrakata422, ActionStartConversation(oEntering, "", 0, 0, 0, "", "", "", "", "", ""));
	}
}
