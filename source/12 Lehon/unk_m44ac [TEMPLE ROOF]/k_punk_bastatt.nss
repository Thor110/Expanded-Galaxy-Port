...
void main() {
	...
	sub1(OBJECT_INVALID);
	AssignCommand(GetPartyMemberByIndex(1), sub1(OBJECT_INVALID));
	AssignCommand(GetPartyMemberByIndex(2), sub1(OBJECT_INVALID));
	SetPlotFlag(GetObjectByTag("bastilae", 0), 0);
	SetPlotFlag(GetPartyMemberByIndex(0), 0);
	SetPlotFlag(GetPartyMemberByIndex(1), 0);
	SetPlotFlag(GetPartyMemberByIndex(2), 0);
}
