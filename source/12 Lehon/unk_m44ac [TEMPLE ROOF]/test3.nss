...
void main() {
	SetPlotFlag(GetObjectByTag("bastila", 0), 0);
	SetPlotFlag(GetObjectByTag("jolee", 0), 0);
	SetPlotFlag(GetObjectByTag("juhani", 0), 0);
	ChangeToStandardFaction(GetObjectByTag("jolee", 0), 1);
	DelayCommand(0.1, AssignCommand(GetObjectByTag("jolee", 0), sub1(OBJECT_INVALID)));
	ChangeToStandardFaction(GetObjectByTag("juhani", 0), 1);
	DelayCommand(0.1, AssignCommand(GetObjectByTag("juhani", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.2, DestroyObject(OBJECT_SELF, 0.0, 1, 0.0));
}
