			...
			if ((int1 == 1003)) {
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							if ((GetGlobalBoolean("UNK_PARTY_DOWN") == 1)) {
								...
								AssignCommand(GetObjectByTag("Bastila", 0), DelayCommand(1.0, ActionStartConversation(GetPartyMemberByIndex(0), "", 0, 0, 0, "", "", "", "", "", "")));
							}
							else {
								SetGlobalBoolean("UNK_PARTY_DOWN", 1);
								sub1("one down", 5, 5, 1.0);
							}
						}
						else {
							if ((int1 == 1007)) {
