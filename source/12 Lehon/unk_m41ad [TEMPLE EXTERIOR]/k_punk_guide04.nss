			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub10(intGLOB_73, 1));
					}
					else {
	...
	if ((!sub7(intGLOB_82))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub7(intGLOB_79)) {
				...
				if (((nLocal < int4) && (!sub7(intGLOB_79)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub7(intGLOB_80), 2.5, float3);
			if (sub7(intGLOB_73)) {
...
int sub71() {
	...
	if ((sub7(intGLOB_128) && (!sub7(intGLOB_129)))) {
		if (sub72()) {
			return 1;
		}
	}
...
int sub69(object objectParam1) {
	...
	if (sub15(intGLOB_144, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub15(intGLOB_142, object1)) {
			return 1;
		}
	}
	object object4 = sub14();
	if (GetIsObjectValid(object4)) {
		if (sub15(intGLOB_143, object4)) {
			return 1;
		}
	}
	object3 = sub28();
	...
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub23(intGLOB_29, 1);
		}
		else {
			talent1 = sub23(intGLOB_29, 0);
		}
	}
	else {
		...
		if (GetIsObjectValid(object3)) {
			...
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub23(intGLOB_30, 1);
			}
			else {
				talent1 = sub23(intGLOB_30, 0);
			}
		}
	}
...
int sub32(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub15(intGLOB_142, oNPC)) {
			return 1;
		}
	}
	oNPC = sub14();
	if (GetIsObjectValid(oNPC)) {
		if (sub15(intGLOB_143, oNPC)) {
			return 1;
		}
	}
	talent1 = sub34(0);
...
int sub11() {
	...
	if (((sub7(intGLOB_135) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub7(intGLOB_132))) {
...
int sub8() {
	...
	sub3(((("GENERIC DEBUG *************** Shield Boolean (" + sub9(intGLOB_133)) + ") = ") + sub9(sub7(intGLOB_133))));
	if (((sub7(intGLOB_133) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub2(object objectParam1) {
	...
	sub5();
	{
		...
		if (((((!sub7(intGLOB_128)) && (!sub7(intGLOB_129))) && (!sub7(intGLOB_130))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub7(intGLOB_138) == 1)) {
					if ((sub12() == 1)) {
						return;
					}
				}
				if ((sub7(intGLOB_132) == 1)) {
...
void main() {
	sub1();
	sub80();
	DestroyObject(GetObjectByTag("unk41_rakguider", 0), 0.0, 1, 0.0);
}
