...
void main() {
	...
	if (((GetIsPC(oEntering) == 1) && (GetLoadFromSaveGame() == 0))) {
		sub1(OBJECT_SELF);
		...
		if (((GetGlobalBoolean("UNK_TEMPLEREADY") == 1) && (GetGlobalBoolean("UNK_GUIDE") == 0))) {
			SetGlobalBoolean("UNK_GUIDE", 1);
			if ((GetGlobalBoolean("Unk_BlackHostile") == 1)) {
				sub3("spawning red guide", 5, 5, 1.0);
				...
				if ((GetGlobalBoolean("Unk_RedHostile") == 1)) {
					sub3("spawning black guide", 5, 5, 1.0);
		...
		if ((((GetGlobalBoolean("UNK_BLACKHOSTILE") == 0) && (GetGlobalBoolean("UNK_THEONE") == 1)) && (GetIsObjectValid(GetObjectByTag("g_rancor03", 0)) == 0))) {
			...
			if ((GetGlobalBoolean("UNK_TEMP9") == 1)) {
		...
		if (((GetIsObjectValid(GetObjectByTag("g_rancor02", 0)) == 0) && (GetGlobalBoolean("UNK_TEMP9") == 1))) {
