...
void main() {
	...
	object oNearestLev40_blastdoorf = GetNearestObjectByTag("lev40_blastdoorf", OBJECT_SELF, 1);
	object oDarthmalak400 = GetObjectByTag("darthmalak400", 0);
	if ((GetIsPC(oEntering) && (!sub1(OBJECT_SELF)))) {
		sub2(OBJECT_SELF, 1);
		AssignCommand(oNearestLev40_blastdoorf, ActionCloseDoor(oNearestLev40_blastdoorf));
		SetLocked(oNearestLev40_blastdoorf, 1);
