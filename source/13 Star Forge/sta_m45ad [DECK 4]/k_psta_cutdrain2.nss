void main() {
	...
	AssignCommand(oSta_45darthMalak, ActionCastFakeSpellAtObject(15, oNearestSta_plc_captive2, 0));
	DelayCommand(1.0, ApplyEffectToObject(1, efBeam, oNearestSta_plc_captive2, 2.0));
	...
	DelayCommand(2.0, AssignCommand(oNearestSta_plc_captive2, ActionPlayAnimation(201, 1.0, 0.0)));
	ActionWait(3.0);
