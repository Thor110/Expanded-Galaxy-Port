...
void main() {
	...
	object oSta45d_sta45c = GetObjectByTag("sta45d_sta45c", 0);
	AssignCommand(oK45_door_malak, ActionCloseDoor(oK45_door_malak));
	SetLocked(oK45_door_malak, 1);
	AssignCommand(oSta45d_sta45c, ActionCloseDoor(oSta45d_sta45c));
	SetLocked(oSta45d_sta45c, 1);
	object oPC = GetFirstPC();
