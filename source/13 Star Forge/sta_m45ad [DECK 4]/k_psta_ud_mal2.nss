...
void main() {
	...
	if ((int1 == 1001)) {
		...
		int int5 = GetGlobalBoolean("STA_MALAK_DRAIN");
		if ((((((nGlobal > 0) && (!GetIsInConversation(oNearestSta_jedi_conv))) && (!GetIsInCombat(OBJECT_SELF))) && (!GetIsInConversation(OBJECT_SELF))) && (int5 != 1))) {
			if ((GetDistanceToObject(oPC) > 15.0)) {
				ActionMoveToObject(oPC, 1, 1.0);
			}
			else {
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							int int15 = GetGlobalNumber("STA_MALAK_JEDI");
