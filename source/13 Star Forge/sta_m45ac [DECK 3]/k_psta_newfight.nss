...
void main() {
	object oNearestK45_gen_newdroid = GetNearestObjectByTag("k45_gen_newdroid", OBJECT_SELF, 1);
	ChangeToStandardFaction(oNearestK45_gen_newdroid, 2);
	DelayCommand(0.5, AssignCommand(oNearestK45_gen_newdroid, sub1(OBJECT_INVALID)));
}
