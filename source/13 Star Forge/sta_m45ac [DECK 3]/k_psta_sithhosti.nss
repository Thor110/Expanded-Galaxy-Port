...
void main() {
	...
	ChangeToStandardFaction(oSta_sith2, 1);
	ChangeToStandardFaction(oSta_sith3, 1);
	ChangeToStandardFaction(OBJECT_SELF, 1);
	DelayCommand(0.5, AssignCommand(oSta_sith2, sub1(oPC)));
	DelayCommand(0.5, AssignCommand(oSta_sith3, sub1(oPC)));
