										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 1011)) {
												...
												if ((int1 == 2222)) {
													...
													if (((((!GetIsObjectValid(oK_sta_sithfreeze)) || GetIsDead(oK_sta_sithfreeze)) && ((!GetIsObjectValid(oK_sta_sithfreeze2)) || GetIsDead(oK_sta_sithfreeze2))) && ((!GetIsObjectValid(oK_sta_sithfreeze3)) || GetIsDead(oK_sta_sithfreeze3)))) {
