...
void main() {
	...
	object oSta_way_party_1 = GetObjectByTag("sta_way_party_1", 0);
	object oSta_way_party_2 = GetObjectByTag("sta_way_party_2", 0);
	SetPartyLeader(0xFFFFFFFF);
	SetLockOrientationInDialog(GetPartyMemberByIndex(0), 1);
	SetLockOrientationInDialog(GetPartyMemberByIndex(1), 1);
	SetLockOrientationInDialog(GetPartyMemberByIndex(2), 1);
	sub1(oSta_way_party0, oSta_way_party_1, oSta_way_party_2);
	DelayCommand(0.3, sub1(oSta_way_party0, oSta_way_party_1, oSta_way_party_2));
}
