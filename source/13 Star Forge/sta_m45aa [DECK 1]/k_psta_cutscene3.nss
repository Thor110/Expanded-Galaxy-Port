...
void main() {
	object oSta_trgcutscene2 = GetObjectByTag("sta_trgcutscene2", 0);
	if (((GetIsPC(GetEnteringObject()) && (!sub1(OBJECT_SELF, intGLOB_118))) && (!sub1(oSta_trgcutscene2, intGLOB_118)))) {
		sub2(OBJECT_SELF, intGLOB_118, 1);
		unknown unknown1 = EventUserDefined(451);
		...
		NoClicksFor(0.7);
		DelayCommand(0.5, AssignCommand(GetObjectByTag("sta_cutscene2", 0), ActionStartConversation(OBJECT_SELF, "", 0, 0, 0, "", "", "", "", "", "")));
	}
}
