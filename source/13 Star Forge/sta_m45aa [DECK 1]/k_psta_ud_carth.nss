						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								if (GetIsObjectValid(oSta_bastila)) {
									object object5 = GetObjectByTag("sta_bastila", 0);
									...
									DelayCommand(3.0, sub1("sta_bastila", "", OBJECT_INVALID));
									...
									AssignCommand(object9, ActionMoveToObject(oSta_way_exit, 0, 1.0));
								}
							}
							else {
								if ((int1 == 1008)) {
