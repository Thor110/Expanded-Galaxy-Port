...
void main() {
	object oNPC = GetPartyMemberByIndex(0);
	object oSta_trg_hostcut3 = GetObjectByTag("sta_trg_hostcut3", 0);
	if ((((GetEnteringObject() == oNPC) && (!sub1(OBJECT_SELF, intGLOB_118))) && (!sub1(oSta_trg_hostcut3, intGLOB_118)))) {
		...
		ChangeToStandardFaction(oK_sta_darkjedi1, 4);
		ChangeToStandardFaction(oK_sta_darkjedi2, 4);
		ChangeToStandardFaction(oK_sta_darkjedi3, 4);
		SetNPCAIStyle(oK_sta_darkjedi1, 2);
		SetNPCAIStyle(oK_sta_darkjedi2, 2);
		SetNPCAIStyle(oK_sta_darkjedi3, 2);
		SetNPCAIStyle(oK_sta_lightjedi1, 2);
		SetNPCAIStyle(oK_sta_lightjedi2, 2);
		SetNPCAIStyle(oK_sta_lightjedi3, 2);
		DelayCommand(0.1, AssignCommand(oK_sta_darkjedi1, sub3(oK_sta_lightjedi1)));
		DelayCommand(0.1, AssignCommand(oK_sta_lightjedi1, sub3(oK_sta_darkjedi1)));
		DelayCommand(0.2, AssignCommand(oK_sta_darkjedi2, sub3(oK_sta_lightjedi2)));
		DelayCommand(0.2, AssignCommand(oK_sta_lightjedi2, sub3(oK_sta_darkjedi2)));
		DelayCommand(0.3, AssignCommand(oK_sta_darkjedi3, sub3(oK_sta_lightjedi3)));
		DelayCommand(0.3, AssignCommand(oK_sta_lightjedi3, sub3(oK_sta_darkjedi3)));
	}
}
