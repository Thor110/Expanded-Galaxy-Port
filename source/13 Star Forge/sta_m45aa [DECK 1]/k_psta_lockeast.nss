...
void main() {
	...
	if ((((GetEnteringObject() == oNPC) && (!sub1(OBJECT_SELF, intGLOB_1))) && (!sub1(oSta_trg_lockwest, intGLOB_1)))) {
		object oSta_dor_lockeast = GetObjectByTag("sta_dor_lockeast", 0);
		AssignCommand(oSta_dor_lockeast, ActionCloseDoor(oSta_dor_lockeast));
		SetLocked(oSta_dor_lockeast, 1);
