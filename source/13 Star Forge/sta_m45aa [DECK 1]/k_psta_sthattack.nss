...
void main() {
	...
	SignalEvent(oSta45a_Sith01, unknown1);
	SignalEvent(oSta45a_Sith02, unknown1);
	SignalEvent(oSta45a_Sith03, unknown1);
	SignalEvent(oSta45a_Sith04, unknown1);
	...
	unknown unknown3 = EventUserDefined(145);
	AssignCommand(oSta_Jedi001, sub1(oSta45a_Sith01));
	AssignCommand(oSta_Jedi002, sub1(oSta45a_Sith02));
	AssignCommand(oSta_Jedi003, sub1(oSta45a_Sith03));
	AssignCommand(oSta_Jedi004, sub1(oSta45a_Sith04));
}
