...
void main() {
	object oSta_trgcutscene3 = GetObjectByTag("sta_trgcutscene3", 0);
	if (((GetIsPC(GetEnteringObject()) && (!sub1(OBJECT_SELF, intGLOB_118))) && (!sub1(oSta_trgcutscene3, intGLOB_118)))) {
