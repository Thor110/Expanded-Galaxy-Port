...
void main() {
	...
	if ((int1 == 1001)) {
		if (GetGlobalBoolean("STA_SITH_RUN")) {
			object oPC = GetFirstPC();
			if (((!GetIsInCombat(OBJECT_SELF)) && (GetDistanceToObject(oPC) > 10.0))) {
				ClearAllActions();
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == intGLOB_138)) {
												...
												if ((int1 == 451)) {
													effect effect1 = EffectDamageForcePoints(GetMaxForcePoints(OBJECT_SELF));
													ApplyEffectToObject(0, effect1, OBJECT_SELF, 0.0);
												}
											}
										}
									}
