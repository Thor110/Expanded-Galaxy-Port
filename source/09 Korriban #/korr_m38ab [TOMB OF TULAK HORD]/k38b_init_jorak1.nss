...
void main() {
	...
	if (((GetEnteringObject() == oNPC) && (sub1() == 0))) {
		sub3(object3, location1);
		sub3(object7, location3);
		object oKor38b_mekel = GetObjectByTag("kor38b_mekel", 0);
		AssignCommand(oKor38b_mekel, PlayAnimation(116, 1.0, 5.0));
		AssignCommand(oNPC, PlayAnimation(116, 1.0, 5.0));
		sub4("kor38b_jorakuln", "", OBJECT_INVALID);
		sub6(1);
	}
}
