...
void main() {
	...
	object oKor36_endsith1 = GetObjectByTag("kor36_endsith1", 0);
	if (((GetIsObjectValid(oKor36_endsith1) && (!sub1())) && (GetEnteringObject() == oNPC))) {
		sub3(1);
		sub5("kor36_endsith1", "", OBJECT_INVALID);
	}
}
