...
int sub2() {
	return GetGlobalNumber("KOR39_SITH_HOSTILE");
}
			...
			if ((int1 == 1003)) {
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							if ((((GetMinOneHP(OBJECT_SELF) == 1) && (GetCurrentHitPoints(OBJECT_SELF) <= 10)) && (GetStandardFaction(OBJECT_SELF) == 1))) {
								sub1("YUTHURA SURRENDERING", 5, 5, 4.0);
								SetGlobalBoolean("KOR_YUTH_YIELD", 1);
								SurrenderToEnemies();
								DelayCommand(0.4, SurrenderToEnemies());
								NoClicksFor(0.8);
								DelayCommand(0.6, ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", ""));
							}
						}
						else {
							if ((int1 == 1007)) {
								SetGlobalNumber("KOR_START_FINAL", 3);
								object oKor39_utharwynn = GetObjectByTag("kor39_utharwynn", 0);
								if ((sub2() == 1)) {
									if ((!GetIsDead(oKor39_utharwynn))) {
										object oPC = GetFirstPC();
										CancelCombat(oKor39_utharwynn);
										sub3("kor39_utharwynn", "", OBJECT_INVALID);
									}
								}
								else {
									if (((sub2() == 3) && GetIsDead(oKor39_utharwynn))) {
										...
										if ((sub2() == 4)) {
											object object12 = GetObjectByTag("kor39_kor36", 0);
											SetLocked(object12, 0);
											object object14 = GetObjectByTag("kor39_dooracid", 0);
											SetLocked(object14, 0);
											object object16 = GetObjectByTag("k39_door_starmap", 0);
											SetLocked(object16, 0);
											sub5(6);
										}
									}
								}
								if (((GetGlobalNumber("KOR_FINAL_TEST") == 4) && GetIsDead(oKor39_utharwynn))) {
									object object18 = GetObjectByTag("kor39_kor36", 0);
									SetLocked(object18, 0);
									object object20 = GetObjectByTag("kor39_dooracid", 0);
									SetLocked(object20, 0);
									object object22 = GetObjectByTag("k39_door_starmap", 0);
									SetLocked(object22, 0);
								}
							}
							else {
								if ((int1 == 1008)) {
