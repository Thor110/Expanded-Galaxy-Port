...
void main() {
	...
	sub1(oPC);
	CreateItemOnObject("G_I_DRDUTLDEV004", oPC, 1);
	CreateItemOnObject("G_I_DRDUTLDEV007", oPC, 1);
	CreateItemOnObject("G_I_DRDUTLDEV009", oPC, 1);
	CreateItemOnObject("G_I_DRDHVPLAT003", oPC, 1);
	SetGlobalNumber("KOR_ROGUE_DROID", 1);
	...
	object oK38a_way_exit = GetObjectByTag("k38a_way_exit", 0);
	ActionOpenDoor(oK38a_door_locked);
	ActionMoveToObject(oK38a_way_exit, 1, 1.0);
