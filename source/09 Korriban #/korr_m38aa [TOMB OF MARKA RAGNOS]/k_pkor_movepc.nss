...
void main() {
	...
	object oK38a_way_party1 = GetObjectByTag("k38a_way_party1", 0);
	object oK38a_way_party2 = GetObjectByTag("k38a_way_party2", 0);
	object oPC = GetFirstPC();
	object oK38a_way_player = GetObjectByTag("k38a_way_player", 0);
	ActionPauseConversation();
	DelayCommand(0.5, sub1(oK38a_way_player, oK38a_way_party1, oK38a_way_party2));
	ActionWait(1.5);
