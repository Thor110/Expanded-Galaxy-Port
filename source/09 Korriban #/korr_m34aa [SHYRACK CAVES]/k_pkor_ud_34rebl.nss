				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								int int3 = (GetGlobalNumber("KOR_RENSITH_DEAD") + 1);
								SetGlobalNumber("KOR_RENSITH_DEAD", int3);
								if ((int3 >= 3)) {
									SetGlobalNumber("KOR_RENEGADE_DEAL", 2);
									AddJournalQuestEntry("kor35_renegadesith", 30, 0);
									GivePlotXP("kor35_renegadesith", 75);
								}
							}
							else {
								if ((int1 == 1008)) {
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 34)) {
												...
												if ((int1 == 134)) {
													object object3 = GetItemPossessedBy(OBJECT_SELF, "G_W_BLSTRPSTL001");
													if (GetIsObjectValid(object3)) {
														ClearAllActions();
													...
													if (GetIsObjectValid(object7)) {
														DelayCommand(0.5, sub2(object7));
													}
													else {
														DelayCommand(0.5, sub2(oNPC));
													}
												}
											}
										}
