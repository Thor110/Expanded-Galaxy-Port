...
void main() {
	...
	if (((GetTag(object3) == "tat17_sandperdis") && GetIsObjectValid(GetItemPossessedBy(oPC, "tat17_sandperdis")))) {
		AddJournalQuestEntry("tat17ag_sandbounty", 40, 0);
	}
	if (((GetGlobalBoolean("tat_TuskenMad") == 1) || (GetGlobalBoolean("tat_TuskenJob") == 1))) {
		sub1();
	}
}
