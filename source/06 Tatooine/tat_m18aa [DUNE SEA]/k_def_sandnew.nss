...
// Prototypes
void sub12(string stringParam1, int intParam2, int intParam3, float floatParam4);
...
void main() {
	...
	object object1 = GetObjectByTag(("Ambush_0" + IntToString(nGlobal)), 0);
	sub12("working", 5, 8, 3.0);
	sub12(GetTag(object1), 5, 10, 3.0);
	ClearAllActions();
	DelayCommand(1.0, ActionForceMoveToObject(object1, 1, 3.0, 30.0));
}
