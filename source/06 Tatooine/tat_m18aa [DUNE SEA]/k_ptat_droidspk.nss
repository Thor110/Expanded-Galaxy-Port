...
// Globals
	...
	int intGLOB_147 = 2;
	int intGLOB_148 = 3;
	int intGLOB_149 = 2600;
	int intGLOB_150 = 2470;
	int intGLOB_151 = 2350;
	string stringGLOB_1 = "DECOMP_REPLACE";

// Prototypes
void sub83(string stringParam1, int intParam2, int intParam3, float floatParam4);
void sub82();
int sub81(int intParam1, int intParam2);
void sub80();
void sub79(string stringParam1);
int sub78(object objectParam1);
void sub77();
int sub76();
int sub75();
object sub74(object objectParam1);
int sub73(object objectParam1);
int sub72(object objectParam1);
talent sub71(object objectParam1, talent talentParam2);
int sub70(int intParam1);
...
int sub57();
int sub56();
talent sub55(int intParam1);
string sub54(int intParam1);
int sub53();
int sub52();
int sub51();
int sub50();
...
int sub42();
int sub41();
int sub40(int intParam1);
int sub39(int intParam1);
talent sub38(int intParam1);
object sub37();
int sub36(object objectParam1);
talent sub35(object objectParam1, talent talentParam2);
talent sub34(object objectParam1, talent talentParam2);
int sub33();
object sub32();
int sub31();
talent sub30(int intParam1);
talent sub29(int intParam1);
talent sub28(int intParam1);
talent sub27(int intParam1, int intParam2);
int sub26(object objectParam1, float floatParam2);
int sub25(object objectParam1, float floatParam2);
object sub24();
int sub23();
int sub22(object objectParam1);
int sub21();
object sub20(int intParam1);
int sub19(int intParam1, object objectParam2);
object sub18();
int sub17(object objectParam1);
int sub16();
int sub15();
void sub14(int intParam1, int intParam2);
string sub13(int intParam1);
int sub12();
string sub11(object objectParam1);
void sub10();
void sub9(object objectParam1);
string sub8(object objectParam1);
void sub7(string stringParam1);
void sub6(object objectParam1, int intParam2, object oTarget);
void sub5(string stringParam1);
void sub4(object objectParam1, int intParam2, int intParam3);
void sub3(int intParam1, object objectParam2);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub14(intGLOB_73, 1));
					}
					else {
	...
	if ((!sub1(intGLOB_82))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub1(intGLOB_79)) {
				...
				if (((nLocal < int4) && (!sub1(intGLOB_79)))) {
					int16 = sub81(int4, nLocal);
					nLocal = (nLocal + int16);
				}
				else {
					if ((nLocal == int4)) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub1(intGLOB_80), 2.5, float3);
			if (sub1(intGLOB_73)) {
				ActionDoCommand(sub82());
			}
			SetLocalNumber(OBJECT_SELF, intGLOB_70, nLocal);
			if ((string2 != "UNKNOWN")) {
				ActionDoCommand(sub80());
			}
		}
	}
}
...
int sub78(object objectParam1) {
	...
	sub79(("Walk Initiate for " + GetTag(objectParam1)));
	sub79(("TAG WAY FOUND = " + IntToString(GetIsObjectValid(oWP))));
	sub79(("WAY POINT NAME = " + GetTag(oWP)));
	sub79(("SERIES INT = " + IntToString(nLocal)));
	sub79(("SERIES WAY FOUND = " + IntToString(GetIsObjectValid(object3))));
	sub79(("SERIES Series Tag = " + string8));
	sub79("");
...
int sub76() {
	sub5("GENERIC DEBUG *************** Start Commoner AI");
	...
	if (GetIsObjectValid(oNearest)) {
		sub5("GENERIC DEBUG *************** Clear 2710");
		ClearAllActions();
		ActionMoveAwayFromObject(oNearest, 1, 20.0);
		DelayCommand(0.2, ActionDoCommand(sub77()));
		return 1;
	}
	else {
		if (GetIsObjectValid(object3)) {
			sub5(("GENERIC DEBUG *************** Object Flee = " + sub8(object3)));
			sub5("GENERIC DEBUG *************** Clear 2720");
			ClearAllActions();
...
int sub75() {
	sub5(("GENERIC DEBUG *************** Post DCR Checks for " + sub8(OBJECT_SELF)));
	if ((sub1(intGLOB_128) && (!sub1(intGLOB_129)))) {
		if (sub76()) {
			return 1;
		}
	}
		...
		if (sub1(intGLOB_129)) {
			sub5("GENERIC DEBUG *************** Clear 1000");
			ClearAllActions();
			return 1;
		}
	}
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub78(OBJECT_SELF) == 1))) {
		sub5("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
		DelayCommand(1.0, sub80());
		return 1;
	}
	else {
		if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetIsObjectValid(GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF)))) && IsObjectPartyMember(OBJECT_SELF))) {
			if ((!GetSoloMode())) {
				sub83("NO TARGET: FOLLOW LEADER", 10, 10, 4.0);
				CancelCombat(OBJECT_SELF);
				sub5("GENERIC DEBUG *************** Clear 1200");
				ClearAllActions();
				ActionFollowLeader();
			}
			return 1;
...
object sub74(object objectParam1) {
	sub5("GENERIC DEBUG *************** Starting: Determine Attack Target");
	int nStyle = GetPartyAIStyle();
	int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
	object object1;
	object oLastTarget = GetLastHostileTarget(OBJECT_SELF);
	sub5(((("GENERIC DEBUG *************** Intruder = " + IntToString(GetIsObjectValid(objectParam1))) + " Last Target = ") + IntToString(GetIsObjectValid(oLastTarget))));
	if (((GetIsObjectValid(objectParam1) && (!GetIsDead(objectParam1))) && (!GetIsDebilitated(objectParam1)))) {
		sub5(("GENERIC DEBUG *************** Intruder Target Returned = " + ObjectToString(objectParam1)));
		return objectParam1;
	}
	else {
		if (((GetIsObjectValid(oLastTarget) && (!GetIsDead(oLastTarget))) && (!GetIsDebilitated(oLastTarget)))) {
			sub5(("GENERIC DEBUG *************** Last Target Returned = " + ObjectToString(objectParam1)));
			return oLastTarget;
		}
		else {
			if ((nStyle == 0)) {
				int int13 = 1;
				sub5("GENERIC DEBUG *************** Getting nearest target - 249");
				...
				if ((nStyle == 1)) {
					...
					if (GetIsObjectValid(oLastActor)) {
						sub5("GENERIC DEBUG *************** Getting nearest target - 262");
						...
						if (GetIsObjectValid(oLastActor)) {
							sub5("GENERIC DEBUG *************** Getting nearest target - 269");
							object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
						}
					}
				}
					...
					if ((nStyle != 2)) {
						sub5("GENERIC DEBUG *************** Getting nearest target - 275");
						object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
					}
					else {
						sub5("GENERIC DEBUG *************** Getting nearest target - 279");
						object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
					}
				}
			}
	...
	if (GetIsObjectValid(object1)) {
		sub5(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub8(object1)));
		return object1;
	}
	sub5("GENERIC DEBUG *************** No Attack Targets Found");
	return OBJECT_INVALID;
}

int sub73(object objectParam1) {
	object object1 = sub37();
	talent talent1;
	object object3;
	if ((GetRacialType(OBJECT_SELF) == 5)) {
		return sub36(OBJECT_INVALID);
	}
	if (sub19(intGLOB_144, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub19(intGLOB_142, object1)) {
			return 1;
		}
	}
	object object4 = sub18();
	if (GetIsObjectValid(object4)) {
		if (sub19(intGLOB_143, object4)) {
			return 1;
		}
	}
	object3 = sub32();
	sub5(("GENERIC DEBUG *************** Jedi Support AI: AOE Target = " + sub13(GetIsObjectValid(object3))));
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub27(intGLOB_29, 1);
		}
		else {
			talent1 = sub27(intGLOB_29, 0);
		}
	}
	else {
		sub5("GENERIC DEBUG *************** Jedi Support AI: Inside the Party AI Section");
		object3 = sub74(OBJECT_INVALID);
		sub5(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub8(object3)));
		if (GetIsObjectValid(object3)) {
			sub5(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub8(object3)));
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub27(intGLOB_30, 1);
			}
			else {
				talent1 = sub27(intGLOB_30, 0);
			}
		}
	}
	talent1 = sub34(object3, talent1);
	talent1 = sub35(object3, talent1);
	if ((GetIsObjectValid(object3) && GetIsTalentValid(talent1))) {
		sub5("GENERIC DEBUG *************** Clear 1450");
		ClearAllActions();
		ActionUseTalentOnObject(talent1, object3);
		return 1;
	}
	sub5("GENERIC DEBUG *************** Jedi Support AI: Fall Through");
	return sub36(OBJECT_INVALID);
}
...
talent sub71(object objectParam1, talent talentParam2) {
	int int1;
	sub5("GENERIC DEBUG *************** Starting Droid Talent Double Check");
	if ((GetTypeFromTalent(talentParam2) == 0)) {
		sub5("GENERIC DEBUG *************** Droid Talent is a Spell");
...
int sub70(int intParam1) {
	int int1;
	int nRandom = d4(1);
	if ((sub22(OBJECT_SELF) != 0)) {
		while ((int1 == 0)) {
			if ((sub22(OBJECT_SELF) == 1)) {
				if ((nRandom == 1)) {
					nRandom = intGLOB_44;
				}
				else {
																...
																if ((intParam1 == intGLOB_44)) {
																	...
																	if ((intParam1 == intGLOB_45)) {
																		...
																		if (((intParam1 == intGLOB_46) || (intParam1 == intGLOB_42))) {
																			sub5("GENERIC DEBUG *************** Melee/Ranged Breather");
																		}
																		else {
				...
				if ((intParam1 == intGLOB_46)) {
					...
					if ((intParam1 == intGLOB_47)) {
						...
						if ((intParam1 == intGLOB_48)) {
							...
							if ((intParam1 == intGLOB_49)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub41())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_50)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub41())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_51)) {
										...
										if ((intParam1 == intGLOB_52)) {
											...
											if ((intParam1 == intGLOB_53)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub45() && sub46()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_54)) {
													...
													if ((intParam1 == intGLOB_55)) {
														...
														if ((intParam1 == intGLOB_56)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub43() && sub49()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_57)) {
																if (((sub49() && sub42()) && sub50())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_58)) {
																	if (((sub47() && sub42()) && sub44())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_59)) {
																		if (((sub48() && sub42()) && sub44())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_59)) {
																			if (((sub43() && sub51()) && sub42())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_61)) {
																				talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																				if ((sub51() && GetIsTalentValid(talRandom))) {
																					return 1;
																				}
																			}
																			else {
																				if ((intParam1 == intGLOB_62)) {
																					if (((sub51() && sub42()) && sub50())) {
																						return 1;
																					}
																				}
																				else {
																					if ((intParam1 == intGLOB_63)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if ((sub42() && GetIsTalentValid(talRandom))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_64)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub42() && sub49()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_65)) {
																								talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																								if (((sub51() && sub52()) && GetIsTalentValid(talRandom))) {
																									return 1;
																								}
																							}
																							else {
																								if (((intParam1 == intGLOB_66) || (intParam1 == intGLOB_67))) {
																									...
																									sub5(((("GENERIC DEBUG *************** Droid Items = " + sub8(oLArmItem)) + " / ") + sub8(oRArmItem)));
																									if (sub53()) {
																										sub5("GENERIC DEBUG *************** Droid Utility Check is TRUE");
																										return 1;
																									}
																									sub5("GENERIC DEBUG *************** Droid Utility Check is FALSE");
																								}
																							}
																						}
																					}
...
talent sub38(int intParam1) {
	...
	talent talent1;
	int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
	sub5("GENERIC DEBUG *************** Starting GetComboMove");
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				int2 = sub39(intParam1);
				sub5(("GENERIC DEBUG *************** Starting Jedi Combo " + sub54(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub5(("GENERIC DEBUG *************** Starting Droid Combo " + sub54(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub55(int2);
				}
				else {
					int2 = sub70(intParam1);
					sub5(("GENERIC DEBUG *************** Starting NPC Combo " + sub54(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_35, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_34, int2);
					return sub55(int2);
				}
		...
		sub5(("GENERIC DEBUG *************** Continuing Combo " + sub54(structGLOB_1.int15)));
		return sub55(structGLOB_1.int15);
	}
	return talent1;
}

object sub37() {
	sub5("GENERIC DEBUG *************** Starting Poison Check");
	effect efNext;
	...
	sub5("GENERIC DEBUG ***************  Returning Invalid Poison Object");
	return OBJECT_INVALID;
}
...
int sub36(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub19(intGLOB_142, oNPC)) {
			return 1;
		}
	}
	oNPC = sub18();
	if (GetIsObjectValid(oNPC)) {
		if (sub19(intGLOB_143, oNPC)) {
			return 1;
		}
	}
	talent1 = sub38(0);
	...
	if ((nLocalBool == 1)) {
		...
		sub5("GENERIC DEBUG *************** Default AI Debug Start *************************");
		sub5(("GENERIC DEBUG *************** Intruder    = " + sub8(objectParam1)));
		sub5(("GENERIC DEBUG *************** Last Target = " + sub8(oNPC)));
		sub5(("GENERIC DEBUG *************** Closest     = " + sub8(oNearest)));
		if ((((IsObjectPartyMember(OBJECT_SELF) && GetIsObjectValid(oNPC)) && (!GetIsDead(oNPC))) && GetObjectSeen(oNPC, OBJECT_SELF))) {
			...
			if ((GetIsObjectValid(objectParam1) && GetObjectSeen(objectParam1, OBJECT_SELF))) {
				sub5("GENERIC DEBUG *************** Intruder becomes Target");
				oNPC = objectParam1;
			}
			else {
				if ((GetIsObjectValid(oNearest) && GetObjectSeen(oNearest, OBJECT_SELF))) {
					if (((((!GetIsObjectValid(oNPC)) || (!GetIsEnemy(oNPC, OBJECT_SELF))) || GetIsDead(oNPC)) || (GetCurrentHitPoints(oNPC) < GetCurrentHitPoints(oNearest)))) {
						sub5("GENERIC DEBUG *************** Closest becomes Target");
						oNPC = oNearest;
					}
				}
			}
	...
	if ((GetRacialType(OBJECT_SELF) == 5)) {
		talent1 = sub71(oNPC, talent1);
	}
	talent1 = sub34(oNPC, talent1);
	talent1 = sub35(oNPC, talent1);
	sub5("GENERIC DEBUG *************** Default AI Debug End ***************************");
	sub5(((("GENERIC DEBUG *************** Target = " + sub8(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	if (GetIsObjectValid(oNPC)) {
		sub5("GENERIC DEBUG *************** Clear 1300");
		ClearAllActions();
		if (sub21()) {
			sub5("GENERIC DEBUG *************** Switching Weapons");
		}
		if ((GetIsTalentValid(talent1) && GetIsEnemy(oNPC, OBJECT_SELF))) {
			sub5("GENERIC DEBUG *************** Using Talent on Target");
			ActionUseTalentOnObject(talent1, oNPC);
			return 1;
		}
		else {
			if (GetIsEnemy(oNPC, OBJECT_SELF)) {
				sub5("GENERIC DEBUG *************** Action Attack by Default");
				ActionAttack(oNPC, 0);
				return 1;
			}
		}
	}
	sub5("GENERIC DEBUG *************** Default AI has failed to do an action");
	return 0;
}
...
talent sub34(object objectParam1, talent talentParam2) {
	...
	if ((GetTypeFromTalent(talentParam2) == 0)) {
		if (((GetIdFromTalent(talentParam2) == 49) || (GetIdFromTalent(talentParam2) == 4))) {
			sub5(("GENERIC DEBUG *************** Lightsaber Throw Check = " + FloatToString(GetDistanceBetween(OBJECT_SELF, objectParam1), 4, 2)));
...
int sub33() {
	sub5("GENERIC DEBUG *************** Boss AI: Start Targeted Action Routine");
	talent talent1;
	object object1;
	int int1;
	int nRandom = d6(1);
	...
	sub5((("GENERIC DEBUG *************** Boss AI: Get the #" + sub13(nRandom)) + " target"));
	object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, int4, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
	sub5(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub8(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub5(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub8(oNearest)) + " nCnt = ") + sub13(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub5(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub8(oNearest)));
			object1 = oNearest;
		}
		(int4++);
	...
	if ((int7 == 1)) {
		if (GetIsTalentValid(talent1)) {
			if ((GetTypeFromTalent(talent1) == 1)) {
				sub5(("GENERIC DEBUG *************** Boss AI: Talent Feat = " + sub13(GetIdFromTalent(talent1))));
			}
			else {
				if ((GetTypeFromTalent(talent1) == 0)) {
					sub5(("GENERIC DEBUG *************** Boss AI: Talent Power = " + sub13(GetIdFromTalent(talent1))));
				}
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			sub5("GENERIC DEBUG *************** Boss AI: Get Boss Combat Move AI Droid");
			int1 = 1;
		}
		talent1 = sub27(intGLOB_30, int1);
		talent1 = sub34(object1, talent1);
		talent1 = sub35(object1, talent1);
		sub5(("GENERIC DEBUG *************** Boss AI: Target = " + sub13(GetIsObjectValid(object1))));
		sub5(("GENERIC DEBUG *************** Boss AI: Talent = " + sub13(GetIsTalentValid(talent1))));
		if ((GetIsTalentValid(talent1) && GetIsObjectValid(object1))) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub5("GENERIC DEBUG *************** Boss AI: Targeted Power Success");
			return 1;
		}
	}
	sub5("GENERIC DEBUG *************** Boss AI: Targeted Failure");
	return 0;
}
...
int sub31() {
	sub5("GENERIC DEBUG *************** Boss AI: AOE Function Starting");
	talent talent1;
	object object1 = sub32();
	sub5(("GENERIC DEBUG *************** Boss AI: AOE Target = " + sub13(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub27(intGLOB_29, int2);
		if (GetIsTalentValid(talent1)) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub5("GENERIC DEBUG *************** Boss AI: AOE Success");
			return 1;
		}
	}
	sub5("GENERIC DEBUG *************** Boss AI: AOE Failure");
	return 0;
}
...
talent sub29(int intParam1) {
	...
	sub5(("GENERIC DEBUG *************** Last Force Power Used = " + sub13(nLastForce)));
	...
	sub5(("GENERIC DEBUG *************** Force Power Returned = " + sub13(GetIdFromTalent(talent1))));
	return talent1;
}
...
talent sub28(int intParam1) {
	...
	sub5("GENERIC DEBUG *************** Grenade Selection Failure");
	talent talent11;
	return talent11;
	return talent11;
}
...
talent sub27(int intParam1, int intParam2) {
	...
	if (((intParam1 == intGLOB_28) || (intParam1 == intGLOB_32))) {
		...
		if (GetIsTalentValid(talRandom)) {
			sub5("GENERIC DEBUG *************** Boss AI: Grenade Talent Chosen");
			return talRandom;
		}
	}
	if (((intParam1 == intGLOB_29) || (intParam1 == intGLOB_32))) {
		...
		if (GetIsTalentValid(talRandom)) {
			sub5("GENERIC DEBUG *************** Boss AI: AOE Force Power Talent Chosen");
			return talRandom;
		}
	}
	if (((intParam1 == intGLOB_30) || (intParam1 == intGLOB_32))) {
		if ((d100(1) > 50)) {
			talRandom = sub30(intParam2);
			if (GetIsTalentValid(talRandom)) {
				sub5("GENERIC DEBUG *************** Boss AI: Targeted Force Power Talent Chosen");
				return talRandom;
			}
			talRandom = sub29(intParam2);
			if (GetIsTalentValid(talRandom)) {
		...
		if ((sub22(OBJECT_SELF) == 1)) {
			sub5("GENERIC DEBUG *************** Boss AI: Melee Feat Talent Chosen");
			talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
		}
		else {
			sub5("GENERIC DEBUG *************** Boss AI: Range Feat Talent Chosen");
		...
		if (((intParam1 == intGLOB_31) || (intParam1 == intGLOB_32))) {
			...
			sub5("GENERIC DEBUG *************** Boss AI: No Feats Available");
		}
	}
	return talRandom;
}
...
object sub24() {
	...
	while (GetIsObjectValid(oShapeObject)) {
		if ((GetObjectSeen(oShapeObject, OBJECT_SELF) && (!GetIsDead(oShapeObject)))) {
			int3 = sub25(oShapeObject, 4.0);
			int4 = sub26(oShapeObject, 4.0);
...
int sub23() {
	sub5("GENERIC DEBUG *************** Boss AI: Grenade Function Starting");
	talent talent1;
	object object1 = sub24();
	sub5(("GENERIC DEBUG *************** Boss AI: Grenade Target = " + sub13(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub27(intGLOB_28, int2);
		if (GetIsTalentValid(talent1)) {
			sub5("GENERIC DEBUG *************** Clear 1460");
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub5("GENERIC DEBUG *************** Boss AI: AOE Success");
			return 1;
...
int sub22(object objectParam1) {
	...
	sub5("GENERIC DEBUG *************** Return No Weapon Type");
	return 0;
}

int sub21() {
	object oInvItem;
	if (((((GetIsObjectValid(GetAttackTarget(OBJECT_SELF)) && (GetDistanceBetween(GetAttackTarget(OBJECT_SELF), OBJECT_SELF) <= 3.0)) && (sub22(OBJECT_SELF) != 1)) && (GetRacialType(OBJECT_SELF) == 6)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		oInvItem = GetFirstItemInInventory(OBJECT_SELF);
		while (GetIsObjectValid(oInvItem)) {
			sub5("GENERIC DEBUG *************** Checking Melee Weapon");
			if (((((((((((((((GetBaseItemType(oInvItem) == 9) || (GetBaseItemType(oInvItem) == 6)) || (GetBaseItemType(oInvItem) == 80)) || (GetBaseItemType(oInvItem) == 78)) || (GetBaseItemType(oInvItem) == 8)) || (GetBaseItemType(oInvItem) == 2)) || (GetBaseItemType(oInvItem) == 0)) || (GetBaseItemType(oInvItem) == 10)) || (GetBaseItemType(oInvItem) == 4)) || (GetBaseItemType(oInvItem) == 1)) || (GetBaseItemType(oInvItem) == 5)) || (GetBaseItemType(oInvItem) == 7)) || (GetBaseItemType(oInvItem) == 3)) || (GetBaseItemType(oInvItem) == 79))) {
				sub5("GENERIC DEBUG *************** Equipping Melee Weapon");
		...
		if (((((((sub22(OBJECT_SELF) != 2) && (GetLevelByClass(4, OBJECT_SELF) == 0)) && (GetLevelByClass(3, OBJECT_SELF) == 0)) && (GetLevelByClass(5, OBJECT_SELF) == 0)) && (GetDistanceBetween(GetAttemptedAttackTarget(), OBJECT_SELF) > 3.0)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
			oInvItem = GetFirstItemInInventory(OBJECT_SELF);
			while (GetIsObjectValid(oInvItem)) {
				sub5("GENERIC DEBUG *************** Checking Ranged Weapon");
				if ((((((((((((((((GetBaseItemType(oInvItem) == 20) || (GetBaseItemType(oInvItem) == 12)) || (GetBaseItemType(oInvItem) == 77)) || (GetBaseItemType(oInvItem) == 19)) || (GetBaseItemType(oInvItem) == 16)) || (GetBaseItemType(oInvItem) == 21)) || (GetBaseItemType(oInvItem) == 13)) || (GetBaseItemType(oInvItem) == 24)) || (GetBaseItemType(oInvItem) == 14)) || (GetBaseItemType(oInvItem) == 15)) || (GetBaseItemType(oInvItem) == 18)) || (GetBaseItemType(oInvItem) == 23)) || (GetBaseItemType(oInvItem) == 17)) || (GetBaseItemType(oInvItem) == 22)) || (GetBaseItemType(oInvItem) == 17))) {
					sub5("GENERIC DEBUG *************** Equipping Ranged Weapon");
	...
	sub5("GENERIC DEBUG *************** Should not currently change weapons");
	return 0;
}
...
object sub20(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		sub5("GENERIC DEBUG *************** Searching for Alternate Target");
		oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0, 6, 0xFFFFFFFF, 0xFFFFFFFF);
		sub5(("GENERIC DEBUG *************** Alternate Target = " + sub8(oNearest)));
	}
	sub5(("GENERIC DEBUG *************** Heal Drain Target = " + sub13(intParam1)));
	sub5(("GENERIC DEBUG *************** Get Active Party Member: " + sub8(oNearest)));
	return oNearest;
}
...
int sub19(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_141)) {
			...
			if ((intParam1 == intGLOB_142)) {
				...
				if ((intParam1 == intGLOB_143)) {
					sub5(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub8(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
					if ((GetRacialType(OBJECT_SELF) != 5)) {
					...
					int3 = 0;
					if ((GetCreatureHasTalent(talSpell, OBJECT_SELF) || GetCreatureHasTalent(talent2, OBJECT_SELF))) {
						sub5("GENERIC DEBUG *************** I have Heal or Cure");
						int3 = 1;
						if (GetCreatureHasTalent(talSpell, OBJECT_SELF)) {
							talent8 = talSpell;
						}
						...
						if (((GetIsTalentValid(talBest) || GetCreatureHasTalent(talent6, OBJECT_SELF)) || GetCreatureHasTalent(talent7, OBJECT_SELF))) {
							if ((objectParam2 == OBJECT_SELF)) {
								if ((GetCreatureHasTalent(talent7, OBJECT_SELF) && (!IsObjectPartyMember(OBJECT_SELF)))) {
									sub5("GENERIC DEBUG *************** I have Death Field");
									int3 = 1;
									int4 = 1;
									talent8 = talent7;
								}
									...
									if ((GetCreatureHasTalent(talent6, OBJECT_SELF) && (!IsObjectPartyMember(OBJECT_SELF)))) {
										sub5("GENERIC DEBUG *************** I have Drain Life");
										int3 = 1;
										int4 = 1;
										talent8 = talent6;
									}
									else {
										sub5("GENERIC DEBUG *************** I have a Med Pack");
										int3 = 1;
										talent8 = talBest;
									}
								}
					...
					if ((intParam1 == intGLOB_144)) {
						...
						if (((((!GetHasSpellEffect(36, OBJECT_SELF)) && (!GetHasSpellEffect(33, OBJECT_SELF))) && (!GetHasSpellEffect(22, OBJECT_SELF))) && (int3 == 1))) {
							sub5("GENERIC DEBUG *************** I do have VALOR");
							int3 = 1;
						}
						else {
							sub5("GENERIC DEBUG *************** I do not have VALOR");
							int3 = 0;
						}
					}
				}
		...
		if (((int3 == 1) && (int4 == 0))) {
			sub5("GENERIC DEBUG *************** Clear 2300");
			int nTalent = GetIdFromTalent(talent8);
			sub5(("GENERIC DEBUG *************** Spells.2DA ID = " + sub13(nTalent)));
			ClearAllActions();
			...
			if (((int3 == 1) && (int4 == 1))) {
				objectParam2 = sub20(1);
				if (GetIsObjectValid(objectParam2)) {
					sub5(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub8(objectParam2)));
					sub5("GENERIC DEBUG *************** Clear 2400");
					ClearAllActions();
		...
		if ((GetIsTalentValid(talent8) && (!GetHasSpellEffect(GetIdFromTalent(talent8), OBJECT_SELF)))) {
			if (GetIsObjectValid(objectParam2)) {
				sub5("GENERIC DEBUG *************** Clear 2500");
				ClearAllActions();
				sub5(((("GENERIC DEBUG *************** Target = " + GetName(objectParam2)) + " Talent Code = ") + IntToString(int2)));
				ActionUseTalentOnObject(talent8, OBJECT_SELF);
				return 1;
			}
		}
	}
	sub5(((((("GENERIC DEBUG *************** " + sub8(OBJECT_SELF)) + " VP = ") + sub13(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub13(GetMaxHitPoints(OBJECT_SELF))));
	sub5("GENERIC DEBUG *************** Healing Not Used");
	return 0;
}

object sub18() {
	sub5("GENERIC DEBUG ***************  Starting Injury Check Function");
...
int sub17(object objectParam1) {
	sub5("GENERIC DEBUG *************** Boss AI Start");
	object object1 = sub18();
	if (GetIsObjectValid(object1)) {
		if (sub19(intGLOB_143, object1)) {
			return 1;
		}
	}
	if (sub21()) {
	...
	sub5("GENERIC DEBUG *************** Boss AI: Fall Through");
	return sub36(OBJECT_INVALID);
}

int sub16() {
	sub5("GENERIC DEBUG *************** Malak AI Start");
	...
	sub5(("GENERIC DEBUG *************** Malak Distance to PC = " + FloatToString(GetDistanceBetween(OBJECT_SELF, oPC), 4, 4)));
	if ((fDistance > 10.0)) {
		int6 = 1;
	}
	if ((int6 == 1)) {
		sub5("GENERIC DEBUG *************** Clear 1480");
		ClearAllActions();
		if (((GetHasSpellEffect(8, oPC) || GetHasSpellEffect(34, oPC)) || GetHasSpellEffect(37, oPC))) {
			...
			if (GetIsTalentValid(talSpell)) {
				sub5("GENERIC DEBUG *************** Using Breach");
			...
			if ((fDistance > 10.0)) {
				...
				if ((int14 != (-1))) {
					...
					if (GetIsTalentValid(talent3)) {
						sub5("GENERIC DEBUG *************** Malak Using Force Power");
	...
	if ((int7 == 1)) {
		sub5("GENERIC DEBUG *************** Malak Attacking");
		ActionAttack(oPC, 0);
		return 1;
	}
	sub5("GENERIC DEBUG *************** Malak AI Drop Out");
	return 0;
}

int sub15() {
	int int1 = 0;
	if (((sub1(intGLOB_135) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub1(intGLOB_132))) {
...
int sub12() {
	sub5("GENERIC DEBUG *************** Starting Forcefield Search");
	sub5(((("GENERIC DEBUG *************** Shield Boolean (" + sub13(intGLOB_133)) + ") = ") + sub13(sub1(intGLOB_133))));
	if (((sub1(intGLOB_133) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub9(object objectParam1) {
	sub5("");
	sub5(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub8(OBJECT_SELF)));
	sub10();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub5(("GENERIC DEBUG *************** AI STYLE = " + sub11(OBJECT_SELF)));
		if (((((!sub1(intGLOB_128)) && (!sub1(intGLOB_129))) && (!sub1(intGLOB_130))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub1(intGLOB_138) == 1)) {
					if ((sub16() == 1)) {
						return;
					}
				}
				if ((sub1(intGLOB_132) == 1)) {
					if ((sub17(objectParam1) == 1)) {
						return;
					}
				}
				if ((nNPCStyle == 0)) {
					if ((sub36(objectParam1) == 1)) {
						return;
					}
				}
				else {
		...
		if (sub75()) {
			sub5("GENERIC DEBUG *************** DETERMINE COMBAT ROUND END");
		}
		sub5("GENERIC DEBUG *************** WARNING DETERMINE COMBAT ROUND FAILURE");
	}
}
...
void sub6(object objectParam1, int intParam2, object oTarget) {
	sub7("");
	sub7(("GENERIC SHOUT DEBUG *************** Respond to Shout Started for " + sub8(OBJECT_SELF)));
	sub7(("GENERIC SHOUT DEBUG *************** Intruder Object = " + sub8(oTarget)));
	int int1;
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		if (((((GetLocalNumber(objectParam1, intGLOB_38) == GetLocalNumber(OBJECT_SELF, intGLOB_36)) || (GetLocalNumber(objectParam1, intGLOB_38) == 0)) || (GetLocalNumber(OBJECT_SELF, intGLOB_38) == 0)) || IsObjectPartyMember(OBJECT_SELF))) {
		if (((((!sub1(intGLOB_128)) && (!sub1(intGLOB_129))) && (!sub1(intGLOB_130))) && (!GetUserActionsPending()))) {
			sub7("GENERIC SHOUT DEBUG *************** Check 1 Pass");
			if ((((intParam2 == 1) && GetIsFriend(objectParam1, OBJECT_SELF)) && (objectParam1 != OBJECT_SELF))) {
				if ((((IsObjectPartyMember(OBJECT_SELF) && IsObjectPartyMember(objectParam1)) && (GetSoloMode() == 0)) || (!IsObjectPartyMember(OBJECT_SELF)))) {
					sub7("GENERIC SHOUT DEBUG *************** Check 2 Pass");
					if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
						sub7("GENERIC SHOUT DEBUG *************** Check 3 Pass");
						if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (nStyle != 2)) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
							sub7("GENERIC SHOUT DEBUG *************** Check 3 Pass");
							if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
								sub7("GENERIC SHOUT DEBUG *************** Check 5 Pass");
								sub7(("GENERIC SHOUT DEBUG *************** Intruder = " + sub8(oTarget)));
								if (GetObjectSeen(oTarget, OBJECT_SELF)) {
									sub7("GENERIC SHOUT DEBUG *************** Shout: Determine Combat Round");
									sub5("GENERIC SHOUT DEBUG *************** Shout Clear 1800");
									ClearAllActions();
									sub9(oTarget);
								}
								else {
									if (GetIsObjectValid(oTarget)) {
										sub7("GENERIC SHOUT DEBUG *************** Shout: Move To Intruder");
										sub5("GENERIC SHOUT DEBUG ***************= Shout Clear 1900");
										ClearAllActions();
										float float1 = 5.0;
										if (((GetDistanceBetween(OBJECT_SELF, oTarget) < 20.0) && (!GetObjectSeen(oTarget, OBJECT_SELF)))) {
											ActionMoveToObject(oTarget, 1, 2.0);
										}
										else {
											if ((sub22(OBJECT_SELF) == 1)) {
												ActionMoveToObject(oTarget, 1, 4.0);
											}
											else {
												ActionMoveToObject(oTarget, 1, 15.0);
											}
										}
									}
									else {
										if (IsObjectPartyMember(OBJECT_SELF)) {
											oTarget = GetAttackTarget(objectParam1);
											sub7(("GENERIC SHOUT DEBUG *************** Attack Intruder = " + sub8(oTarget)));
											if (GetIsObjectValid(oTarget)) {
												sub9(oTarget);
											}
											else {
												oTarget = GetSpellTarget(objectParam1);
												sub7(("GENERIC SHOUT DEBUG *************** Spell Intruder = " + sub8(oTarget)));
												if (GetIsObjectValid(oTarget)) {
													sub9(oTarget);
												}
											}
								...
								if ((((intParam2 == 15) && GetIsFriend(objectParam1, OBJECT_SELF)) && (objectParam1 != OBJECT_SELF))) {
									if ((GetCurrentAction(OBJECT_SELF) == 65535)) {
										if (GetObjectSeen(oTarget, OBJECT_SELF)) {
											sub5("GENERIC SHOUT DEBUG *************** Clear 2000");
											ClearAllActions();
											sub7(("GENERIC SHOUT DEBUG *************** Attack Intruder = " + sub8(oTarget)));
											sub9(oTarget);
										}
											...
											if (GetIsObjectValid(oTarget)) {
												sub5("GENERIC SHOUT DEBUG *************** Clear 2100");
												ClearAllActions();
												ActionMoveToObject(oTarget, 1, 5.0);
											}
										}
									}
								}
			...
			if (sub1(intGLOB_129)) {
				sub5("GENERIC SHOUT DEBUG *************** Clear 2200");
				ClearAllActions();
				return;
			}
		}
...
void sub3(int intParam1, object objectParam2) {
	if (((intParam1 == 1) || (intParam1 == 0))) {
		sub4(objectParam2, intGLOB_5, intParam1);
	}
	return;
}
...
void main() {
	int int1 = GetListenPatternNumber();
	if ((!sub1(intGLOB_130))) {
		object oSpeaker = GetLastSpeaker();
		object oNearest;
		object oLastActor = GetLastHostileActor(oSpeaker);
		if ((((!GetIsObjectValid(oLastActor)) || GetIsDead(oLastActor)) || (!GetObjectSeen(oLastActor, oSpeaker)))) {
			if (GetCommandable(OBJECT_SELF)) {
				if ((int1 == (-1))) {
					object oPC = GetFirstPC();
					object oTat18_10tanis_01 = GetObjectByTag("tat18_10tanis_01", 0);
					ClearAllActions();
					AssignCommand(oTat18_10tanis_01, ClearAllActions());
					if ((sub2(oTat18_10tanis_01) == 1)) {
						BeginConversation("", OBJECT_INVALID);
						return;
					}
					else {
						sub3(1, oTat18_10tanis_01);
						AssignCommand(oTat18_10tanis_01, ActionStartConversation(oTat18_10tanis_01, "", 0, 0, 1, "", "", "", "", "", ""));
					}
				}
				else {
					if (((((int1 != (-1)) && GetIsObjectValid(oSpeaker)) && (!GetIsPC(oSpeaker))) && GetIsFriend(oSpeaker, OBJECT_SELF))) {
						if ((int1 >= 1)) {
							oNearest = GetLastHostileActor(oSpeaker);
							if ((!GetIsObjectValid(oNearest))) {
								oNearest = GetAttemptedAttackTarget();
								if ((!GetIsObjectValid(oNearest))) {
									oNearest = GetAttemptedSpellTarget();
									if ((!GetIsObjectValid(oNearest))) {
										oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
										if ((!GetIsObjectValid(oNearest))) {
											sub5("GENERIC DEBUG *************** No Intruder Object For Shout");
											oNearest = OBJECT_INVALID;
										}
									}
								}
	...
	if ((int1 == (-1))) {
		ExecuteScript("k_def_dialbool", OBJECT_SELF, int1);
	}
	if (sub1(intGLOB_107)) {
