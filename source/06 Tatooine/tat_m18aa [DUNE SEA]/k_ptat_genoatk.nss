...
void main() {
	...
	object oTat_senni = GetObjectByTag("tat_senni", 0);
	object oTat_bounty = GetObjectByTag("tat_bounty", 0);
	object oTat_thug1 = GetObjectByTag("tat_thug1", 0);
	object oTat_thug2 = GetObjectByTag("tat_thug2", 0);
	object oTat_thug3 = GetObjectByTag("tat_thug3", 0);
	object oTat_thug4 = GetObjectByTag("tat_thug4", 0);
	object oTat18_aturret_01 = GetObjectByTag("tat18_aturret_01", 0);
	object oTat18_aturret_02 = GetObjectByTag("tat18_aturret_02", 0);
	object object19 = GetObjectByTag("tat18_aturret_02", 1);
	ChangeToStandardFaction(oTat18_aturret_01, 5);
	ChangeToStandardFaction(oTat18_aturret_02, 5);
	ChangeToStandardFaction(object19, 5);
	ChangeToStandardFaction(oHulas, 1);
	ChangeToStandardFaction(oTat_senni, 1);
	ChangeToStandardFaction(oTat_bounty, 1);
	ChangeToStandardFaction(oTat_thug1, 1);
	ChangeToStandardFaction(oTat_thug2, 1);
	ChangeToStandardFaction(oTat_thug3, 1);
	ChangeToStandardFaction(oTat_thug4, 1);
	DelayCommand(0.5, AssignCommand(oTat_senni, sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oTat_bounty, sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oTat_thug1, sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oTat_thug2, sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oTat_thug3, sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oTat_thug4, sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oHulas, sub1(OBJECT_INVALID)));
}
