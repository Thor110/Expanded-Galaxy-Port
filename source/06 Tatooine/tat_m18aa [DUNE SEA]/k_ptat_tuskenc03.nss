...
void main() {
	...
	object object3 = GetNearestObjectByTag("tat18_tusken05", OBJECT_SELF, 2);
	object oNearestTat18_tusken06 = GetNearestObjectByTag("tat18_tusken06", OBJECT_SELF, 1);
	SetDialogPlaceableCamera(10);
	ChangeToStandardFaction(oNearestTat18_tusken05, 1);
	ChangeToStandardFaction(object3, 1);
	ChangeToStandardFaction(oNearestTat18_tusken06, 1);
	AssignCommand(oNearestTat18_tusken05, DelayCommand(2.0, sub1(OBJECT_INVALID)));
	AssignCommand(object3, DelayCommand(2.0, sub1(OBJECT_INVALID)));
	AssignCommand(oNearestTat18_tusken06, DelayCommand(2.0, sub1(OBJECT_INVALID)));
}
