...
void main() {
	...
	ChangeToStandardFaction(oTat18_jagithug01, 1);
	ChangeToStandardFaction(oTat18_jagithug02, 1);
	ChangeToStandardFaction(OBJECT_SELF, 1);
	AssignCommand(oTat18_jagithug01, sub1(OBJECT_INVALID));
	AssignCommand(oTat18_jagithug02, sub1(OBJECT_INVALID));
	ApplyEffectToObject(0, EffectDamage(GetCurrentHitPoints(OBJECT_SELF), 8, 0), OBJECT_SELF, 0.0);
}
