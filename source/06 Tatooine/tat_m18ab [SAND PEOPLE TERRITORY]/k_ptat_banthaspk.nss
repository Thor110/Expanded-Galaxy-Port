...
int sub76() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		if (GetIsObjectValid(object3)) {
			sub6(("GENERIC DEBUG *************** Object Flee = " + sub9(object3)));
...
int sub75() {
	sub6(("GENERIC DEBUG *************** Post DCR Checks for " + sub9(OBJECT_SELF)));
...
object sub74(object objectParam1) {
	...
	if (GetIsObjectValid(object1)) {
		sub6(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub9(object1)));
		return object1;
	}
...
int sub73(object objectParam1) {
	...
	if (sub19(intGLOB_117, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub19(intGLOB_115, object1)) {
			return 1;
		}
	}
	object object4 = sub18();
	if (GetIsObjectValid(object4)) {
		if (sub19(intGLOB_116, object4)) {
			return 1;
		}
	}
	object3 = sub32();
	sub6(("GENERIC DEBUG *************** Jedi Support AI: AOE Target = " + sub14(GetIsObjectValid(object3))));
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub27(intGLOB_2, 1);
		}
		else {
			talent1 = sub27(intGLOB_2, 0);
		}
	}
	else {
		sub6("GENERIC DEBUG *************** Jedi Support AI: Inside the Party AI Section");
		object3 = sub74(OBJECT_INVALID);
		sub6(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub9(object3)));
		if (GetIsObjectValid(object3)) {
			sub6(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub9(object3)));
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub27(intGLOB_3, 1);
			}
			else {
				talent1 = sub27(intGLOB_3, 0);
			}
		}
	}
																						...
																						if ((intParam1 == intGLOB_37)) {
																							...
																							if ((intParam1 == intGLOB_38)) {
																								...
																								if (((intParam1 == intGLOB_39) || (intParam1 == intGLOB_40))) {
																									...
																									sub6(((("GENERIC DEBUG *************** Droid Items = " + sub9(oLArmItem)) + " / ") + sub9(oRArmItem)));
																									if (sub53()) {
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				...
				sub6(("GENERIC DEBUG *************** Starting Jedi Combo " + sub54(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub6(("GENERIC DEBUG *************** Starting Droid Combo " + sub54(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub55(int2);
				}
					...
					sub6(("GENERIC DEBUG *************** Starting NPC Combo " + sub54(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub55(int2);
				}
		...
		sub6(("GENERIC DEBUG *************** Continuing Combo " + sub54(structGLOB_1.int15)));
...
int sub36(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub19(intGLOB_115, oNPC)) {
			return 1;
		}
	}
	oNPC = sub18();
	if (GetIsObjectValid(oNPC)) {
		if (sub19(intGLOB_116, oNPC)) {
			return 1;
		}
	}
	talent1 = sub38(0);
	...
	if ((nLocalBool == 1)) {
		...
		sub6(("GENERIC DEBUG *************** Intruder    = " + sub9(objectParam1)));
		sub6(("GENERIC DEBUG *************** Last Target = " + sub9(oNPC)));
		sub6(("GENERIC DEBUG *************** Closest     = " + sub9(oNearest)));
	...
	sub6(((("GENERIC DEBUG *************** Target = " + sub9(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	if (GetIsObjectValid(oNPC)) {
...
int sub33() {
	...
	sub6((("GENERIC DEBUG *************** Boss AI: Get the #" + sub14(nRandom)) + " target"));
	object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, int4, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
	sub6(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub9(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub6(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub9(oNearest)) + " nCnt = ") + sub14(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub6(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub9(oNearest)));
			object1 = oNearest;
		}
		(int4++);
	...
	if ((int7 == 1)) {
		if (GetIsTalentValid(talent1)) {
			if ((GetTypeFromTalent(talent1) == 1)) {
				sub6(("GENERIC DEBUG *************** Boss AI: Talent Feat = " + sub14(GetIdFromTalent(talent1))));
			}
			else {
				if ((GetTypeFromTalent(talent1) == 0)) {
					sub6(("GENERIC DEBUG *************** Boss AI: Talent Power = " + sub14(GetIdFromTalent(talent1))));
				}
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		...
		talent1 = sub27(intGLOB_3, int1);
		talent1 = sub34(object1, talent1);
		talent1 = sub35(object1, talent1);
		sub6(("GENERIC DEBUG *************** Boss AI: Target = " + sub14(GetIsObjectValid(object1))));
		sub6(("GENERIC DEBUG *************** Boss AI: Talent = " + sub14(GetIsTalentValid(talent1))));
...
int sub31() {
	...
	sub6(("GENERIC DEBUG *************** Boss AI: AOE Target = " + sub14(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub27(intGLOB_2, int2);
		if (GetIsTalentValid(talent1)) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
...
talent sub29(int intParam1) {
	...
	sub6(("GENERIC DEBUG *************** Last Force Power Used = " + sub14(nLastForce)));
	...
	sub6(("GENERIC DEBUG *************** Force Power Returned = " + sub14(GetIdFromTalent(talent1))));
	return talent1;
}
...
int sub23() {
	...
	talent talent1;
	object object1 = sub24();
	sub6(("GENERIC DEBUG *************** Boss AI: Grenade Target = " + sub14(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub27(intGLOB_1, int2);
		if (GetIsTalentValid(talent1)) {
...
object sub20(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		...
		sub6(("GENERIC DEBUG *************** Alternate Target = " + sub9(oNearest)));
	}
	sub6(("GENERIC DEBUG *************** Heal Drain Target = " + sub14(intParam1)));
	sub6(("GENERIC DEBUG *************** Get Active Party Member: " + sub9(oNearest)));
	return oNearest;
}
...
int sub19(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_114)) {
			...
			if ((intParam1 == intGLOB_115)) {
				...
				if ((intParam1 == intGLOB_116)) {
					sub6(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub9(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
					if ((GetRacialType(OBJECT_SELF) != 5)) {
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub6(("GENERIC DEBUG *************** Spells.2DA ID = " + sub14(nTalent)));
			ClearAllActions();
			...
			if (((int3 == 1) && (int4 == 1))) {
				...
				if (GetIsObjectValid(objectParam2)) {
					sub6(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub9(objectParam2)));
	...
	sub6(((((("GENERIC DEBUG *************** " + sub9(OBJECT_SELF)) + " VP = ") + sub14(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub14(GetMaxHitPoints(OBJECT_SELF))));
...
int sub13() {
	...
	sub6(((("GENERIC DEBUG *************** Shield Boolean (" + sub14(intGLOB_106)) + ") = ") + sub14(sub1(intGLOB_106))));
...
void sub10(object objectParam1) {
	sub6("");
	sub6(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub9(OBJECT_SELF)));
	sub11();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub6(("GENERIC DEBUG *************** AI STYLE = " + sub12(OBJECT_SELF)));
...
void sub7(object objectParam1, int intParam2, object oTarget) {
	sub8("");
	sub8(("GENERIC SHOUT DEBUG *************** Respond to Shout Started for " + sub9(OBJECT_SELF)));
	sub8(("GENERIC SHOUT DEBUG *************** Intruder Object = " + sub9(oTarget)));
	int int1;
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		...
		if (((((!sub1(intGLOB_101)) && (!sub1(intGLOB_102))) && (!sub1(intGLOB_103))) && (!GetUserActionsPending()))) {
			sub8("GENERIC SHOUT DEBUG *************** Check 1 Pass");
			if ((((intParam2 == 1) && GetIsFriend(objectParam1, OBJECT_SELF)) && (objectParam1 != OBJECT_SELF))) {
				if ((((IsObjectPartyMember(OBJECT_SELF) && IsObjectPartyMember(objectParam1)) && (GetSoloMode() == 0)) || (!IsObjectPartyMember(OBJECT_SELF)))) {
					sub8("GENERIC SHOUT DEBUG *************** Check 2 Pass");
					if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
						sub8("GENERIC SHOUT DEBUG *************** Check 3 Pass");
						if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (nStyle != 2)) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
							sub8("GENERIC SHOUT DEBUG *************** Check 3 Pass");
							if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
								sub8("GENERIC SHOUT DEBUG *************** Check 5 Pass");
								sub8(("GENERIC SHOUT DEBUG *************** Intruder = " + sub9(oTarget)));
								if (GetObjectSeen(oTarget, OBJECT_SELF)) {
									sub8("GENERIC SHOUT DEBUG *************** Shout: Determine Combat Round");
									sub6("GENERIC SHOUT DEBUG *************** Shout Clear 1800");
									ClearAllActions();
									sub10(oTarget);
								}
								else {
									if (GetIsObjectValid(oTarget)) {
										sub8("GENERIC SHOUT DEBUG *************** Shout: Move To Intruder");
										sub6("GENERIC SHOUT DEBUG ***************= Shout Clear 1900");
										ClearAllActions();
										float float1 = 5.0;
										...
										if (IsObjectPartyMember(OBJECT_SELF)) {
											...
											sub8(("GENERIC SHOUT DEBUG *************** Attack Intruder = " + sub9(oTarget)));
											if (GetIsObjectValid(oTarget)) {
												sub10(oTarget);
											}
											else {
												oTarget = GetSpellTarget(objectParam1);
												sub8(("GENERIC SHOUT DEBUG *************** Spell Intruder = " + sub9(oTarget)));
												if (GetIsObjectValid(oTarget)) {
													sub10(oTarget);
												}
											}
								...
								if ((((intParam2 == 15) && GetIsFriend(objectParam1, OBJECT_SELF)) && (objectParam1 != OBJECT_SELF))) {
									if ((GetCurrentAction(OBJECT_SELF) == 65535)) {
										if (GetObjectSeen(oTarget, OBJECT_SELF)) {
											sub6("GENERIC SHOUT DEBUG *************** Clear 2000");
											ClearAllActions();
											sub8(("GENERIC SHOUT DEBUG *************** Attack Intruder = " + sub9(oTarget)));
											sub10(oTarget);
										}
											...
											if (GetIsObjectValid(oTarget)) {
												sub6("GENERIC SHOUT DEBUG *************** Clear 2100");
												ClearAllActions();
			...
			if (sub1(intGLOB_102)) {
				sub6("GENERIC SHOUT DEBUG *************** Clear 2200");
				ClearAllActions();
				return;
			}
		}
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub4(intGLOB_46, 1));
					}
					else {
							...
							if ((!GetIsObjectValid(oNearest))) {
								...
								if ((!GetIsObjectValid(oNearest))) {
									...
									if ((!GetIsObjectValid(oNearest))) {
										...
										if ((!GetIsObjectValid(oNearest))) {
											sub6("GENERIC DEBUG *************** No Intruder Object For Shout");
											oNearest = OBJECT_INVALID;
										}
									}
								}
