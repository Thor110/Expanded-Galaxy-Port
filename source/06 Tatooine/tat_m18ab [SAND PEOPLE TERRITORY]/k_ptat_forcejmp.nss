...
void main() {
	location location1 = GetLocation(GetObjectByTag("tat_droid_run", 0));
	object oVornsdroid2 = GetObjectByTag("vornsdroid2", 0);
	sub1(GetObjectByTag("tat_pc_run", 0), GetObjectByTag("tat_assoc1_run", 0), GetObjectByTag("tat_assoc2_run", 0));
	AssignCommand(oVornsdroid2, JumpToLocation(location1));
}
