...
void main() {
	...
	unknown unknown1 = EventUserDefined(44);
	if ((int1 == 1001)) {
	}
	else {
		if ((int1 == 1002)) {
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							object oTat_invis_conv1 = GetObjectByTag("tat_invis_conv1", 0);
							if ((((nCurHP <= 40) && (sub1(OBJECT_SELF) == 0)) && GetIsObjectValid(oTat_invis_conv1))) {
								...
								DelayCommand(0.5, ApplyEffectToObject(0, EffectVisualEffect(1007, 0), OBJECT_SELF, 0.0));
								DelayCommand(0.5, SignalEvent(OBJECT_SELF, unknown1));
							}
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == 1011)) {
												...
												if ((int1 == 44)) {
													...
													ActionDoCommand(SignalEvent(OBJECT_SELF, unknown1));
												}
												else {
													if ((int1 == intGLOB_138)) {
														sub2("wp_homebase");
