...
void main() {
	object oTat_party0_bike_jump = GetObjectByTag("tat_party0_bike_jump", 0);
	object oTat_party1_bike_jump = GetObjectByTag("tat_party1_bike_jump", 0);
	object oTat_party2_bike_jump = GetObjectByTag("tat_party2_bike_jump", 0);
	object oVornsdroid = GetObjectByTag("vornsdroid", 0);
	location location1 = GetLocation(GetObjectByTag("wp_vorndroidspawn", 0));
	sub1(4.0);
	sub2(oTat_party0_bike_jump, oTat_party1_bike_jump, oTat_party2_bike_jump);
	AssignCommand(oVornsdroid, JumpToLocation(location1));
}
