...
void main() {
	DelayCommand(0.2, ChangeToStandardFaction(GetObjectByTag("Vorn", 0), 1));
	DelayCommand(0.3, AssignCommand(GetObjectByTag("Vorn", 0), sub1(OBJECT_INVALID)));
	DelayCommand(0.2, ChangeToStandardFaction(GetObjectByTag("vornsdroid2", 0), 1));
	DelayCommand(0.3, AssignCommand(GetObjectByTag("vornsdroid2", 0), sub1(OBJECT_INVALID)));
}
