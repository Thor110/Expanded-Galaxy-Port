...
void main() {
	object oTat20_09first_01 = GetObjectByTag("tat20_09first_01", 0);
	object oEntering = GetEnteringObject();
	if (((GetIsPC(oEntering) == 1) && (GetIsEnemy(oTat20_09first_01, oEntering) == 0))) {
		sub1("tat20_09first_01", "", OBJECT_INVALID);
	}
}
