...
void main() {
	object oTat_party_move0 = GetObjectByTag("tat_party_move0", 0);
	object oTat_party_move1 = GetObjectByTag("tat_party_move1", 0);
	object oTat_party_move2 = GetObjectByTag("tat_party_move2", 0);
	sub1(2.0);
	...
	sub2(oTat_party_jump0, oTat_party_jump1, oTat_party_jump2);
}
