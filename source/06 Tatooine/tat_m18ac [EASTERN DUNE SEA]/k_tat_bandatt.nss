...
void main() {
	object oTat_bandon_thug1 = GetObjectByTag("tat_bandon_thug1", 0);
	object oTat_bandon_thug2 = GetObjectByTag("tat_bandon_thug2", 0);
	if (GetIsObjectValid(oTat_bandon_thug1)) {
		ChangeToStandardFaction(oTat_bandon_thug1, 1);
		DelayCommand(0.5, AssignCommand(oTat_bandon_thug1, ClearAllActions()));
		DelayCommand(0.5, AssignCommand(oTat_bandon_thug1, sub1(OBJECT_INVALID)));
	}
	if (GetIsObjectValid(oTat_bandon_thug2)) {
		ChangeToStandardFaction(oTat_bandon_thug2, 1);
		DelayCommand(0.5, AssignCommand(oTat_bandon_thug2, ClearAllActions()));
		DelayCommand(0.5, AssignCommand(oTat_bandon_thug2, sub1(OBJECT_INVALID)));
	}
	ChangeToStandardFaction(GetObjectByTag("tat_bandon", 0), 1);
