...
void main() {
	...
	ChangeToStandardFaction(oTat18_tuskamb_01, 1);
	ChangeToStandardFaction(oTat18_tuskamb_02, 1);
	ChangeToStandardFaction(oTat18_tuskamb_03, 1);
	ChangeToStandardFaction(oTat18_tuskamb_04, 1);
	AssignCommand(oTat18_tuskamb_01, ClearAllActions());
	AssignCommand(oTat18_tuskamb_02, ClearAllActions());
	AssignCommand(oTat18_tuskamb_03, ClearAllActions());
	AssignCommand(oTat18_tuskamb_04, ClearAllActions());
	AssignCommand(oTat18_tuskamb_01, DelayCommand(1.0, sub1(OBJECT_INVALID)));
	AssignCommand(oTat18_tuskamb_02, DelayCommand(1.0, sub1(OBJECT_INVALID)));
	AssignCommand(oTat18_tuskamb_03, DelayCommand(1.0, sub1(OBJECT_INVALID)));
	AssignCommand(oTat18_tuskamb_04, DelayCommand(1.0, sub1(OBJECT_INVALID)));
}
