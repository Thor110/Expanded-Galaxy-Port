...
void main() {
	...
	DelayCommand(0.5, AssignCommand(oDan_cut_zuulan, sub2(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oDan_cut_droid1, sub2(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oDan_cut_droid2, sub2(OBJECT_INVALID)));
}
