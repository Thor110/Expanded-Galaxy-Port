...
void main() {
	...
	ChangeToStandardFaction(oDan_cut_zuulan, 1);
	ChangeToStandardFaction(oDan_cut_droid1, 1);
	ChangeToStandardFaction(oDan_cut_droid2, 1);
	DelayCommand(0.4, SetMinOneHP(OBJECT_SELF, 0));
	DelayCommand(0.5, AssignCommand(oDan_cut_zuulan, sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oDan_cut_droid1, sub1(OBJECT_INVALID)));
	DelayCommand(0.5, AssignCommand(oDan_cut_droid2, sub1(OBJECT_INVALID)));
}
