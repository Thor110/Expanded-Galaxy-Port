...
void main() {
	int int1 = sub1(10, 0);
	sub2(int1);
	sub3(OBJECT_SELF, 6, 1);
	int int3 = 1;
	object oNearestMan28_pdroid3 = GetNearestObjectByTag("man28_pdroid3", OBJECT_SELF, 1);
	while (GetIsObjectValid(oNearestMan28_pdroid3)) {
		DelayCommand(0.5, ApplyEffectToObject(0, EffectVisualEffect(4003, 0), oNearestMan28_pdroid3, 0.0));
		(int3++);
		oNearestMan28_pdroid3 = GetNearestObjectByTag("man28_pdroid3", OBJECT_SELF, int3);
	}
}
