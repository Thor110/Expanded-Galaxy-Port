...
void main() {
	...
	object oDan14ad_drd02 = GetObjectByTag("dan14ad_drd02", 0);
	object oDan14ad_drd03 = GetObjectByTag("dan14ad_drd03", 0);
	object oDan14ad_drd04 = GetObjectByTag("dan14ad_drd04", 0);
	ChangeToStandardFaction(oDan14ad_drd01, 1);
	ChangeToStandardFaction(oDan14ad_drd02, 1);
	ChangeToStandardFaction(oDan14ad_drd03, 3);
	ChangeToStandardFaction(oDan14ad_drd04, 3);
	AssignCommand(oDan14ad_drd01, sub1(OBJECT_INVALID));
	AssignCommand(oDan14ad_drd02, sub1(OBJECT_INVALID));
	AssignCommand(oDan14ad_drd03, sub1(OBJECT_INVALID));
	AssignCommand(oDan14ad_drd04, sub1(OBJECT_INVALID));
}
