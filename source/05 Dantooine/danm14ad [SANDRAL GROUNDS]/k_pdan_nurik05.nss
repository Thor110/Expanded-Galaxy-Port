...
void main() {
	sub1("dan14ad_wp_nurik", 2, 1, 0);
	AssignCommand(GetObjectByTag("dan14_rahasia", 0), sub1("dan15ad_wp_rahasia", 1, 3, 0));
	AssignCommand(GetObjectByTag("dan14_shen", 0), sub1("dan15ad_wp_shen", 1, 3, 0));
}
