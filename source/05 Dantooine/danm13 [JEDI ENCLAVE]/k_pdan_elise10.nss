...
void sub1(int intParam1) {
	SetGlobalNumber("DAN_ELISE_PLOT", intParam1);
}

void main() {
	sub1(intGLOB_156);
	SignalEvent(GetObjectByTag("dan13_elise", 0), EventUserDefined(100));
	SignalEvent(GetObjectByTag("dan13_samnt", 0), EventUserDefined(100));
	SignalEvent(GetObjectByTag("dan13_c869", 0), EventUserDefined(100));
}
