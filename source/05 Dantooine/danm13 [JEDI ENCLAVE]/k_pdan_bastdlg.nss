...
void sub3(object objectParam1, int intParam2, object oTarget);
void sub2(string stringParam1);
string sub1(object objectParam1);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub11(intGLOB_46, 1));
					}
					else {
	...
	if ((!sub5(intGLOB_55))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub5(intGLOB_52)) {
				...
				if (((nLocal < int4) && (!sub5(intGLOB_52)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub5(intGLOB_53), 2.5, float3);
			if (sub5(intGLOB_46)) {
...
int sub73() {
	...
	if (GetIsObjectValid(oNearest)) {
		...
		if (GetIsObjectValid(object3)) {
			sub2(("GENERIC DEBUG *************** Object Flee = " + sub1(object3)));
...
int sub72() {
	sub2(("GENERIC DEBUG *************** Post DCR Checks for " + sub1(OBJECT_SELF)));
	if ((sub5(intGLOB_101) && (!sub5(intGLOB_102)))) {
		if (sub73()) {
			return 1;
		}
	}
...
object sub71(object objectParam1) {
	...
	if (GetIsObjectValid(object1)) {
		sub2(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub1(object1)));
		return object1;
	}
...
int sub70(object objectParam1) {
	...
	if (sub16(intGLOB_117, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub16(intGLOB_115, object1)) {
			return 1;
		}
	}
	object object4 = sub15();
	if (GetIsObjectValid(object4)) {
		if (sub16(intGLOB_116, object4)) {
			return 1;
		}
	}
	object3 = sub29();
	sub2(("GENERIC DEBUG *************** Jedi Support AI: AOE Target = " + sub10(GetIsObjectValid(object3))));
	if (GetIsObjectValid(object3)) {
		...
		sub2(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub1(object3)));
		if (GetIsObjectValid(object3)) {
			sub2(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub1(object3)));
			if ((GetRacialType(object3) == 5)) {
																						...
																						if ((intParam1 == intGLOB_37)) {
																							...
																							if ((intParam1 == intGLOB_38)) {
																								...
																								if (((intParam1 == intGLOB_39) || (intParam1 == intGLOB_40))) {
																									...
																									sub2(((("GENERIC DEBUG *************** Droid Items = " + sub1(oLArmItem)) + " / ") + sub1(oRArmItem)));
																									if (sub50()) {
	...
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				...
				sub2(("GENERIC DEBUG *************** Starting Jedi Combo " + sub51(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					...
					sub2(("GENERIC DEBUG *************** Starting Droid Combo " + sub51(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub52(int2);
				}
					...
					sub2(("GENERIC DEBUG *************** Starting NPC Combo " + sub51(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub52(int2);
				}
		...
		sub2(("GENERIC DEBUG *************** Continuing Combo " + sub51(structGLOB_1.int15)));
...
int sub33(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub16(intGLOB_115, oNPC)) {
			return 1;
		}
	}
	oNPC = sub15();
	if (GetIsObjectValid(oNPC)) {
		if (sub16(intGLOB_116, oNPC)) {
			return 1;
		}
	}
	talent1 = sub35(0);
	...
	if ((nLocalBool == 1)) {
		...
		sub2(("GENERIC DEBUG *************** Intruder    = " + sub1(objectParam1)));
		sub2(("GENERIC DEBUG *************** Last Target = " + sub1(oNPC)));
		sub2(("GENERIC DEBUG *************** Closest     = " + sub1(oNearest)));
	...
	sub2(((("GENERIC DEBUG *************** Target = " + sub1(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	if (GetIsObjectValid(oNPC)) {
...
int sub30() {
	...
	sub2((("GENERIC DEBUG *************** Boss AI: Get the #" + sub10(nRandom)) + " target"));
	object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, int4, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
	sub2(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub1(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub2(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub1(oNearest)) + " nCnt = ") + sub10(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub2(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub1(oNearest)));
			object1 = oNearest;
		}
		(int4++);
	...
	if ((int7 == 1)) {
		if (GetIsTalentValid(talent1)) {
			if ((GetTypeFromTalent(talent1) == 1)) {
				sub2(("GENERIC DEBUG *************** Boss AI: Talent Feat = " + sub10(GetIdFromTalent(talent1))));
			}
			else {
				if ((GetTypeFromTalent(talent1) == 0)) {
					sub2(("GENERIC DEBUG *************** Boss AI: Talent Power = " + sub10(GetIdFromTalent(talent1))));
				}
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		...
		sub2(("GENERIC DEBUG *************** Boss AI: Target = " + sub10(GetIsObjectValid(object1))));
		sub2(("GENERIC DEBUG *************** Boss AI: Talent = " + sub10(GetIsTalentValid(talent1))));
...
int sub28() {
	...
	sub2(("GENERIC DEBUG *************** Boss AI: AOE Target = " + sub10(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
...
talent sub26(int intParam1) {
	...
	sub2(("GENERIC DEBUG *************** Last Force Power Used = " + sub10(nLastForce)));
	...
	sub2(("GENERIC DEBUG *************** Force Power Returned = " + sub10(GetIdFromTalent(talent1))));
	return talent1;
}
...
int sub20() {
	...
	talent talent1;
	object object1 = sub21();
	sub2(("GENERIC DEBUG *************** Boss AI: Grenade Target = " + sub10(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
...
object sub17(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		...
		sub2(("GENERIC DEBUG *************** Alternate Target = " + sub1(oNearest)));
	}
	sub2(("GENERIC DEBUG *************** Heal Drain Target = " + sub10(intParam1)));
	sub2(("GENERIC DEBUG *************** Get Active Party Member: " + sub1(oNearest)));
	return oNearest;
}
...
int sub16(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_114)) {
			...
			if ((intParam1 == intGLOB_115)) {
				...
				if ((intParam1 == intGLOB_116)) {
					int3 = 0;
					sub2(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub1(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
					if ((GetRacialType(OBJECT_SELF) != 5)) {
		...
		if (((int3 == 1) && (int4 == 0))) {
			...
			sub2(("GENERIC DEBUG *************** Spells.2DA ID = " + sub10(nTalent)));
			ClearAllActions();
			...
			if (((int3 == 1) && (int4 == 1))) {
				...
				if (GetIsObjectValid(objectParam2)) {
					sub2(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub1(objectParam2)));
	...
	sub2(((((("GENERIC DEBUG *************** " + sub1(OBJECT_SELF)) + " VP = ") + sub10(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub10(GetMaxHitPoints(OBJECT_SELF))));
...
int sub12() {
	int int1 = 0;
	if (((sub5(intGLOB_108) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub5(intGLOB_105))) {
...
int sub9() {
	...
	sub2(((("GENERIC DEBUG *************** Shield Boolean (" + sub10(intGLOB_106)) + ") = ") + sub10(sub5(intGLOB_106))));
	if (((sub5(intGLOB_106) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub6(object objectParam1) {
	sub2("");
	sub2(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub1(OBJECT_SELF)));
	sub7();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub2(("GENERIC DEBUG *************** AI STYLE = " + sub8(OBJECT_SELF)));
		if (((((!sub5(intGLOB_101)) && (!sub5(intGLOB_102))) && (!sub5(intGLOB_103))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub5(intGLOB_111) == 1)) {
					if ((sub13() == 1)) {
						return;
					}
				}
				if ((sub5(intGLOB_105) == 1)) {
...
void sub3(object objectParam1, int intParam2, object oTarget) {
	sub4("");
	sub4(("GENERIC SHOUT DEBUG *************** Respond to Shout Started for " + sub1(OBJECT_SELF)));
	sub4(("GENERIC SHOUT DEBUG *************** Intruder Object = " + sub1(oTarget)));
	int int1;
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		if (((((GetLocalNumber(objectParam1, intGLOB_11) == GetLocalNumber(OBJECT_SELF, intGLOB_9)) || (GetLocalNumber(objectParam1, intGLOB_11) == 0)) || (GetLocalNumber(OBJECT_SELF, intGLOB_11) == 0)) || IsObjectPartyMember(OBJECT_SELF))) {
		if (((((!sub5(intGLOB_101)) && (!sub5(intGLOB_102))) && (!sub5(intGLOB_103))) && (!GetUserActionsPending()))) {
			sub4("GENERIC SHOUT DEBUG *************** Check 1 Pass");
			if ((((intParam2 == 1) && GetIsFriend(objectParam1, OBJECT_SELF)) && (objectParam1 != OBJECT_SELF))) {
				if ((((IsObjectPartyMember(OBJECT_SELF) && IsObjectPartyMember(objectParam1)) && (GetSoloMode() == 0)) || (!IsObjectPartyMember(OBJECT_SELF)))) {
					sub4("GENERIC SHOUT DEBUG *************** Check 2 Pass");
					if ((((!GetIsObjectValid(GetAttemptedAttackTarget())) && (!GetIsObjectValid(GetAttemptedSpellTarget()))) && (!GetIsObjectValid(GetAttackTarget(OBJECT_SELF))))) {
						sub4("GENERIC SHOUT DEBUG *************** Check 3 Pass");
						if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (nStyle != 2)) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
							sub4("GENERIC SHOUT DEBUG *************** Check 3 Pass");
							if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
								sub4("GENERIC SHOUT DEBUG *************** Check 5 Pass");
								sub4(("GENERIC SHOUT DEBUG *************** Intruder = " + sub1(oTarget)));
								if (GetObjectSeen(oTarget, OBJECT_SELF)) {
									sub4("GENERIC SHOUT DEBUG *************** Shout: Determine Combat Round");
									sub2("GENERIC SHOUT DEBUG *************** Shout Clear 1800");
									ClearAllActions();
									sub6(oTarget);
								}
								else {
									if (GetIsObjectValid(oTarget)) {
										sub4("GENERIC SHOUT DEBUG *************** Shout: Move To Intruder");
										sub2("GENERIC SHOUT DEBUG ***************= Shout Clear 1900");
										ClearAllActions();
										float float1 = 5.0;
										...
										if (IsObjectPartyMember(OBJECT_SELF)) {
											...
											sub4(("GENERIC SHOUT DEBUG *************** Attack Intruder = " + sub1(oTarget)));
											if (GetIsObjectValid(oTarget)) {
												sub6(oTarget);
											}
											else {
												oTarget = GetSpellTarget(objectParam1);
												sub4(("GENERIC SHOUT DEBUG *************** Spell Intruder = " + sub1(oTarget)));
												if (GetIsObjectValid(oTarget)) {
													sub6(oTarget);
												}
											}
								...
								if ((((intParam2 == 15) && GetIsFriend(objectParam1, OBJECT_SELF)) && (objectParam1 != OBJECT_SELF))) {
									if ((GetCurrentAction(OBJECT_SELF) == 65535)) {
										if (GetObjectSeen(oTarget, OBJECT_SELF)) {
											sub2("GENERIC SHOUT DEBUG *************** Clear 2000");
											ClearAllActions();
											sub4(("GENERIC SHOUT DEBUG *************** Attack Intruder = " + sub1(oTarget)));
											sub6(oTarget);
										}
											...
											if (GetIsObjectValid(oTarget)) {
												sub2("GENERIC SHOUT DEBUG *************** Clear 2100");
												ClearAllActions();
			...
			if (sub5(intGLOB_102)) {
				sub2("GENERIC SHOUT DEBUG *************** Clear 2200");
				ClearAllActions();
				return;
			}
		}
...
void main() {
	...
	object oNearest;
	if (((int1 == (-1)) && GetCommandable(OBJECT_SELF))) {
		ClearAllActions();
		if (((GetGlobalNumber("DAN_JEDI_PLOT") > 1) && (GetGlobalNumber("DAN_JEDI_PLOT") <= 4))) {
			ActionStartConversation(GetFirstPC(), "k_hbas_dialog", 0, 0, 0, "", "", "", "", "", "", 0);
		}
		else {
		...
		if (((((int1 != (-1)) && GetIsObjectValid(oSpeaker)) && (!GetIsPC(oSpeaker))) && GetIsFriend(oSpeaker, OBJECT_SELF))) {
			...
			sub2(("GENERIC DEBUG *************** Shout Intruder = " + sub1(oNearest)));
			sub2(((((("GENERIC DEBUG *************** " + sub1(OBJECT_SELF)) + " shouted at by: ") + sub1(oSpeaker)) + " for shout: ") + IntToString(int1)));
			sub3(oSpeaker, int1, oNearest);
		}
	}
	if (sub5(intGLOB_80)) {
