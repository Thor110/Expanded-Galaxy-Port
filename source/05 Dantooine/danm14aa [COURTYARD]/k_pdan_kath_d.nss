...
void main() {
	...
	if ((int1 == intGLOB_138)) {
		...
		if (((int1 == 10) || (int1 == 1011))) {
			int nRandom = Random(3);
			switch (nRandom) {
				case 0:
					ActionPlayAnimation(22, 1.0, 10.0);
					break;
				case 1:
					ActionMoveToObject(GetNearestObjectByTag("wp_ambient", OBJECT_SELF, (2 + Random(2))), 0, 3.0);
					ActionPlayAnimation(108, 1.0, 0.0);
					break;
				case 2:
					ActionDoCommand(SetFacingPoint(GetPosition(GetNearestObject(1, OBJECT_SELF, 1))));
