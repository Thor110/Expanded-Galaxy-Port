...
void main() {
	...
	if (((IsObjectPartyMember(oExiting) && GetIsObjectValid(GetObjectByTag("dan14_handon", 0))) && sub1())) {
		AssignCommand(GetObjectByTag("dan14_bolook", 0), ActionStartConversation(oExiting, "dan14_bolookt", 0, 0, 1, "", "", "", "", "", ""));
	}
}
