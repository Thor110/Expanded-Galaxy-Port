...
void main() {
	...
	sub2(OBJECT_INVALID);
	SignalEvent(GetObjectByTag("dan14ac_duros03", 0), EventUserDefined(50));
	SignalEvent(GetObjectByTag("dan14ac_duros04", 0), EventUserDefined(50));
	SignalEvent(GetObjectByTag("dan14ac_mand03", 0), EventUserDefined(50));
	SignalEvent(GetObjectByTag("dan14ac_mand04", 0), EventUserDefined(50));
}
