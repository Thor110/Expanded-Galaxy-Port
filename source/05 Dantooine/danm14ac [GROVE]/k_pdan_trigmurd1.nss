...
void main() {
	...
	if ((((oEntering == GetFirstPC()) && (oEntering == GetPartyMemberByIndex(0))) && (sub1(GetArea(OBJECT_SELF), intGLOB_124) == 0))) {
		sub2(GetArea(OBJECT_SELF), intGLOB_124, 1);
		sub3("dan14_bolook", "", OBJECT_INVALID);
		SetGlobalBoolean("DAN_BOLOOK_WEST", 1);
	}
}
