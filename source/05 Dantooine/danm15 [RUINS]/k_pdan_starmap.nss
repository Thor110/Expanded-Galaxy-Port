...
void main() {
	...
	if ((IsObjectPartyMember(oEntering) && sub1())) {
		...
		sub4(GetObjectByTag("wp_player", 0), GetObjectByTag("wp_npc1", 0), GetObjectByTag("wp_npc2", 0));
		NoClicksFor(0.4);
		...
		DelayCommand(0.2, AssignCommand(GetObjectByTag("dan15_starmapobj", 0), ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", "", 0)));
	}
}
