...
void main() {
	...
	ApplyEffectToObject(0, EffectEntangle(), oTat18_10droid_01, 0.0);
	ApplyEffectToObject(0, EffectEntangle(), oTat18_10droid_02, 0.0);
	ApplyEffectToObject(0, EffectEntangle(), oTat18_10droid_03, 0.0);
	ApplyEffectToObject(0, EffectEntangle(), oTat18_10droid_04, 0.0);
	ApplyEffectToObject(0, EffectEntangle(), OBJECT_SELF, 0.0);
	ChangeToStandardFaction(oTat18_10droid_01, 1);
	ChangeToStandardFaction(oTat18_10droid_02, 1);
	ChangeToStandardFaction(oTat18_10droid_03, 1);
	ChangeToStandardFaction(oTat18_10droid_04, 1);
	ChangeToStandardFaction(OBJECT_SELF, 1);
	AssignCommand(oTat18_10droid_01, sub1(OBJECT_INVALID));
	AssignCommand(oTat18_10droid_02, sub1(OBJECT_INVALID));
	AssignCommand(oTat18_10droid_03, sub1(OBJECT_INVALID));
	AssignCommand(oTat18_10droid_04, sub1(OBJECT_INVALID));
}
