...
void main() {
	...
	if ((GetTag(GetItemInSlot(1, oEntering)) == "tat17_sandperdis")) {
		...
		while ((GetIsObjectValid(oAreaObject) == 1)) {
			if (((((GetTag(oAreaObject) == "tat18_13craw1_01") || (GetTag(oAreaObject) == "tat18_13craw1_02")) || (GetTag(oAreaObject) == "tat18_13craw1_03")) || (GetTag(oAreaObject) == "tat18_13craw2_01"))) {
				...
				AssignCommand(oAreaObject, sub1(OBJECT_INVALID));
			}
			oAreaObject = GetNextObjectInArea(OBJECT_INVALID, 1);
		}
	}
	else {
		if (((GetTag(oEntering) == "tat18_tusken03") || (GetTag(oEntering) == "tat18_tusken04"))) {
			AssignCommand(oEntering, DelayCommand(1.0, sub1(OBJECT_INVALID)));
		}
	}
}
