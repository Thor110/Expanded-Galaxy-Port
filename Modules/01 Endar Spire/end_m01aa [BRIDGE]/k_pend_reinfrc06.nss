...
void main() {
	if ((IsObjectPartyMember(GetEnteringObject()) && sub1())) {
		CreateObject(1, "end_reinforce3", GetLocation(GetObjectByTag("wp_end_reinforce3_1", 0)), 0);
		CreateObject(1, "end_reinforce4", GetLocation(GetObjectByTag("wp_end_reinforce4_1", 0)), 0);
	}
}
