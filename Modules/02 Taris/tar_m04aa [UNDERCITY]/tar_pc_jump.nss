...
void main() {
	object oTar_pc0_jump_wp = GetObjectByTag("tar_pc0_jump_wp", 0);
	object oTar_pc1_jump_wp = GetObjectByTag("tar_pc1_jump_wp", 0);
	object oTar_pc2_jump_wp = GetObjectByTag("tar_pc2_jump_wp", 0);
	SetPartyLeader(0xFFFFFFFF);
	DelayCommand(0.2, sub1(oTar_pc0_jump_wp, oTar_pc1_jump_wp, oTar_pc2_jump_wp));
}
