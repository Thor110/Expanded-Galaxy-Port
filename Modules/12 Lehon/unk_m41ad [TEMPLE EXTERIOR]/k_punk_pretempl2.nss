...
void main() {
	if ((GetGlobalNumber("DAN_JUHANI_PLOT") != 2)) {
		...
		AddPartyMember(4, GetObjectByTag("jolee", 0));
	}//skipping over stunt_19 module as it doesn't load yet//StartNewModule("stunt_19", "",//etc//
	AssignCommand(GetArea(OBJECT_SELF), DelayCommand(0.5, StartNewModule("unk_m44aa", "unk44_sw44aa01", "", "", "", "", "", "")));
