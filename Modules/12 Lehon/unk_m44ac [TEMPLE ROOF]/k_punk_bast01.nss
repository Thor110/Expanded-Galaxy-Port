...
void main() {
	...
	AssignCommand(GetPartyMemberByIndex(0), SetFacingPoint(GetPosition(GetObjectByTag("bastend", 0))));
	AssignCommand(GetPartyMemberByIndex(1), sub1(GetPartyMemberByIndex(1), GetLocation(GetObjectByTag("joleeend", 0))));
	AssignCommand(GetPartyMemberByIndex(1), SetFacingPoint(GetPosition(GetObjectByTag("bastend", 0))));
	AssignCommand(GetPartyMemberByIndex(2), sub1(GetPartyMemberByIndex(2), GetLocation(GetObjectByTag("juhaniend", 0))));
	AssignCommand(GetPartyMemberByIndex(2), SetFacingPoint(GetPosition(GetObjectByTag("bastend", 0))));
