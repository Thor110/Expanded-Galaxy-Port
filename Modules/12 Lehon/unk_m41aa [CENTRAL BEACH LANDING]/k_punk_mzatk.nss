...
// Prototypes
void sub49(int intParam1, int intParam2);
int sub48(int intParam1, int intParam2);
void sub47();
int sub46();
int sub45();
int sub44();
...
talent sub11();
object sub10();
int sub9(int intParam1, object objectParam2);
int sub8(object objectParam1);
object sub7();
	...
	if ((!sub5(intGLOB_66))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub5(intGLOB_63)) {
				...
				if (((nLocal < int4) && (!sub5(intGLOB_63)))) {
					int16 = sub48(int4, nLocal);
					nLocal = (nLocal + int16);
				}
				else {
					if ((nLocal == int4)) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub5(intGLOB_64), 2.5, 200.0);
...
int sub45() {
	object oInvItem;
	if (((((GetIsObjectValid(GetAttackTarget(OBJECT_SELF)) && (GetDistanceBetween(GetAttackTarget(OBJECT_SELF), OBJECT_SELF) <= 4.0)) && (sub44() != 1)) && (GetRacialType(OBJECT_SELF) == 6)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		...
		if ((((((((sub44() != 2) && (GetLevelByClass(4, OBJECT_SELF) == 0)) && (GetLevelByClass(3, OBJECT_SELF) == 0)) && (GetLevelByClass(5, OBJECT_SELF) == 0)) && GetIsObjectValid(GetAttackTarget(OBJECT_SELF))) && (GetDistanceBetween(GetAttemptedAttackTarget(), OBJECT_SELF) > 4.0)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
			oInvItem = GetFirstItemInInventory(OBJECT_SELF);
			while (GetIsObjectValid(oInvItem)) {
				...
				if ((intParam1 == intGLOB_33)) {
					...
					if ((intParam1 == intGLOB_34)) {
						...
						if ((intParam1 == intGLOB_35)) {
							...
							if ((intParam1 == intGLOB_36)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub14())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_37)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub14())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_38)) {
										...
										if ((intParam1 == intGLOB_39)) {
											...
											if ((intParam1 == intGLOB_40)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub18() && sub19()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_41)) {
													talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
													if ((sub20() && GetIsTalentValid(talRandom))) {
														return 1;
													}
												}
												else {
													if ((intParam1 == intGLOB_42)) {
														...
														if ((intParam1 == intGLOB_43)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub16() && sub22()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_44)) {
																if (((sub22() && sub15()) && sub23())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_45)) {
																	if (((sub20() && sub15()) && sub17())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_46)) {
																		if (((sub21() && sub15()) && sub17())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_46)) {
																			if (((sub16() && sub24()) && sub15())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_48)) {
																				talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																				if ((sub24() && GetIsTalentValid(talRandom))) {
																					return 1;
																				}
																			}
																			else {
																				if ((intParam1 == intGLOB_49)) {
																					if (((sub24() && sub15()) && sub23())) {
																						return 1;
																					}
																				}
																				else {
																					if ((intParam1 == intGLOB_50)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if ((sub15() && GetIsTalentValid(talRandom))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_51)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub15() && sub22()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_52)) {
																								talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																								if (((sub24() && sub25()) && GetIsTalentValid(talRandom))) {
																									return 1;
																								}
																							}
																							else {
...
talent sub11() {
		...
		if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
			...
			if ((nRandom > 0)) {
				if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
					int2 = sub12();
					sub2(("GENERIC DEBUG *************** Starting Jedi Combo " + sub27(int2)));
					...
					if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
						int2 = sub42();
						sub2(("GENERIC DEBUG *************** Starting Droid Combo " + sub27(int2)));
						SetLocalNumber(OBJECT_SELF, intGLOB_23, 1);
						SetLocalNumber(OBJECT_SELF, intGLOB_22, int2);
						return sub28(int2);
					}
						...
						int2 = sub43();
						sub2(("GENERIC DEBUG *************** Starting NPC Combo " + sub27(int2)));
						SetLocalNumber(OBJECT_SELF, intGLOB_23, 1);
						SetLocalNumber(OBJECT_SELF, intGLOB_22, int2);
						return sub28(int2);
					}
			...
			sub2(("GENERIC DEBUG *************** Continuing Combo " + sub27(structGLOB_1.int15)));
			return sub28(structGLOB_1.int15);
		}
	}
	else {
		if ((nNPCStyle == 4)) {
	...
	sub2("GENERIC DEBUG *************** HOLY CRAP YOU ARE STUPID");
	return talent1;
}

object sub10() {
	if ((sub8(OBJECT_SELF) > 0)) {
...
int sub6(object objectParam1) {
	...
	if ((IsObjectPartyMember(OBJECT_SELF) == 0)) {
		...
		if (GetIsObjectValid(oNPC)) {
			if (sub9(intGLOB_114, oNPC)) {
				return 1;
			}
		}
		oNPC = sub10();
		if (GetIsObjectValid(oNPC)) {
			if (sub9(intGLOB_115, oNPC)) {
				return 1;
			}
		}
	}
	...
	if ((nLocalBool == 1)) {
		...
		if ((GetIsObjectValid(oNearest) && (((!GetIsObjectValid(oNPC)) && (!GetIsEnemy(oNPC, OBJECT_SELF))) || (GetCurrentHitPoints(oNPC) < GetCurrentHitPoints(oNearest))))) {
			oNPC = oNearest;
		}
	}
	sub2(((("GENERIC DEBUG *************** Target = " + sub3(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	sub2("GENERIC DEBUG *************** Clear 253");
	ClearAllActions();
	if (sub45()) {
...
void sub1(object objectParam1) {
	...
	sub2(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub3(OBJECT_SELF)));
	{
		...
		sub2(("GENERIC DEBUG *************** ROUND NUMBER " + IntToString(nLocal)));
		SetLocalNumber(OBJECT_SELF, intGLOB_24, (nLocal++));
		sub4();
		int int3 = 0;
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		if ((((!sub5(intGLOB_109)) && (!sub5(intGLOB_110))) && (!sub5(intGLOB_111)))) {
				...
				if ((nNPCStyle == 0)) {
					...
					if ((nNPCStyle == 3)) {
						...
						if (GetIsObjectValid(object2)) {
							if (sub9(intGLOB_114, object2)) {
								return;
							}
						}
						ClearAllActions();
						sub2("GENERIC DEBUG *************** Clear 113");
					}
					else {
						if ((nNPCStyle == 4)) {
							ClearAllActions();
							sub2("GENERIC DEBUG *************** Clear 118");
						}
						else {
							if ((nNPCStyle == 5)) {
								ClearAllActions();
								sub2("GENERIC DEBUG *************** Clear 123");
							}
							else {
								if ((nNPCStyle == 2)) {
									ClearAllActions();
									sub2("GENERIC DEBUG *************** Clear 128");
								}
								else {
									if ((nNPCStyle == 1)) {
										ClearAllActions();
										sub2("GENERIC DEBUG *************** Clear 133");
									}
								}
							}
						}
		...
		if ((sub5(intGLOB_109) && (!sub5(intGLOB_110)))) {
			int int20 = sub46();
			return;
		}
		else {
...
void main() {
	...
	ChangeToStandardFaction(oMission, 1);
	//AssignCommand(oMission, sub1(OBJECT_INVALID));
  //ActionAttack(GetFirstPC(),FALSE);
	AssignCommand(oMission, ActionAttack(GetFirstPC(),FALSE));
	ChangeToStandardFaction(oZaalbar, 1);
	//AssignCommand(oZaalbar, sub1(OBJECT_INVALID));
	AssignCommand(oZaalbar, ActionAttack(GetFirstPC(),FALSE));
	ChangeToStandardFaction(oCand, 2);
	//AssignCommand(oCand, sub1(OBJECT_INVALID));
	AssignCommand(oCand, ActionAttack(GetFirstPC(),FALSE));
