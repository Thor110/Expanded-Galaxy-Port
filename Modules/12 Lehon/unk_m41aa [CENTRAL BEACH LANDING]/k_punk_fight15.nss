...
void main() {
	...
	ChangeToStandardFaction(GetObjectByTag("unk41_blackrak4", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("unk41_blackrak5", 0), 2);
	ChangeToStandardFaction(GetObjectByTag("unk41_redrak1", 0), 4);
	ChangeToStandardFaction(GetObjectByTag("unk41_redrak2", 0), 4);
	ChangeToStandardFaction(GetObjectByTag("unk41_redrak3", 0), 4);
	AssignCommand(GetObjectByTag("unk41_blackrak4", 0), sub1(OBJECT_INVALID));
	AssignCommand(GetObjectByTag("unk41_blackrak5", 0), sub1(OBJECT_INVALID));
	AssignCommand(GetObjectByTag("unk41_redrak1", 0), sub1(OBJECT_INVALID));
	AssignCommand(GetObjectByTag("unk41_redrak2", 0), sub1(OBJECT_INVALID));
	AssignCommand(GetObjectByTag("unk41_redrak3", 0), sub1(OBJECT_INVALID));
	ActionWait(8.0);
