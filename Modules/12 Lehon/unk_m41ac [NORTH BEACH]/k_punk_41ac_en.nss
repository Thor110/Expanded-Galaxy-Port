...
void main() {
	if ((GetIsPC(GetEnteringObject()) == 1)) {
		...
		if ((GetGlobalBoolean("UNK_TEMP5") == 1)) {
			sub1("unk5", 5, 5, 2.0);
		}
		if ((GetGlobalBoolean("UNK_TEMP6") == 1)) {
			sub1("unk6", 5, 6, 2.0);
		}
		if ((GetGlobalBoolean("UNK_BLACKHOSTILE") == 1)) {
			sub1("unk7", 5, 7, 2.0);
		}
		if ((GetGlobalBoolean("UNK_SPAWN") == 1)) {
			CreateObject(1, "unk41_rancor02", GetLocation(GetObjectByTag("wp_01_11", 0)), 0);
			CreateObject(1, "unk41_rancor02", GetLocation(GetObjectByTag("wp_01_10", 0)), 0);
			CreateObject(1, "unk41_blkwand001", GetLocation(GetObjectByTag("wp_01_07", 0)), 0);
			CreateObject(1, "unk41_blkwandere", GetLocation(GetObjectByTag("wp_01_09", 0)), 0);
			CreateObject(1, "unk41_blkwand001", GetLocation(GetObjectByTag("wp_01_04", 0)), 0);
			CreateObject(1, "unk41_blkwandere", GetLocation(GetObjectByTag("wp_01_01", 0)), 0);
			CreateObject(1, "unk41_blkwand001", GetLocation(GetObjectByTag("wp_01_12", 0)), 0);
			CreateObject(1, "unk41_rakplot", GetLocation(GetObjectByTag("rakplot", 0)), 0);
			SetGlobalBoolean("UNK_SPAWN", 0);
		}
		if (((GetGlobalBoolean("UNK_TEMP6") == 1) || (GetGlobalBoolean("UNK_BLACKHOSTILE") == 1))) {
			sub2();
		}
		if ((((GetGlobalBoolean("UNK_TEMP6") == 0) && (GetGlobalBoolean("UNK_BLACKHOSTILE") == 1)) || ((GetGlobalBoolean("UNK_RED_TALK") == 1) && (GetGlobalBoolean("UNK_REDHOSTILE") == 0)))) {
			DestroyObject(GetObjectByTag("unk41_rancor01", 0), 0.0, 1, 0.0);
			DelayCommand(0.3, DestroyObject(GetObjectByTag("unk41_rancor01", 0), 0.0, 1, 0.0));
			DestroyObject(GetObjectByTag("unk41_blkwand001", 0), 0.0, 1, 0.0);
			DestroyObject(GetObjectByTag("unk41_blkwandere", 0), 0.0, 1, 0.0);
			DelayCommand(0.3, DestroyObject(GetObjectByTag("unk41_blkwand001", 0), 0.0, 1, 0.0));
			DelayCommand(0.3, DestroyObject(GetObjectByTag("unk41_blkwandere", 0), 0.0, 1, 0.0));
			DelayCommand(0.6, DestroyObject(GetObjectByTag("unk41_blkwand001", 0), 0.0, 1, 0.0));
			DestroyObject(GetObjectByTag("plottalk", 0), 0.0, 0, 0.0);
			DestroyObject(GetObjectByTag("entering", 0), 0.0, 0, 0.0);
		}
	}
}
