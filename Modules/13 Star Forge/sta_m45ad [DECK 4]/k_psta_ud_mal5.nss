...
void sub78(string stringParam1, int intParam2, int intParam3, float floatParam4);
void sub77();
int sub76(int intParam1, int intParam2);
void sub75();
void sub74(string stringParam1);
int sub73(object objectParam1);
void sub72();
int sub71();
int sub70();
object sub69(object objectParam1);
int sub68(object objectParam1);
int sub67(object objectParam1);
talent sub66(object objectParam1, talent talentParam2);
int sub65(int intParam1);
int sub64(int intParam1);
int sub63();
int sub62();
int sub61();
int sub60();
...
int sub52();
int sub51();
talent sub50(int intParam1);
string sub49(int intParam1);
int sub48();
int sub47();
int sub46();
int sub45();
...
int sub34(int intParam1);
talent sub33(int intParam1);
object sub32();
int sub31(object objectParam1);
talent sub30(object objectParam1, talent talentParam2);
talent sub29(object objectParam1, talent talentParam2);
int sub28();
object sub27();
int sub26();
talent sub25(int intParam1);
talent sub24(int intParam1);
talent sub23(int intParam1);
talent sub22(int intParam1, int intParam2);
int sub21(object objectParam1, float floatParam2);
int sub20(object objectParam1, float floatParam2);
object sub19();
int sub18();
int sub17(object objectParam1);
int sub16();
object sub15(int intParam1);
int sub14(int intParam1, object objectParam2);
object sub13();
int sub12(object objectParam1);
int sub11();
int sub10();
void sub9(int intParam1, int intParam2);
string sub8(int intParam1);
int sub7();
int sub6(int intParam1);
string sub5(object objectParam1);
void sub4();
string sub3(object objectParam1);
			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub9(intGLOB_46, 1));
					}
					else {
	...
	if ((!sub6(intGLOB_55))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub6(intGLOB_52)) {
				...
				if (((nLocal < int4) && (!sub6(intGLOB_52)))) {
					int16 = sub76(int4, nLocal);
					nLocal = (nLocal + int16);
				}
				else {
					if ((nLocal == int4)) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub6(intGLOB_53), 2.5, float3);
			if (sub6(intGLOB_46)) {
				ActionDoCommand(sub77());
			}
			SetLocalNumber(OBJECT_SELF, intGLOB_43, nLocal);
			if ((string2 != "UNKNOWN")) {
				ActionDoCommand(sub75());
			}
		}
	}
}
...
int sub73(object objectParam1) {
	...
	sub74(("Walk Initiate for " + GetTag(objectParam1)));
	sub74(("TAG WAY FOUND = " + IntToString(GetIsObjectValid(oWP))));
	sub74(("WAY POINT NAME = " + GetTag(oWP)));
	sub74(("SERIES INT = " + IntToString(nLocal)));
	sub74(("SERIES WAY FOUND = " + IntToString(GetIsObjectValid(object3))));
	sub74(("SERIES Series Tag = " + string8));
	sub74("");
...
int sub71() {
	sub2("GENERIC DEBUG *************** Start Commoner AI");
	...
	if (GetIsObjectValid(oNearest)) {
		sub2("GENERIC DEBUG *************** Clear 2710");
		ClearAllActions();
		ActionMoveAwayFromObject(oNearest, 1, 20.0);
		DelayCommand(0.2, ActionDoCommand(sub72()));
		return 1;
	}
	else {
		if (GetIsObjectValid(object3)) {
			sub2(("GENERIC DEBUG *************** Object Flee = " + sub3(object3)));
			sub2("GENERIC DEBUG *************** Clear 2720");
			ClearAllActions();
...
int sub70() {
	sub2(("GENERIC DEBUG *************** Post DCR Checks for " + sub3(OBJECT_SELF)));
	if ((sub6(intGLOB_101) && (!sub6(intGLOB_102)))) {
		if (sub71()) {
			return 1;
		}
	}
		...
		if (sub6(intGLOB_102)) {
			sub2("GENERIC DEBUG *************** Clear 1000");
			ClearAllActions();
			return 1;
		}
	}
	if (((!IsObjectPartyMember(OBJECT_SELF)) && (sub73(OBJECT_SELF) == 1))) {
		sub2("GENERIC DEBUG *************** Clear 1100");
		ClearAllActions();
		DelayCommand(1.0, sub75());
		return 1;
	}
	else {
		if ((((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetIsObjectValid(GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF)))) && IsObjectPartyMember(OBJECT_SELF))) {
			if ((!GetSoloMode())) {
				sub78("NO TARGET: FOLLOW LEADER", 10, 10, 4.0);
				CancelCombat(OBJECT_SELF);
				sub2("GENERIC DEBUG *************** Clear 1200");
				ClearAllActions();
				ActionFollowLeader();
			}
			return 1;
...
object sub69(object objectParam1) {
	sub2("GENERIC DEBUG *************** Starting: Determine Attack Target");
	int nStyle = GetPartyAIStyle();
	int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
	object object1;
	object oLastTarget = GetLastHostileTarget(OBJECT_SELF);
	sub2(((("GENERIC DEBUG *************** Intruder = " + IntToString(GetIsObjectValid(objectParam1))) + " Last Target = ") + IntToString(GetIsObjectValid(oLastTarget))));
	if (((GetIsObjectValid(objectParam1) && (!GetIsDead(objectParam1))) && (!GetIsDebilitated(objectParam1)))) {
		sub2(("GENERIC DEBUG *************** Intruder Target Returned = " + ObjectToString(objectParam1)));
		return objectParam1;
	}
	else {
		if (((GetIsObjectValid(oLastTarget) && (!GetIsDead(oLastTarget))) && (!GetIsDebilitated(oLastTarget)))) {
			sub2(("GENERIC DEBUG *************** Last Target Returned = " + ObjectToString(objectParam1)));
			return oLastTarget;
		}
		else {
			if ((nStyle == 0)) {
				int int13 = 1;
				sub2("GENERIC DEBUG *************** Getting nearest target - 249");
				...
				if ((nStyle == 1)) {
					...
					if (GetIsObjectValid(oLastActor)) {
						sub2("GENERIC DEBUG *************** Getting nearest target - 262");
						...
						if (GetIsObjectValid(oLastActor)) {
							sub2("GENERIC DEBUG *************** Getting nearest target - 269");
							object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
						}
					}
				}
					...
					if ((nStyle != 2)) {
						sub2("GENERIC DEBUG *************** Getting nearest target - 275");
						object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
					}
					else {
						sub2("GENERIC DEBUG *************** Getting nearest target - 279");
						object1 = GetNearestCreature(3, 1, OBJECT_SELF, 1, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
					}
				}
			}
	...
	if (GetIsObjectValid(object1)) {
		sub2(("GENERIC DEBUG *************** Attack Target From Determine Attack Target = " + sub3(object1)));
		return object1;
	}
	sub2("GENERIC DEBUG *************** No Attack Targets Found");
...
int sub68(object objectParam1) {
	...
	if ((GetRacialType(OBJECT_SELF) == 5)) {
		return sub31(OBJECT_INVALID);
	}
	if (sub14(intGLOB_117, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub14(intGLOB_115, object1)) {
			return 1;
		}
	}
	object object4 = sub13();
	if (GetIsObjectValid(object4)) {
		if (sub14(intGLOB_116, object4)) {
			return 1;
		}
	}
	object3 = sub27();
	sub2(("GENERIC DEBUG *************** Jedi Support AI: AOE Target = " + sub8(GetIsObjectValid(object3))));
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub22(intGLOB_2, 1);
		}
		else {
			talent1 = sub22(intGLOB_2, 0);
		}
	}
	else {
		sub2("GENERIC DEBUG *************** Jedi Support AI: Inside the Party AI Section");
		object3 = sub69(OBJECT_INVALID);
		sub2(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub3(object3)));
		if (GetIsObjectValid(object3)) {
			sub2(("GENERIC DEBUG *************** Jedi Support AI: Valid oTarget Set As = " + sub3(object3)));
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub22(intGLOB_3, 1);
			}
			else {
				talent1 = sub22(intGLOB_3, 0);
			}
		}
	}
	talent1 = sub29(object3, talent1);
	talent1 = sub30(object3, talent1);
	if ((GetIsObjectValid(object3) && GetIsTalentValid(talent1))) {
		sub2("GENERIC DEBUG *************** Clear 1450");
		ClearAllActions();
		ActionUseTalentOnObject(talent1, object3);
		return 1;
	}
	sub2("GENERIC DEBUG *************** Jedi Support AI: Fall Through");
	return sub31(OBJECT_INVALID);
}
...
talent sub66(object objectParam1, talent talentParam2) {
	int int1;
	sub2("GENERIC DEBUG *************** Starting Droid Talent Double Check");
	if ((GetTypeFromTalent(talentParam2) == 0)) {
		sub2("GENERIC DEBUG *************** Droid Talent is a Spell");
...
int sub65(int intParam1) {
	int int1;
	int nRandom = d4(1);
	if ((sub17(OBJECT_SELF) != 0)) {
		while ((int1 == 0)) {
			if ((sub17(OBJECT_SELF) == 1)) {
				if ((nRandom == 1)) {
					nRandom = intGLOB_17;
				}
				else {
																...
																if ((intParam1 == intGLOB_17)) {
																	...
																	if ((intParam1 == intGLOB_18)) {
																		...
																		if (((intParam1 == intGLOB_19) || (intParam1 == intGLOB_15))) {
																			sub2("GENERIC DEBUG *************** Melee/Ranged Breather");
																		}
																		else {
				...
				if ((intParam1 == intGLOB_19)) {
					...
					if ((intParam1 == intGLOB_20)) {
						...
						if ((intParam1 == intGLOB_21)) {
							...
							if ((intParam1 == intGLOB_22)) {
								talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
								if ((GetIsTalentValid(talRandom) && sub36())) {
									return 1;
								}
							}
							else {
								if ((intParam1 == intGLOB_23)) {
									talRandom = GetCreatureTalentRandom(63743, OBJECT_SELF, 0);
									talent2 = GetCreatureTalentRandom(62207, OBJECT_SELF, 0);
									if (((GetIsTalentValid(talRandom) && GetIsTalentValid(talent2)) && sub36())) {
										return 1;
									}
								}
								else {
									if ((intParam1 == intGLOB_24)) {
										...
										if ((intParam1 == intGLOB_25)) {
											...
											if ((intParam1 == intGLOB_26)) {
												talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
												if (((sub40() && sub41()) && GetIsTalentValid(talRandom))) {
													return 1;
												}
											}
											else {
												if ((intParam1 == intGLOB_27)) {
													...
													if ((intParam1 == intGLOB_28)) {
														...
														if ((intParam1 == intGLOB_29)) {
															talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
															if (((sub38() && sub44()) && GetIsTalentValid(talRandom))) {
																return 1;
															}
														}
														else {
															if ((intParam1 == intGLOB_30)) {
																if (((sub44() && sub37()) && sub45())) {
																	return 1;
																}
															}
															else {
																if ((intParam1 == intGLOB_31)) {
																	if (((sub42() && sub37()) && sub39())) {
																		return 1;
																	}
																}
																else {
																	if ((intParam1 == intGLOB_32)) {
																		if (((sub43() && sub37()) && sub39())) {
																			return 1;
																		}
																	}
																	else {
																		if ((intParam1 == intGLOB_32)) {
																			if (((sub38() && sub46()) && sub37())) {
																				return 1;
																			}
																		}
																		else {
																			if ((intParam1 == intGLOB_34)) {
																				...
																				if ((intParam1 == intGLOB_35)) {
																					...
																					if ((intParam1 == intGLOB_36)) {
																						talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																						if ((sub37() && GetIsTalentValid(talRandom))) {
																							return 1;
																						}
																					}
																					else {
																						if ((intParam1 == intGLOB_37)) {
																							talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																							if (((sub37() && sub44()) && GetIsTalentValid(talRandom))) {
																								return 1;
																							}
																						}
																						else {
																							if ((intParam1 == intGLOB_38)) {
																								talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
																								if (((sub46() && sub47()) && GetIsTalentValid(talRandom))) {
																									return 1;
																								}
																							}
																							else {
																								if (((intParam1 == intGLOB_39) || (intParam1 == intGLOB_40))) {
																									...
																									sub2(((("GENERIC DEBUG *************** Droid Items = " + sub3(oLArmItem)) + " / ") + sub3(oRArmItem)));
																									if (sub48()) {
																										sub2("GENERIC DEBUG *************** Droid Utility Check is TRUE");
																										return 1;
																									}
																									sub2("GENERIC DEBUG *************** Droid Utility Check is FALSE");
																								}
																							}
																						}
																					}
...
talent sub33(int intParam1) {
	...
	talent talent1;
	int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
	sub2("GENERIC DEBUG *************** Starting GetComboMove");
	if (((structGLOB_1.int13 == 4) || (structGLOB_1.int13 == 0))) {
		...
		if ((nRandom > 0)) {
			if ((((GetLevelByClass(4, OBJECT_SELF) > 0) || (GetLevelByClass(3, OBJECT_SELF) > 0)) || (GetLevelByClass(5, OBJECT_SELF) > 0))) {
				int2 = sub34(intParam1);
				sub2(("GENERIC DEBUG *************** Starting Jedi Combo " + sub49(int2)));
				...
				if (((GetLevelByClass(6, OBJECT_SELF) > 0) || (GetLevelByClass(7, OBJECT_SELF) > 0))) {
					int2 = sub64(intParam1);
					sub2(("GENERIC DEBUG *************** Starting Droid Combo " + sub49(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub50(int2);
				}
					...
					sub2(("GENERIC DEBUG *************** Starting NPC Combo " + sub49(int2)));
					SetLocalNumber(OBJECT_SELF, intGLOB_8, 1);
					SetLocalNumber(OBJECT_SELF, intGLOB_7, int2);
					return sub50(int2);
				}
		...
		sub2(("GENERIC DEBUG *************** Continuing Combo " + sub49(structGLOB_1.int15)));
		return sub50(structGLOB_1.int15);
	}
	return talent1;
}

object sub32() {
	sub2("GENERIC DEBUG *************** Starting Poison Check");
	effect efNext;
	...
	sub2("GENERIC DEBUG ***************  Returning Invalid Poison Object");
	return OBJECT_INVALID;
}
...
int sub31(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub14(intGLOB_115, oNPC)) {
			return 1;
		}
	}
	oNPC = sub13();
	if (GetIsObjectValid(oNPC)) {
		if (sub14(intGLOB_116, oNPC)) {
			return 1;
		}
	}
	talent1 = sub33(0);
	...
	if ((nLocalBool == 1)) {
		...
		sub2("GENERIC DEBUG *************** Default AI Debug Start *************************");
		sub2(("GENERIC DEBUG *************** Intruder    = " + sub3(objectParam1)));
		sub2(("GENERIC DEBUG *************** Last Target = " + sub3(oNPC)));
		sub2(("GENERIC DEBUG *************** Closest     = " + sub3(oNearest)));
		if ((((IsObjectPartyMember(OBJECT_SELF) && GetIsObjectValid(oNPC)) && (!GetIsDead(oNPC))) && GetObjectSeen(oNPC, OBJECT_SELF))) {
			...
			if ((GetIsObjectValid(objectParam1) && GetObjectSeen(objectParam1, OBJECT_SELF))) {
				sub2("GENERIC DEBUG *************** Intruder becomes Target");
				oNPC = objectParam1;
			}
			else {
				if ((GetIsObjectValid(oNearest) && GetObjectSeen(oNearest, OBJECT_SELF))) {
					if (((((!GetIsObjectValid(oNPC)) || (!GetIsEnemy(oNPC, OBJECT_SELF))) || GetIsDead(oNPC)) || (GetCurrentHitPoints(oNPC) < GetCurrentHitPoints(oNearest)))) {
						sub2("GENERIC DEBUG *************** Closest becomes Target");
						oNPC = oNearest;
					}
				}
			}
	...
	if ((GetRacialType(OBJECT_SELF) == 5)) {
		talent1 = sub66(oNPC, talent1);
	}
	talent1 = sub29(oNPC, talent1);
	talent1 = sub30(oNPC, talent1);
	sub2("GENERIC DEBUG *************** Default AI Debug End ***************************");
	sub2(((("GENERIC DEBUG *************** Target = " + sub3(oNPC)) + " is Enemy: ") + IntToString(GetIsEnemy(oNPC, OBJECT_SELF))));
	if (GetIsObjectValid(oNPC)) {
		sub2("GENERIC DEBUG *************** Clear 1300");
		ClearAllActions();
		if (sub16()) {
			sub2("GENERIC DEBUG *************** Switching Weapons");
		}
		if ((GetIsTalentValid(talent1) && GetIsEnemy(oNPC, OBJECT_SELF))) {
			sub2("GENERIC DEBUG *************** Using Talent on Target");
			ActionUseTalentOnObject(talent1, oNPC);
			return 1;
		}
		else {
			if (GetIsEnemy(oNPC, OBJECT_SELF)) {
				sub2("GENERIC DEBUG *************** Action Attack by Default");
				ActionAttack(oNPC, 0);
				return 1;
			}
		}
	}
	sub2("GENERIC DEBUG *************** Default AI has failed to do an action");
	return 0;
}
...
talent sub29(object objectParam1, talent talentParam2) {
	...
	if ((GetTypeFromTalent(talentParam2) == 0)) {
		if (((GetIdFromTalent(talentParam2) == 49) || (GetIdFromTalent(talentParam2) == 4))) {
			sub2(("GENERIC DEBUG *************** Lightsaber Throw Check = " + FloatToString(GetDistanceBetween(OBJECT_SELF, objectParam1), 4, 2)));
...
int sub28() {
	sub2("GENERIC DEBUG *************** Boss AI: Start Targeted Action Routine");
	talent talent1;
	object object1;
	int int1;
	int nRandom = d6(1);
	...
	sub2((("GENERIC DEBUG *************** Boss AI: Get the #" + sub8(nRandom)) + " target"));
	object oNearest = GetNearestCreature(3, 1, OBJECT_SELF, int4, 7, 7, 0xFFFFFFFF, 0xFFFFFFFF);
	sub2(("GENERIC DEBUG *************** Boss AI: Initial oFind Search = " + sub3(oNearest)));
	while ((GetIsObjectValid(oNearest) && (int4 <= nRandom))) {
		sub2(((("GENERIC DEBUG *************** Boss AI: Valid oFind = " + sub3(oNearest)) + " nCnt = ") + sub8(int4)));
		if (GetIsObjectValid(oNearest)) {
			sub2(("GENERIC DEBUG *************** Boss AI: Valid oTarget Set As = " + sub3(oNearest)));
			object1 = oNearest;
		}
		(int4++);
	...
	if ((int7 == 1)) {
		if (GetIsTalentValid(talent1)) {
			if ((GetTypeFromTalent(talent1) == 1)) {
				sub2(("GENERIC DEBUG *************** Boss AI: Talent Feat = " + sub8(GetIdFromTalent(talent1))));
			}
			else {
				if ((GetTypeFromTalent(talent1) == 0)) {
					sub2(("GENERIC DEBUG *************** Boss AI: Talent Power = " + sub8(GetIdFromTalent(talent1))));
				}
			}
		}
	}
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			sub2("GENERIC DEBUG *************** Boss AI: Get Boss Combat Move AI Droid");
			int1 = 1;
		}
		talent1 = sub22(intGLOB_3, int1);
		talent1 = sub29(object1, talent1);
		talent1 = sub30(object1, talent1);
		sub2(("GENERIC DEBUG *************** Boss AI: Target = " + sub8(GetIsObjectValid(object1))));
		sub2(("GENERIC DEBUG *************** Boss AI: Talent = " + sub8(GetIsTalentValid(talent1))));
		if ((GetIsTalentValid(talent1) && GetIsObjectValid(object1))) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub2("GENERIC DEBUG *************** Boss AI: Targeted Power Success");
			return 1;
		}
	}
	sub2("GENERIC DEBUG *************** Boss AI: Targeted Failure");
	return 0;
}
...
int sub26() {
	sub2("GENERIC DEBUG *************** Boss AI: AOE Function Starting");
	talent talent1;
	object object1 = sub27();
	sub2(("GENERIC DEBUG *************** Boss AI: AOE Target = " + sub8(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub22(intGLOB_2, int2);
		if (GetIsTalentValid(talent1)) {
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub2("GENERIC DEBUG *************** Boss AI: AOE Success");
			return 1;
		}
	}
	sub2("GENERIC DEBUG *************** Boss AI: AOE Failure");
	return 0;
}
...
talent sub24(int intParam1) {
	...
	sub2(("GENERIC DEBUG *************** Last Force Power Used = " + sub8(nLastForce)));
	...
	sub2(("GENERIC DEBUG *************** Force Power Returned = " + sub8(GetIdFromTalent(talent1))));
	return talent1;
}
...
talent sub23(int intParam1) {
	...
	sub2("GENERIC DEBUG *************** Grenade Selection Failure");
	talent talent11;
	return talent11;
	return talent11;
}
...
talent sub22(int intParam1, int intParam2) {
	...
	if (((intParam1 == intGLOB_1) || (intParam1 == intGLOB_5))) {
		talRandom = sub23(intParam2);
		if (GetIsTalentValid(talRandom)) {
			sub2("GENERIC DEBUG *************** Boss AI: Grenade Talent Chosen");
			return talRandom;
		}
	}
	if (((intParam1 == intGLOB_2) || (intParam1 == intGLOB_5))) {
		...
		if (GetIsTalentValid(talRandom)) {
			sub2("GENERIC DEBUG *************** Boss AI: AOE Force Power Talent Chosen");
			return talRandom;
		}
	}
	if (((intParam1 == intGLOB_3) || (intParam1 == intGLOB_5))) {
		if ((d100(1) > 50)) {
			...
			if (GetIsTalentValid(talRandom)) {
				sub2("GENERIC DEBUG *************** Boss AI: Targeted Force Power Talent Chosen");
				return talRandom;
			}
			talRandom = sub24(intParam2);
			if (GetIsTalentValid(talRandom)) {
		...
		if ((sub17(OBJECT_SELF) == 1)) {
			sub2("GENERIC DEBUG *************** Boss AI: Melee Feat Talent Chosen");
			talRandom = GetCreatureTalentRandom(4356, OBJECT_SELF, 0);
		}
		else {
			sub2("GENERIC DEBUG *************** Boss AI: Range Feat Talent Chosen");
		...
		if (((intParam1 == intGLOB_4) || (intParam1 == intGLOB_5))) {
			...
			sub2("GENERIC DEBUG *************** Boss AI: No Feats Available");
		}
	}
	return talRandom;
}
...
object sub19() {
	...
	while (GetIsObjectValid(oShapeObject)) {
		if ((GetObjectSeen(oShapeObject, OBJECT_SELF) && (!GetIsDead(oShapeObject)))) {
			int3 = sub20(oShapeObject, 4.0);
			int4 = sub21(oShapeObject, 4.0);
...
int sub18() {
	sub2("GENERIC DEBUG *************** Boss AI: Grenade Function Starting");
	talent talent1;
	object object1 = sub19();
	sub2(("GENERIC DEBUG *************** Boss AI: Grenade Target = " + sub8(GetIsObjectValid(object1))));
	int int2;
	if (GetIsObjectValid(object1)) {
		if ((GetRacialType(object1) == 5)) {
			(int2 == 1);
		}
		talent1 = sub22(intGLOB_1, int2);
		if (GetIsTalentValid(talent1)) {
			sub2("GENERIC DEBUG *************** Clear 1460");
			ClearAllActions();
			ActionUseTalentOnObject(talent1, object1);
			sub2("GENERIC DEBUG *************** Boss AI: AOE Success");
			return 1;
...
int sub17(object objectParam1) {
	...
	sub2("GENERIC DEBUG *************** Return No Weapon Type");
	return 0;
}

int sub16() {
	object oInvItem;
	if (((((GetIsObjectValid(GetAttackTarget(OBJECT_SELF)) && (GetDistanceBetween(GetAttackTarget(OBJECT_SELF), OBJECT_SELF) <= 3.0)) && (sub17(OBJECT_SELF) != 1)) && (GetRacialType(OBJECT_SELF) == 6)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		oInvItem = GetFirstItemInInventory(OBJECT_SELF);
		while (GetIsObjectValid(oInvItem)) {
			sub2("GENERIC DEBUG *************** Checking Melee Weapon");
			if (((((((((((((((GetBaseItemType(oInvItem) == 9) || (GetBaseItemType(oInvItem) == 6)) || (GetBaseItemType(oInvItem) == 80)) || (GetBaseItemType(oInvItem) == 78)) || (GetBaseItemType(oInvItem) == 8)) || (GetBaseItemType(oInvItem) == 2)) || (GetBaseItemType(oInvItem) == 0)) || (GetBaseItemType(oInvItem) == 10)) || (GetBaseItemType(oInvItem) == 4)) || (GetBaseItemType(oInvItem) == 1)) || (GetBaseItemType(oInvItem) == 5)) || (GetBaseItemType(oInvItem) == 7)) || (GetBaseItemType(oInvItem) == 3)) || (GetBaseItemType(oInvItem) == 79))) {
				sub2("GENERIC DEBUG *************** Equipping Melee Weapon");
		...
		if (((((((sub17(OBJECT_SELF) != 2) && (GetLevelByClass(4, OBJECT_SELF) == 0)) && (GetLevelByClass(3, OBJECT_SELF) == 0)) && (GetLevelByClass(5, OBJECT_SELF) == 0)) && (GetDistanceBetween(GetAttemptedAttackTarget(), OBJECT_SELF) > 3.0)) && (!IsObjectPartyMember(OBJECT_SELF)))) {
			oInvItem = GetFirstItemInInventory(OBJECT_SELF);
			while (GetIsObjectValid(oInvItem)) {
				sub2("GENERIC DEBUG *************** Checking Ranged Weapon");
				if ((((((((((((((((GetBaseItemType(oInvItem) == 20) || (GetBaseItemType(oInvItem) == 12)) || (GetBaseItemType(oInvItem) == 77)) || (GetBaseItemType(oInvItem) == 19)) || (GetBaseItemType(oInvItem) == 16)) || (GetBaseItemType(oInvItem) == 21)) || (GetBaseItemType(oInvItem) == 13)) || (GetBaseItemType(oInvItem) == 24)) || (GetBaseItemType(oInvItem) == 14)) || (GetBaseItemType(oInvItem) == 15)) || (GetBaseItemType(oInvItem) == 18)) || (GetBaseItemType(oInvItem) == 23)) || (GetBaseItemType(oInvItem) == 17)) || (GetBaseItemType(oInvItem) == 22)) || (GetBaseItemType(oInvItem) == 17))) {
					sub2("GENERIC DEBUG *************** Equipping Ranged Weapon");
	...
	sub2("GENERIC DEBUG *************** Should not currently change weapons");
	return 0;
}
...
object sub15(int intParam1) {
	...
	if (((!GetIsEnemy(oNearest, OBJECT_SELF)) && (intParam1 == 1))) {
		sub2("GENERIC DEBUG *************** Searching for Alternate Target");
		oNearest = GetNearestCreature(3, 1, OBJECT_SELF, 1, 0, 6, 0xFFFFFFFF, 0xFFFFFFFF);
		sub2(("GENERIC DEBUG *************** Alternate Target = " + sub3(oNearest)));
	}
	sub2(("GENERIC DEBUG *************** Heal Drain Target = " + sub8(intParam1)));
	sub2(("GENERIC DEBUG *************** Get Active Party Member: " + sub3(oNearest)));
	return oNearest;
}
...
int sub14(int intParam1, object objectParam2) {
	if (GetIsObjectValid(objectParam2)) {
		...
		if ((intParam1 == intGLOB_114)) {
			...
			if ((intParam1 == intGLOB_115)) {
				...
				if ((intParam1 == intGLOB_116)) {
					sub2(("GENERIC DEBUG *************** Starting Heal Talent Checks " + sub3(OBJECT_SELF)));
					talSpell = TalentSpell(28);
					talent2 = TalentSpell(10);
					if ((GetRacialType(OBJECT_SELF) != 5)) {
					...
					int3 = 0;
					if ((GetCreatureHasTalent(talSpell, OBJECT_SELF) || GetCreatureHasTalent(talent2, OBJECT_SELF))) {
						sub2("GENERIC DEBUG *************** I have Heal or Cure");
						int3 = 1;
						if (GetCreatureHasTalent(talSpell, OBJECT_SELF)) {
							talent8 = talSpell;
						}
						...
						if (((GetIsTalentValid(talBest) || GetCreatureHasTalent(talent6, OBJECT_SELF)) || GetCreatureHasTalent(talent7, OBJECT_SELF))) {
							if ((objectParam2 == OBJECT_SELF)) {
								if ((GetCreatureHasTalent(talent7, OBJECT_SELF) && (!IsObjectPartyMember(OBJECT_SELF)))) {
									sub2("GENERIC DEBUG *************** I have Death Field");
									int3 = 1;
									int4 = 1;
									talent8 = talent7;
								}
									...
									if ((GetCreatureHasTalent(talent6, OBJECT_SELF) && (!IsObjectPartyMember(OBJECT_SELF)))) {
										sub2("GENERIC DEBUG *************** I have Drain Life");
										int3 = 1;
										int4 = 1;
										talent8 = talent6;
									}
									else {
										sub2("GENERIC DEBUG *************** I have a Med Pack");
										int3 = 1;
										talent8 = talBest;
									}
								}
					...
					if ((intParam1 == intGLOB_117)) {
						...
						if (((((!GetHasSpellEffect(36, OBJECT_SELF)) && (!GetHasSpellEffect(33, OBJECT_SELF))) && (!GetHasSpellEffect(22, OBJECT_SELF))) && (int3 == 1))) {
							sub2("GENERIC DEBUG *************** I do have VALOR");
							int3 = 1;
						}
						else {
							sub2("GENERIC DEBUG *************** I do not have VALOR");
							int3 = 0;
						}
					}
				}
		...
		if (((int3 == 1) && (int4 == 0))) {
			sub2("GENERIC DEBUG *************** Clear 2300");
			int nTalent = GetIdFromTalent(talent8);
			sub2(("GENERIC DEBUG *************** Spells.2DA ID = " + sub8(nTalent)));
			ClearAllActions();
			...
			if (((int3 == 1) && (int4 == 1))) {
				objectParam2 = sub15(1);
				if (GetIsObjectValid(objectParam2)) {
					sub2(("GENERIC DEBUG *************** Hostile Heal Targeted On: " + sub3(objectParam2)));
					sub2("GENERIC DEBUG *************** Clear 2400");
					ClearAllActions();
		...
		if ((GetIsTalentValid(talent8) && (!GetHasSpellEffect(GetIdFromTalent(talent8), OBJECT_SELF)))) {
			if (GetIsObjectValid(objectParam2)) {
				sub2("GENERIC DEBUG *************** Clear 2500");
				ClearAllActions();
				sub2(((("GENERIC DEBUG *************** Target = " + GetName(objectParam2)) + " Talent Code = ") + IntToString(int2)));
				ActionUseTalentOnObject(talent8, OBJECT_SELF);
				return 1;
			}
		}
	}
	sub2(((((("GENERIC DEBUG *************** " + sub3(OBJECT_SELF)) + " VP = ") + sub8(GetCurrentHitPoints(OBJECT_SELF))) + "/") + sub8(GetMaxHitPoints(OBJECT_SELF))));
	sub2("GENERIC DEBUG *************** Healing Not Used");
	return 0;
}

object sub13() {
	sub2("GENERIC DEBUG ***************  Starting Injury Check Function");
...
int sub12(object objectParam1) {
	sub2("GENERIC DEBUG *************** Boss AI Start");
	object object1 = sub13();
	if (GetIsObjectValid(object1)) {
		if (sub14(intGLOB_116, object1)) {
			return 1;
		}
	}
	if (sub16()) {
	...
	sub2("GENERIC DEBUG *************** Boss AI: Fall Through");
	return sub31(OBJECT_INVALID);
}

int sub11() {
	sub2("GENERIC DEBUG *************** Malak AI Start");
	...
	sub2(("GENERIC DEBUG *************** Malak Distance to PC = " + FloatToString(GetDistanceBetween(OBJECT_SELF, oPC), 4, 4)));
	if ((fDistance > 10.0)) {
		int6 = 1;
	}
	if ((int6 == 1)) {
		sub2("GENERIC DEBUG *************** Clear 1480");
		ClearAllActions();
		if (((GetHasSpellEffect(8, oPC) || GetHasSpellEffect(34, oPC)) || GetHasSpellEffect(37, oPC))) {
			...
			if (GetIsTalentValid(talSpell)) {
				sub2("GENERIC DEBUG *************** Using Breach");
			...
			if ((fDistance > 10.0)) {
				...
				if ((int14 != (-1))) {
					...
					if (GetIsTalentValid(talent3)) {
						sub2("GENERIC DEBUG *************** Malak Using Force Power");
	...
	if ((int7 == 1)) {
		sub2("GENERIC DEBUG *************** Malak Attacking");
		ActionAttack(oPC, 0);
		return 1;
	}
	sub2("GENERIC DEBUG *************** Malak AI Drop Out");
	return 0;
}

int sub10() {
	int int1 = 0;
	if (((sub6(intGLOB_108) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub6(intGLOB_105))) {
...
int sub7() {
	sub2("GENERIC DEBUG *************** Starting Forcefield Search");
	sub2(((("GENERIC DEBUG *************** Shield Boolean (" + sub8(intGLOB_106)) + ") = ") + sub8(sub6(intGLOB_106))));
	if (((sub6(intGLOB_106) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub1(object objectParam1) {
	sub2("");
	sub2(("GENERIC DEBUG *************** START DETERMINE COMBAT ROUND " + sub3(OBJECT_SELF)));
	sub4();
	{
		int nStyle = GetPartyAIStyle();
		int nNPCStyle = GetNPCAIStyle(OBJECT_SELF);
		sub2(("GENERIC DEBUG *************** AI STYLE = " + sub5(OBJECT_SELF)));
		if (((((!sub6(intGLOB_101)) && (!sub6(intGLOB_102))) && (!sub6(intGLOB_103))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub6(intGLOB_111) == 1)) {
					if ((sub11() == 1)) {
						return;
					}
				}
				if ((sub6(intGLOB_105) == 1)) {
					if ((sub12(objectParam1) == 1)) {
						return;
					}
				}
				if ((nNPCStyle == 0)) {
					if ((sub31(objectParam1) == 1)) {
						return;
					}
				}
				else {
					if ((nNPCStyle == 4)) {
						if ((sub67(objectParam1) == 1)) {
							return;
						}
					}
					else {
		...
		if (sub70()) {
			sub2("GENERIC DEBUG *************** DETERMINE COMBAT ROUND END");
		}
		sub2("GENERIC DEBUG *************** WARNING DETERMINE COMBAT ROUND FAILURE");
	}
}
...
void main() {
	...
	if ((int1 == 1001)) {
		...
		int int8 = GetGlobalBoolean("STA_MALAK_DRAIN");
		string sName = GetName(oNearestSta_malak_drain);
		object object7 = GetObjectByTag(("sta_plc_captive" + sName), 0);
		object oSta_invis_conv_2 = GetObjectByTag("sta_invis_conv_2", 0);
		int int10 = GetGlobalNumber("STA_MALAK_JEDI");
		if ((((nCurFP <= 50) && GetIsObjectValid(oNearestSta_malak_drain)) && (GetCurrentHitPoints(oPC) > (GetMaxHitPoints(oPC) / 2)))) {
			ChangeToStandardFaction(OBJECT_SELF, 5);
			SetGlobalBoolean("STA_MALAK_DRAIN", 1);
			ChangeToStandardFaction(object7, 5);
			...
			if ((GetDistanceToObject(oNearestSta_malak_drain) <= 5.0)) {
				...
				if ((int10 == 0)) {
					...
					DelayCommand(1.0, AssignCommand(oNearestSta_jedi_conv, ActionStartConversation(oNearestSta_jedi_conv, "", 0, 0, 0, "", "", "", "", "", "")));
				}
			}
			else {
				DelayCommand(1.0, SetCommandable(1, OBJECT_SELF));
				DelayCommand(1.0, ActionMoveToObject(oNearestSta_malak_drain, 1, 1.0));
				DelayCommand(1.0, SetCommandable(0, OBJECT_SELF));
			}
		}
		else {
			if (((((nGlobal > 0) && (!GetIsInConversation(oNearestSta_jedi_conv))) && (!GetIsInConversation(OBJECT_SELF))) && (int8 != 1))) {
				if ((GetDistanceToObject(oPC) > 15.0)) {
					ActionMoveToObject(oPC, 1, 13.0);
					ActionDoCommand(sub1(oPC));
				}
			}
		}
	}
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							int int19 = GetCurrentForcePoints(OBJECT_SELF);
							object object11 = GetNearestObjectByTag("sta_jedi_conv", OBJECT_SELF, 1);
							int int21 = GetGlobalNumber("STA_MALAK_JEDI");
							object object13 = GetFirstPC();
							object object15 = GetObjectByTag("sta_invis_conv_2", 0);
							string string3 = GetName(oNearestSta_malak_drain);
							object object17 = GetObjectByTag(("sta_plc_captive" + string3), 0);
							if (((nCurHP <= 100) || (int19 <= 50))) {
								if (GetIsObjectValid(oNearestSta_malak_drain)) {
									ChangeToStandardFaction(OBJECT_SELF, 5);
									SetGlobalBoolean("STA_MALAK_DRAIN", 1);
									ChangeToStandardFaction(object17, 5);
									DelayCommand(0.3, ClearAllActions());
									DelayCommand(0.4, ActionSurrenderToEnemies());
									DelayCommand(0.4, SetCommandable(0, OBJECT_SELF));
									DelayCommand(0.5, CancelCombat(object13));
									DelayCommand(0.5, CancelCombat(OBJECT_SELF));
									DelayCommand(0.5, ClearAllEffects());
									if ((GetDistanceToObject(oNearestSta_malak_drain) <= 5.0)) {
										DelayCommand(1.0, AssignCommand(object13, ClearAllActions()));
										if ((int21 == 0)) {
											DelayCommand(1.0, AssignCommand(object15, ActionStartConversation(object15, "", 0, 0, 0, "", "", "", "", "", "")));
										}
										else {
											DelayCommand(1.0, AssignCommand(object11, ActionStartConversation(object11, "", 0, 0, 0, "", "", "", "", "", "")));
										}
									}
									else {
										DelayCommand(1.0, SetCommandable(1, OBJECT_SELF));
									...
									if (((nCurHP <= 10) && (!GetIsInConversation(OBJECT_SELF)))) {
										...
										DelayCommand(0.4, ActionSurrenderToEnemies());
										DelayCommand(0.4, CancelCombat(object13));
										DelayCommand(0.4, CancelCombat(OBJECT_SELF));
										DelayCommand(0.4, ClearAllEffects());
										DelayCommand(0.4, PlayAnimation(32, 1.0, 999.0));
										DelayCommand(0.5, SetCommandable(0, OBJECT_SELF));
										DelayCommand(3.5, AssignCommand(object15, ActionStartConversation(object15, "", 0, 0, 0, "", "", "", "", "", "")));
									}
								}
							}
						}
