...
object sub1(int intParam1) {
	...
	int int4 = 0;
	int int5 = 0;
	if ((GetIsObjectValid(object3) && (GetCurrentHitPoints(object3) > 0))) {
		if (((intParam1 == 0) || (!GetIsDebilitated(object3)))) {
			(int1++);
			int4 = 1;
		}
	}
	if ((GetIsObjectValid(object5) && (GetCurrentHitPoints(object5) > 0))) {
		if (((intParam1 == 0) || (!GetIsDebilitated(object3)))) {
			(int1++);
			int5 = 1;
		}
	}
	if ((GetIsObjectValid(oNPC) && (GetCurrentHitPoints(oNPC) > 0))) {
		if (((intParam1 == 0) || (!GetIsDebilitated(object3)))) {
			(int1++);
			int3 = 1;
		}
...
void main() {
	...
	if ((int1 == 1001)) {
		if (((!GetIsInCombat(OBJECT_SELF)) && (GetDistanceToObject(object1) >= 15.0))) {
			ActionMoveToObject(object1, 1, 13.0);
		}
		else {
			if (((!GetIsInCombat(OBJECT_SELF)) && (GetDistanceToObject(object1) < 15.0))) {
				ClearAllActions();
