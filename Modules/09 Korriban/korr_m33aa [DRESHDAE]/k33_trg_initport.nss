...
void main() {
	...
	if (((GetEnteringObject() == oNPC) && (GetGlobalBoolean("K_KOR_PORT_FEE") == 0))) {
		object oKor33_portauthor = GetObjectByTag("kor33_portauthor", 0);
		AssignCommand(oKor33_portauthor, ClearAllActions());
		sub1("kor33_portauthor", "", OBJECT_INVALID);
	}
}
