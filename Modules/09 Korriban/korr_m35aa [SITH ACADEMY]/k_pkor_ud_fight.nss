...
// Prototypes
void sub81(string stringParam1);
...
void main() {
	...
	if ((int1 == 1001)) {
		object oKor35_studfight1 = GetObjectByTag("kor35_studfight1", 0);
		object oKor35_studfight2 = GetObjectByTag("kor35_studfight2", 0);
		if ((((!sub1(OBJECT_SELF, intGLOB_118)) && (!GetIsInConversation(OBJECT_SELF))) && (!GetGlobalBoolean("KOR_END_HOSTILE")))) {
			int nRandom = d3(1);
			if ((nRandom == 1)) {
				ClearAllActions();
				ActionDoCommand(sub2(OBJECT_SELF, intGLOB_118, 1));
				ActionDoCommand(ChangeToStandardFaction(oKor35_studfight1, 2));
				ActionDoCommand(ChangeToStandardFaction(oKor35_studfight2, 4));
				ActionDoCommand(AssignCommand(oKor35_studfight1, sub3(oKor35_studfight2)));
				ActionWait(6.0);
				ActionDoCommand(ChangeToStandardFaction(oKor35_studfight1, 5));
				ActionDoCommand(ChangeToStandardFaction(oKor35_studfight2, 5));
				ActionDoCommand(sub2(OBJECT_SELF, intGLOB_118, 0));
			}
			else {
				if ((nRandom == 2)) {
					ClearAllActions();
					ActionDoCommand(sub2(OBJECT_SELF, intGLOB_118, 1));
					vector vPosition = GetPosition(oKor35_studfight1);
					ActionDoCommand(SetFacingPoint(vPosition));
					ActionDoCommand(ChangeToStandardFaction(oKor35_studfight1, 5));
					ActionDoCommand(ChangeToStandardFaction(oKor35_studfight2, 5));
					int int8 = (GetMaxHitPoints(oKor35_studfight1) - GetCurrentHitPoints(oKor35_studfight1));
					int int11 = (GetMaxHitPoints(oKor35_studfight2) - GetCurrentHitPoints(oKor35_studfight2));
					if ((int8 > 0)) {
						effect efHeal = EffectHeal(int8);
						ApplyEffectToObject(0, efHeal, oKor35_studfight1, 0.0);
					}
					if ((int11 > 0)) {
						effect effect3 = EffectHeal(int11);
						ApplyEffectToObject(0, effect3, oKor35_studfight2, 0.0);
					}
					ActionPlayAnimation(5, 1.0, 6.0);
					ActionDoCommand(sub2(OBJECT_SELF, intGLOB_118, 0));
				}
				else {
					if ((nRandom == 3)) {
						ClearAllActions();
						ActionDoCommand(sub2(OBJECT_SELF, intGLOB_118, 1));
						vector struct4 = GetPosition(oKor35_studfight2);
						ActionDoCommand(ChangeToStandardFaction(oKor35_studfight1, 5));
						ActionDoCommand(ChangeToStandardFaction(oKor35_studfight2, 5));
						ActionDoCommand(SetFacingPoint(struct4));
						int int14 = (GetMaxHitPoints(oKor35_studfight1) - GetCurrentHitPoints(oKor35_studfight1));
						int int17 = (GetMaxHitPoints(oKor35_studfight2) - GetCurrentHitPoints(oKor35_studfight2));
						if ((int14 > 0)) {
							effect effect5 = EffectHeal(int14);
							ApplyEffectToObject(0, effect5, oKor35_studfight1, 0.0);
						}
						if ((int17 > 0)) {
							effect effect7 = EffectHeal(int17);
							ApplyEffectToObject(0, effect7, oKor35_studfight2, 0.0);
						}
						ActionPlayAnimation(5, 1.0, 6.0);
						ActionDoCommand(sub2(OBJECT_SELF, intGLOB_118, 0));
					}
