...
void main() {
	...
	if (((((GetEnteringObject() == oNPC) && (!sub1(OBJECT_SELF, intGLOB_1))) && GetIsObjectValid(oKor35_captive9)) && (!GetGlobalBoolean("KOR_END_HOSTILE")))) {
		sub2(OBJECT_SELF, intGLOB_1, 1);
		sub3("kor35_duelconv", "", OBJECT_INVALID);
	}
}
