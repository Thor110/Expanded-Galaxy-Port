...
void main() {
	...
	if (((((GetEnteringObject() == oNPC) && (sub1() == 0)) && (GetGlobalNumber("KOR_SHAARDAN_SWORD") == 2)) && (GetGlobalNumber("KOR33_SHAARDAN") < 4))) {
		sub3(1);
		...
		if (GetIsObjectValid(oKor35_shaardan)) {
			...
			AssignCommand(oKor35_utharwynn, ClearAllActions());
			sub5("kor35_utharwynn", "", OBJECT_INVALID);
		}
	}
}
