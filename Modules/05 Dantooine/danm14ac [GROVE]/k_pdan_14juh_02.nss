			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub12(intGLOB_46, 1));
					}
					else {
	...
	if ((!sub9(intGLOB_55))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub9(intGLOB_52)) {
				...
				if (((nLocal < int4) && (!sub9(intGLOB_52)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub9(intGLOB_53), 2.5, float3);
			if (sub9(intGLOB_46)) {
...
int sub73() {
	...
	if ((sub9(intGLOB_101) && (!sub9(intGLOB_102)))) {
		if (sub74()) {
			return 1;
		}
	}
...
int sub71(object objectParam1) {
	...
	if (sub17(intGLOB_117, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub17(intGLOB_115, object1)) {
			return 1;
		}
	}
	object object4 = sub16();
	if (GetIsObjectValid(object4)) {
		if (sub17(intGLOB_116, object4)) {
			return 1;
		}
	}
	object3 = sub30();
	...
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub25(intGLOB_2, 1);
		}
		else {
			talent1 = sub25(intGLOB_2, 0);
		}
	}
	else {
		...
		if (GetIsObjectValid(object3)) {
			...
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub25(intGLOB_3, 1);
			}
			else {
				talent1 = sub25(intGLOB_3, 0);
			}
		}
	}
...
int sub34(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub17(intGLOB_115, oNPC)) {
			return 1;
		}
	}
	oNPC = sub16();
	if (GetIsObjectValid(oNPC)) {
		if (sub17(intGLOB_116, oNPC)) {
			return 1;
		}
	}
	talent1 = sub36(0);
...
int sub13() {
	int int1 = 0;
	if (((sub9(intGLOB_108) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub9(intGLOB_105))) {
...
int sub10() {
	...
	sub5(((("GENERIC DEBUG *************** Shield Boolean (" + sub11(intGLOB_106)) + ") = ") + sub11(sub9(intGLOB_106))));
	if (((sub9(intGLOB_106) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub4(object objectParam1) {
	...
	sub7();
	{
		...
		if (((((!sub9(intGLOB_101)) && (!sub9(intGLOB_102))) && (!sub9(intGLOB_103))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub9(intGLOB_111) == 1)) {
					if ((sub14() == 1)) {
						return;
					}
				}
				if ((sub9(intGLOB_105) == 1)) {
...
void main() {
	...
	if ((IsObjectPartyMember(oEntering) && sub1())) {
		AwardStealthXP(GetFirstPC());
		ChangeToStandardFaction(oDan14_juhani, 1);
		AssignCommand(oDan14_juhani, ClearAllActions());
		AssignCommand(oDan14_juhani, sub4(OBJECT_INVALID));
	}
}
