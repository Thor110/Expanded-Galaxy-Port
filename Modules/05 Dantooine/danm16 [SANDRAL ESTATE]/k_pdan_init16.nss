...
void main() {
	object oNearestDan16_rahasia = GetNearestObjectByTag("dan16_rahasia", OBJECT_SELF, 1);
	if (sub1()) {
		AssignCommand(oNearestDan16_rahasia, ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", ""));
	}
}
