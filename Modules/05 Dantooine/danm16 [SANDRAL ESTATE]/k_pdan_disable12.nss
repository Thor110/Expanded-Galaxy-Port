...
void main() {
	int int1 = sub1(10, 0);
	sub2(int1);
	SetGlobalBoolean("DAN_RSENT", 1);
	int int3 = 1;
	object oNearestDan16_room3 = GetNearestObjectByTag("dan16_room3", OBJECT_SELF, 1);
	while (GetIsObjectValid(oNearestDan16_room3)) {
		DelayCommand(0.5, ApplyEffectToObject(0, EffectVisualEffect(4003, 0), oNearestDan16_room3, 0.0));
		(int3++);
		oNearestDan16_room3 = GetNearestObjectByTag("dan16_room3", OBJECT_SELF, int3);
	}
}
