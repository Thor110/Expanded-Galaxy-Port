...
for /f %%f in ('dir /b changes') do copy /y "changes\%%f" "Expanded Galaxy Port Installer\tslpatchdata\%%f"

echo updating changes.ini files...

for /f "delims=|" %%o in (override.txt) do (
  echo %%o>> "Expanded Galaxy Port Installer\tslpatchdata\changes-amazon.ini"
  echo %%o>> "Expanded Galaxy Port Installer\tslpatchdata\changes-android.ini"
  echo %%o>> "Expanded Galaxy Port Installer\tslpatchdata\changes-disc.ini"
