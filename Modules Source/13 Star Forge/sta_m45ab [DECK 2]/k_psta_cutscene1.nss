...
void main() {
	...
	object oSta_trg_cutscne2 = GetObjectByTag("sta_trg_cutscne2", 0);
	if ((((GetEnteringObject() == oNPC) && (!sub1(OBJECT_SELF, intGLOB_118))) && (!sub1(oSta_trg_cutscne2, intGLOB_118)))) {
		sub2(OBJECT_SELF, intGLOB_118, 1);
		AssignCommand(GetObjectByTag("sta45b_cutscene1", 0), ActionStartConversation(OBJECT_SELF, "", 0, 0, 0, "", "", "", "", "", ""));
	}
}
