...
// Prototypes
void sub80(string stringParam1);
...
int sub67(object objectParam1) {
	...
	sub2("GENERIC DEBUG *************** Grenade AI Fall Through");
	return sub31(objectParam1);
}
...
int sub7() {
	...
	if (((sub6(intGLOB_106) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		...
		if (GetCreatureHasTalent(talSpell, OBJECT_SELF)) {
			...
			sub2("GENERIC DEBUG *************** Forcefield Search Fallthrough");
			sub9(intGLOB_106, 1);
			return 0;
		}
	}
	...
	sub4();
	{
		...
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub7() == 1)) {
					sub2("GENERIC DEBUG *************** Terminating AI from Shields");
					return;
				}
				if ((sub10() == 1)) {
					return;
...
void main() {
	...
	if ((int1 == 1001)) {
		...
		int int6 = GetGlobalBoolean("STA_MALAK_DRAIN");
		if (((((nGlobal > 0) && (!GetIsInConversation(oNearestSta_jedi_conv))) && (!GetIsInConversation(OBJECT_SELF))) && (int6 != 1))) {
			if ((GetDistanceToObject(oPC) > 15.0)) {
				...
				if ((GetCurrentAction(OBJECT_SELF) == 65534)) {
					sub79("QUEUE EMPTY - ATTACKING", 10, 10, 1.0);
					sub79(("FORCE POINTS = " + IntToString(GetCurrentForcePoints(OBJECT_SELF))), 12, 12, 1.5);
					ActionAttack(oPC, 0);
				}
			}
		}
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							object object7 = GetNearestObjectByTag("sta_jedi_conv", OBJECT_SELF, 1);
							int int16 = GetGlobalNumber("STA_MALAK_JEDI");
							...
							object object13 = GetObjectByTag(("sta_plc_captive" + sName), 0);
								...
								if (GetIsObjectValid(oNearestSta_malak_drain)) {
									...
									if ((GetDistanceToObject(oNearestSta_malak_drain) <= 5.0)) {
										...
										if ((int16 == 0)) {
											...
											DelayCommand(1.0, AssignCommand(object7, ActionStartConversation(object7, "", 0, 0, 0, "", "", "", "", "", "")));
										}
									}
									else {
									...
									if (((nCurHP <= 10) && (!GetIsInConversation(OBJECT_SELF)))) {
										...
										DelayCommand(0.4, SurrenderRetainBuffs());
										DelayCommand(0.4, CancelCombat(object9));
										DelayCommand(0.4, CancelCombat(OBJECT_SELF));
										DelayCommand(0.4, PlayAnimation(32, 1.0, (-1.0)));
										DelayCommand(0.5, SetCommandable(0, OBJECT_SELF));
										DelayCommand(3.5, AssignCommand(oSta_invis_conv_2, ActionStartConversation(oSta_invis_conv_2, "", 0, 0, 0, "", "", "", "", "", "")));
									}
								}
							}
						}
							...
							if ((int1 == 1007)) {
								...
								if ((int1 == 1008)) {
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											int int20 = GetLastSpell();
											if ((((int20 == 15) || (int20 == 11)) || (int20 == 4))) {
												sub79("SPELL FOUND", 10, 10, 2.0);
											}
										}
										else {
											if ((int1 == intGLOB_138)) {
