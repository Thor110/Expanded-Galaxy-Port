		...
		if ((int1 == 1002)) {
			...
			if ((int1 == 1003)) {
				...
				if ((int1 == 1004)) {
					...
					if ((int1 == 1005)) {
						if ((GetGlobalNumber("STA_JEDI_ATTACK") == 10)) {
							SetMinOneHP(OBJECT_SELF, 0);
							DelayCommand(0.1, ApplyEffectToObject(0, EffectDeath(0, 1), OBJECT_SELF, 0.0));
						}
					}
					else {
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								ChangeToStandardFaction(oK_sta_darkjedi1, 5);
								DelayCommand(0.2, SetDialogPlaceableCamera(21));
								AssignCommand(oSta_cutscene2, DelayCommand(2.1, ActionResumeConversation()));
							}
							else {
								if ((int1 == 1008)) {
								}
