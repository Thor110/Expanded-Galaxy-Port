		...
		if ((int1 == 1002)) {
			...
			if ((int1 == 1003)) {
				if ((GetGlobalNumber("STA_JEDI_ATTACK") == 8)) {
					int int5 = (GetMaxForcePoints(OBJECT_SELF) - GetCurrentForcePoints(OBJECT_SELF));
					effect effect1 = EffectHealForcePoints(int5);
					ApplyEffectToObject(0, effect1, OBJECT_SELF, 0.0);
					ClearAllActions();
					sub1(intGLOB_103, 1);
					object oK_sta_lightjedi2 = GetObjectByTag("k_sta_lightjedi2", 0);
					talent talSpell = TalentSpell(15);
					ActionUseTalentOnObject(talSpell, oK_sta_lightjedi2);
					unknown unknown1 = EventUserDefined(452);
					DelayCommand(5.0, SignalEvent(oK_sta_lightjedi2, unknown1));
					DelayCommand(5.0, sub1(intGLOB_103, 0));
				}
			}
			else {
				if ((int1 == 1004)) {
									...
									if ((int1 == 1009)) {
										...
										if ((int1 == 1010)) {
											...
											if ((int1 == intGLOB_138)) {
												...
												if ((int1 == 451)) {
													effect effect3 = EffectDamageForcePoints(100);
