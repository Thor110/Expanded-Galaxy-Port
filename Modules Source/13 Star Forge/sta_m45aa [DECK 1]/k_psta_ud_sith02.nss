					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								object oSta45a_Sith07 = GetObjectByTag("sta45a_Sith07", 0);
								if (((!GetIsDead(oSta_Jedi002)) && GetIsDead(oSta45a_Sith07))) {
									ApplyEffectToObject(2, EffectDeath(0, 1), oSta_Jedi002, 0.0);
								}
							}
							else {
								if ((int1 == 1008)) {
