...
void main() {
	...
	ApplyEffectToObject(2, EffectStunned(), GetObjectByTag("mission", 0), 50.0);
	ChangeToStandardFaction(GetObjectByTag("mission", 0), 4);
	ChangeToStandardFaction(GetObjectByTag("zaalbar", 0), 2);
	AssignCommand(GetObjectByTag("zaalbar", 0), sub1(OBJECT_INVALID));
	ActionWait(3.0);
