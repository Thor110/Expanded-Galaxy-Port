...
void main() {
	...
	object oTat17aa_bastplot = GetObjectByTag("tat17aa_bastplot", 0);
	if (((GetIsObjectValid(oTat17aa_bastplot) == 1) && GetIsPC(oEntering))) {
		sub1("tat17aa_bastplot", "", OBJECT_INVALID);
