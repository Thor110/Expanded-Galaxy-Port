...
void sub4() {
	...
	object oNearestBastila_Starter = GetNearestObjectByTag("Bastila_Starter", OBJECT_SELF, 1);
	if (GetIsObjectValid(oNearestBastila_Starter)) {
		AssignCommand(oNearestBastila_Starter, ActionStartConversation(oPC, "ebo_bast_vision", 0, 0, 1, "Bastila", "", "", "", "", "", 0));
	}
}
...
void main() {
	sub1("Bastila Talk Script Firing v4.0", 5, 5, 4.0);
