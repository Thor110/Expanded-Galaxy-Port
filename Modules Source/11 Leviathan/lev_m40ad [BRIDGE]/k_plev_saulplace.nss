...
void main() {
	...
	while ((int1 < GetPartyMemberCount())) {
		...
		sub1(GetPartyMemberByIndex(int1), GetLocation(GetObjectByTag("WP_PartyLeader", 0)));
		(int1++);
	}
	AssignCommand(oLev40_bdgdoor, ActionCloseDoor(oLev40_bdgdoor));
	SetLocked(oLev40_bdgdoor, 1);
