...
void main() {
	...
	if (((GetIsPC(oEntering) && (GetGlobalNumber("LEV_ESCAPE") == 6)) && (!sub1(OBJECT_SELF)))) {
		sub2(OBJECT_SELF, 1);
		AssignCommand(oLev40_droidtalker, ActionStartConversation(oLev40_droidtalker, "lev40_hkcs_dlg", 0, 0, 0, "", "", "", "", "", ""));
	}
}
