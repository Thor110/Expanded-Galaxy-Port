...
void main() {
	...
	object oLev40_candtalker = GetObjectByTag("lev40_candtalker", 0);
	if (((GetIsPC(oEntering) && (GetGlobalNumber("LEV_ELEVATOR") == 1)) && (!sub1(OBJECT_SELF)))) {
		sub2("SPEAKING...", 5, 5, 5.0);
		sub3(OBJECT_SELF, 1);
		SetPartyLeader((-1));
		AssignCommand(oLev40_candtalker, ActionStartConversation(oLev40_candtalker, "", 0, 0, 0, "", "", "", "", "", ""));
	}
}
