...
void main() {
	object oDan14_sherruk = GetObjectByTag("dan14_sherruk", 0);
	if (((IsObjectPartyMember(GetEnteringObject()) && (GetGlobalNumber("DAN_MAND_STATE") == 4)) && (sub1(oDan14_sherruk) == 0))) {
		int int4 = 0;
		while ((int4 <= 2)) {
			CancelCombat(GetPartyMemberByIndex(int4));
			(int4++);
		}
		AssignCommand(oDan14_sherruk, ActionStartConversation(GetFirstPC(), "", 0, 0, 1, "", "", "", "", "", ""));
	}
}
