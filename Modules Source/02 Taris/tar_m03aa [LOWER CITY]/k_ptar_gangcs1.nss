...
void sub3(object objectParam1, object objectParam2, int intParam3);
...
void sub3(object objectParam1, object objectParam2, int intParam3) {
	...
	AssignCommand(objectParam1, ActionDoCommand(sub4(objectParam2, intParam3)));
}
...
void main() {
	object oTar03_bekcs0 = GetObjectByTag("tar03_bekcs0", 0);
	object oTar03_vulkcut0 = GetObjectByTag("tar03_vulkcut0", 0);
  //vulkar power attack
	sub1(oTar03_vulkcut0, oTar03_bekcs0, TalentFeat(28), 1);
  //
	DelayCommand(1.0, sub3(oTar03_bekcs0, oTar03_vulkcut0, 0));
	DelayCommand(1.0, sub3(GetObjectByTag("tar03_bekcs1", 0), GetObjectByTag("tar03_vulkcut1", 0), 0));
	DelayCommand(1.0, sub3(GetObjectByTag("tar03_vulkcut2", 0), GetObjectByTag("tar03_bekcs2", 0), 0));
