...
void main() {
	...
	object oKas25_wp_wraid3 = GetWaypointByTag("kas25_wp_wraid3");
	AssignCommand(oKas25_wraid, ActionMoveToObject(oKas25_wp_wraid3, 1, 1.0));
	AssignCommand(oKas25_wraid, ActionDoCommand(sub1(OBJECT_INVALID)));
	ChangeToStandardFaction(oKas25_wraid, 1);
}
