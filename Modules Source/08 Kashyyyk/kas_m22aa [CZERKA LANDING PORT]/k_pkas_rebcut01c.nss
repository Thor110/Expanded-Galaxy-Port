...
void main() {
	object oKas22_rebczer_04 = GetObjectByTag("kas22_rebczer_04", 0);
	object oKas22_wookfht_04 = GetObjectByTag("kas22_wookfht_04", 0);
	AssignCommand(oKas22_wookfht_04, ActionPlayAnimation(107, 1.0, 0.0));
	DelayCommand(1.0, AssignCommand(oKas22_wookfht_04, ClearAllActions()));
	DelayCommand(1.0, AssignCommand(oKas22_wookfht_04, sub1(oKas22_rebczer_04)));
}
