			...
			if ((nRandom == 3)) {
				...
				if ((((nRandom == 4) || (nRandom == 5)) && (GetRacialType(OBJECT_SELF) != 5))) {
					if ((GetGender(OBJECT_SELF) == 0)) {
						...
						ActionDoCommand(sub9(intGLOB_73, 1));
					}
					else {
	...
	if ((!sub6(intGLOB_82))) {
		...
		if ((GetDistanceToObject2D(object3) <= 2.5)) {
			...
			if (sub6(intGLOB_79)) {
				...
				if (((nLocal < int4) && (!sub6(intGLOB_79)))) {
		...
		if (GetIsObjectValid(GetWaypointByTag(string9))) {
			...
			ActionForceMoveToObject(object3, sub6(intGLOB_80), 2.5, float3);
			if (sub6(intGLOB_73)) {
...
int sub70() {
	...
	if ((sub6(intGLOB_128) && (!sub6(intGLOB_129)))) {
		if (sub71()) {
			return 1;
		}
	}
...
int sub68(object objectParam1) {
	...
	if (sub14(intGLOB_144, OBJECT_SELF)) {
		return 1;
	}
	if (GetIsObjectValid(object1)) {
		if (sub14(intGLOB_142, object1)) {
			return 1;
		}
	}
	object object4 = sub13();
	if (GetIsObjectValid(object4)) {
		if (sub14(intGLOB_143, object4)) {
			return 1;
		}
	}
	object3 = sub27();
	...
	if (GetIsObjectValid(object3)) {
		if ((GetRacialType(object3) == 5)) {
			talent1 = sub22(intGLOB_29, 1);
		}
		else {
			talent1 = sub22(intGLOB_29, 0);
		}
	}
	else {
		...
		if (GetIsObjectValid(object3)) {
			...
			if ((GetRacialType(object3) == 5)) {
				talent1 = sub22(intGLOB_30, 1);
			}
			else {
				talent1 = sub22(intGLOB_30, 0);
			}
		}
	}
...
int sub31(object objectParam1) {
	...
	if (GetIsObjectValid(oNPC)) {
		if (sub14(intGLOB_142, oNPC)) {
			return 1;
		}
	}
	oNPC = sub13();
	if (GetIsObjectValid(oNPC)) {
		if (sub14(intGLOB_143, oNPC)) {
			return 1;
		}
	}
	talent1 = sub33(0);
...
int sub10() {
	int int1 = 0;
	if (((sub6(intGLOB_135) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		if (((GetHitDice(GetFirstPC()) >= 15) || sub6(intGLOB_132))) {
...
int sub7() {
	...
	sub2(((("GENERIC DEBUG *************** Shield Boolean (" + sub8(intGLOB_133)) + ") = ") + sub8(sub6(intGLOB_133))));
	if (((sub6(intGLOB_133) == 0) && (!IsObjectPartyMember(OBJECT_SELF)))) {
		int int4;
		int int5;
		int int6 = 0;
		talent talSpell;
...
void sub1(object objectParam1) {
	...
	sub4();
	{
		...
		if (((((!sub6(intGLOB_128)) && (!sub6(intGLOB_129))) && (!sub6(intGLOB_130))) && (!GetUserActionsPending()))) {
		if (((GetPartyMemberByIndex(0) != OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF)))) {
			if (((IsObjectPartyMember(OBJECT_SELF) && (!GetPlayerRestrictMode(OBJECT_SELF))) || (!IsObjectPartyMember(OBJECT_SELF)))) {
				...
				if ((sub6(intGLOB_138) == 1)) {
					if ((sub11() == 1)) {
						return;
					}
				}
				if ((sub6(intGLOB_132) == 1)) {
...
void main() {
	object oKas22_kinrath_10 = GetObjectByTag("kas22_kinrath_10", 0);
	object oKas22_kinrath_11 = GetObjectByTag("kas22_kinrath_11", 0);
	object oKas22_kinrath_12 = GetObjectByTag("kas22_kinrath_12", 0);
	object oKas22_kinrath_13 = GetObjectByTag("kas22_kinrath_13", 0);
	SetPlotFlag(oKas22_kinrath_10, 0);
	SetPlotFlag(oKas22_kinrath_11, 0);
	SetPlotFlag(oKas22_kinrath_12, 0);
	SetPlotFlag(oKas22_kinrath_13, 0);
	ChangeToStandardFaction(oKas22_kinrath_10, 1);
	ChangeToStandardFaction(oKas22_kinrath_11, 1);
	ChangeToStandardFaction(oKas22_kinrath_12, 1);
	ChangeToStandardFaction(oKas22_kinrath_13, 1);
	AssignCommand(oKas22_kinrath_10, sub1(OBJECT_INVALID));
	AssignCommand(oKas22_kinrath_11, sub1(OBJECT_INVALID));
	AssignCommand(oKas22_kinrath_12, sub1(OBJECT_INVALID));
	AssignCommand(oKas22_kinrath_13, sub1(OBJECT_INVALID));
}
