...
void main() {
	object oPC = GetFirstPC();
	object oKor38a_wardroid2 = GetObjectByTag("kor38a_wardroid2", 0);
	object oKor38a_wardroid3 = GetObjectByTag("kor38a_wardroid3", 0);
	ChangeToStandardFaction(oKor38a_wardroid2, 1);
	ChangeToStandardFaction(oKor38a_wardroid3, 1);
	ChangeToStandardFaction(OBJECT_SELF, 1);
	DelayCommand(0.5, AssignCommand(oKor38a_wardroid2, sub1(oPC)));
	DelayCommand(0.5, AssignCommand(oKor38a_wardroid3, sub1(oPC)));
	DelayCommand(0.5, sub1(oPC));
}
