...
void main() {
	...
	unknown unknown1 = EventUserDefined(138);
	SignalEvent(oKor38a_wardroid2, unknown1);
	SignalEvent(oKor38a_wardroid3, unknown1);
	object oK38a_way_pc0out = GetObjectByTag("k38a_way_pc0out", 0);
	object oK38a_way_pc1out = GetObjectByTag("k38a_way_pc1out", 0);
	object oK38a_way_pc2out = GetObjectByTag("k38a_way_pc2out", 0);
	sub1(oK38a_way_pc0out, oK38a_way_pc1out, oK38a_way_pc2out);
	ActionWait(1.0);
