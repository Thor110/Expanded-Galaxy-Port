					...
					if ((int1 == 1005)) {
						...
						if ((int1 == 1006)) {
							...
							if ((int1 == 1007)) {
								...
								if ((GetIsDead(oKor36_tukatahen1) && GetIsDead(oKor36_tukatahen2))) {
									object oPC = GetFirstPC();
									location location1 = GetLocation(OBJECT_SELF);
									sub1(64, "kor36_plc_queen", location1);
									object oKor36_lashowe = GetObjectByTag("kor36_lashowe", 0);
									SetGlobalBoolean("KOR_TUKATA_GONE", 1);
									CancelCombat(oKor36_lashowe);
									ChangeToStandardFaction(oKor36_lashowe, 5);
									sub2("kor36_lashowe", "", OBJECT_INVALID);
								}
								SetGlobalBoolean("KOR_TUKATAQUEEN", 1);
							}
							else {
								if ((int1 == 1008)) {
								}
