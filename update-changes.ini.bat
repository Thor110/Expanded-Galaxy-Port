...
del "Expanded Galaxy Port Installer\tslpatchdata\changes-macdisc.ini"
del "Expanded Galaxy Port Installer\tslpatchdata\changes-macaspyr.ini"
...
type changes\changes-switch-intro.ini		changes\changes.ini changes\changes-switch-outro.ini		override.txt > "Expanded Galaxy Port Installer\tslpatchdata\changes-switch.ini"
...
type changes\changes-macdisc-intro.ini		changes\changes.ini changes\changes-macdisc-outro.ini		override.txt > "Expanded Galaxy Port Installer\tslpatchdata\changes-macdisc.ini"
type changes\changes-macaspyr-intro.ini		changes\changes.ini changes\changes-macaspyr-outro.ini		override.txt > "Expanded Galaxy Port Installer\tslpatchdata\changes-macaspyr.ini"
