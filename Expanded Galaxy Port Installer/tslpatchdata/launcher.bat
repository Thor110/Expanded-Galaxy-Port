...
if not exist "DirectX/DSETUP.dll" ren swkotor2.exe swkotor2.exe.main
...
if not exist "DirectX/DSETUP.dll" ren swkotor2.exe.port swkotor2.exe
...
if not exist "DirectX/DSETUP.dll" ren swkotor2.exe swkotor2.exe.port
...
if not exist "DirectX/DSETUP.dll" ren swkotor2.exe.main swkotor2.exe
